...
const prompt = `
generate a long, detailed and seo friendly MDX blog post on Where to learn React?. Include code examples where appropriate. The MDX should be ready to be saved to a file and should include title which is optimised for search engines, date, lastmod, tags which are optimised for search engines, draft with default as false, summary which is optimised for search engines, and author as default for example:
---
title: 'Title of blog'
date: '2021-01-12'
lastmod: '2024-08-16'
