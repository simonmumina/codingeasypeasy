...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['HTML DOM', 'DOM Attributes', 'JavaScript', 'Web Development', 'HTML', 'Attribute Manipulation']
draft: false
...
While many attributes have corresponding properties with the same name (e.g., `id`, `class`), they are not always identical.  For example, the `href` attribute of an `<a>` element contains the original URL, while the `href` property contains the *absolute* URL, resolved by the browser.
