...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['relational database', 'rdbms', 'database management', 'sql', 'mysql', 'postgresql', 'database design', 'data modeling']
draft: false
...
An RDBMS is a software system that allows you to create, update, and administer a *relational* database. The "relational" aspect is key: data is organized into tables with rows (records) and columns (fields), and relationships are established between these tables using common fields (keys).  This relational structure ensures data integrity, consistency, and efficient retrieval.
