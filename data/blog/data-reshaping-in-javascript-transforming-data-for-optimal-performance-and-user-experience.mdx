...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['javascript', 'data manipulation', 'data transformation', 'data reshaping', 'arrays', 'objects', 'performance optimization', 'front-end development']
draft: false
...
const { name, age, address: { city } } = person; // Destructuring with nested objects
