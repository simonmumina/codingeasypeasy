...
date: '2024-01-01'
lastmod: '2024-01-05'
tags: ['javascript', 'regexp', 'regular expressions', 'properties', 'global', 'ignoreCase', 'multiline', 'lastIndex', 'source', 'pattern', 'tutorial', 'guide', 'web development']
draft: false
...
The `regexMultiline` successfully finds "hello" because the `m` flag allows `^` to match the beginning of each *line* within the multiline string.
