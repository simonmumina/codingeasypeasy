...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['HTML DOM', 'Head Object', 'JavaScript', 'Web Development', 'SEO', 'Metadata', 'Document Object Model', 'DOM API']
draft: false
...
While rarely necessary dynamically, you *can* technically change the character set, although it's best practice to define this in the initial HTML.
