...
*   **`SplashScreen.preventAutoHideAsync()`:**  This function prevents the splash screen from automatically hiding until you explicitly call `SplashScreen.hideAsync()`.  It's crucial to call this *before* your app starts loading data.
