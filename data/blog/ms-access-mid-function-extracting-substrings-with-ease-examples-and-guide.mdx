...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['ms access', 'access vba', 'mid function', 'string manipulation', 'database', 'substring', 'vba tutorial']
draft: false
...
2.  It then finds the position of the next "|" character *after* the first one.
