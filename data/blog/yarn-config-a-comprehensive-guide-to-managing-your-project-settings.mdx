...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['yarn', 'package manager', 'configuration', 'javascript', 'nodejs', 'development tools', 'yarn config']
draft: false
...
In this case, Yarn will use `https://my-private-registry.example.com` as the registry for all projects *unless* a project specifies a different registry in its own `.yarnrc.yml` or using a command-line argument.  The `cache-folder` setting will apply only to that specific project.
