...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['C', 'C++', 'Debugging', 'Compiler Warning', 'Implicit Declaration', 'Function Declaration', 'Undefined Function', 'Code Troubleshooting']
draft: false
...
**Cause:** In C (but not in C++), if you define a function *after* it's first used, and you haven't provided a prior declaration, you'll get the implicit declaration warning.
...
But the implementation of `my_function` in `my_library.c` is missing *or* `my_library.c` isn't compiled and linked.
