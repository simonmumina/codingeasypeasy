...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['react-native', 'animation', 'transitions', 'navigation', 'shared element transitions', 'reanimated', 'expo', 'mobile development']
draft: false
  ...
  return (
    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
      <Animated.View style={{ opacity: fadeAnim }}>
        ...
        <TouchableOpacity onPress={navigateToDetail} style={{ marginTop: 20, backgroundColor: 'blue', padding: 10, borderRadius: 5 }}>
