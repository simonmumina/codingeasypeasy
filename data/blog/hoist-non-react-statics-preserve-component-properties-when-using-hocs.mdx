...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['react', 'hoc', 'higher-order-component', 'hoist-non-react-statics', 'component-composition', 'javascript', 'react-patterns']
draft: false
...
The problem arises because the HOC returns a *new* component.  This new component doesn't automatically inherit the static properties (methods and properties defined directly on the component class, not on its prototype or instances) of the original component. These static properties can be essential for various reasons:
