...
```jsx
<div className="aspect-square w-48 h-48 bg-gray-200 relative overflow-hidden">
  <img
    src="/placeholder-image.jpg"  // Replace with your image path
    alt="Square Image"
    className="object-cover h-full w-full" // Ensure the image fills the container
  />
</div>
```
...
```jsx
<div className="aspect-square md:aspect-video w-full h-auto">
  <img
...
```jsx
<div className="aspect-[3/2] w-64 h-auto">
  <img
