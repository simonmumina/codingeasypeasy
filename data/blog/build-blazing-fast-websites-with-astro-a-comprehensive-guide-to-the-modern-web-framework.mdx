...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['astro', 'web development', 'javascript', 'static site generation', 'islands architecture', 'performance', 'framework', 'build tools']
draft: false
...
const MyReactComponent = ({ name }) => {
  return (
    <div>
      Hello, {name}! This component is rendered using React.
    </div>
  );
};
