...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['html', 'css', 'dom', 'unicode', 'bidi', 'javascript', 'front-end development', 'text direction']
draft: false
...
*   **`bidi-override`**:  This creates an override. This means that the element becomes a single level of embedding, and the characters are reordered *strictly* according to the direction property. All implicit bidirectional reordering is overridden. This value should be used with caution as it can break the natural flow of text if used improperly.
