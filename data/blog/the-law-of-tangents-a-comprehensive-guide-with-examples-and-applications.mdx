...
The Law of Tangents is a trigonometric identity that relates the lengths of two sides of a triangle to the tangents of half the difference and half the sum of the angles opposite those sides. While often overshadowed by the Law of Sines and Law of Cosines, the Law of Tangents offers a unique and sometimes more efficient approach to solving for missing angles or sides in _oblique triangles_ (triangles that are not right-angled).

## What is the Law of Tangents?

The Law of Tangents states that for any triangle with sides _a_, _b_, and _c_, and angles _A_, _B_, and _C_ opposite those sides respectively, the following relationships hold:
...
- **(a - b) / (a + b):** This represents the ratio of the difference between two sides (_a_ and _b_) to their sum.
- **(A - B) / 2:** This is half the difference between the angles opposite sides _a_ and _b_.
- **(A + B) / 2:** This is half the sum of the angles opposite sides _a_ and _b_. Since the sum of all angles in a triangle is 180°, (A + B) / 2 is equal to (180° - C) / 2 = 90° - (C / 2).
- **tan((A - B) / 2) / tan((A + B) / 2):** This is the ratio of the tangents of half the difference and half the sum of the angles.

Essentially, the Law of Tangents relates a ratio based on the _lengths of sides_ to a ratio based on the _angles opposite those sides_.

## When to Use the Law of Tangents

The Law of Tangents is most useful in the following scenarios:

- **Given Two Sides and the Included Angle (SAS):** If you know the lengths of two sides of a triangle (_a_ and _b_) and the angle between them (_C_), you can use the Law of Tangents to find the other two angles (_A_ and _B_).
- **Given Two Angles and a Side (AAS or ASA):** If you know two angles (_A_ and _B_) and a side (e.g., _a_), you can first find the third angle (_C_ = 180° - A - B). Then, you can use the Law of Sines or Law of Cosines to find the remaining sides. The Law of Tangents can be useful as a step in the process in specific circumstances.

It's important to note that while you _can_ technically use the Law of Tangents when given three sides (SSS), it's generally more straightforward to use the Law of Cosines in that case.
...
We want to find angles _A_ and _B_.
...
2.  **Find (A + B) / 2:**
    ...
    Since _A + B + C = 180°_, then _A + B = 180° - C = 180° - 35° = 145°_.
    Therefore, _(A + B) / 2 = 145° / 2 = 72.5°_.
...
5.  **Solve the system of equations:**
    ...
    - _(A + B) / 2 = 72.5° => A + B = 145°_
    - _(A - B) / 2 = 29.25° => A - B = 58.5°_
    ...
    Substituting _A_ back into _A + B = 145°_:
...
Therefore, _A ≈ 101.75°_ and _B ≈ 43.25°_.
...
- **Law of Tangents:** Primarily useful for SAS cases, particularly when you want to directly calculate the two unknown angles _A_ and _B_ before finding the third side.
