...
.tooltip { /* standard bootstrap tooltip */
...
When dealing with dynamically loaded content, ensure that the tooltip is initialized *after* the content is available.
...
**Key takeaway:** Ensure the tooltip is attached to the DOM element *after* that element has been rendered.
