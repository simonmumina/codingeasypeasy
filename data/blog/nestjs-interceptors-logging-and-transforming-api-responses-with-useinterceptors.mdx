...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['nestjs', 'interceptors', 'logging', 'api', 'typescript', 'http', 'transformations', 'request-response']
draft: false
...
For example, if you have a logging interceptor and a transformation interceptor, you might want the logging interceptor to execute *before* the transformation interceptor so that it logs the original response data.
