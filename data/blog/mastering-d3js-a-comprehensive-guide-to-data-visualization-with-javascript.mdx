...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['d3.js', 'data visualization', 'javascript', 'web development', 'interactive charts', 'svg', 'data binding']
draft: false
...
svg.selectAll("rect")
  ...
  .on("mouseover", (event, d) => { // Mouseover event handler
    tooltip.transition()
      .duration(200)
      .style("opacity", 0.9);
  ...
  .on("mouseout", (event, d) => { // Mouseout event handler
    tooltip.transition()
      .duration(500)
