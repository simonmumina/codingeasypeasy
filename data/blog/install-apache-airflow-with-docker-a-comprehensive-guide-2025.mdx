...
date: '2025-05-27'
lastmod: '2025-05-15'
tags: ['airflow', 'docker', 'docker-compose', 'data-engineering', 'etl', 'workflow-automation', 'apache-airflow', 'installation-guide']
draft: false
...
*   **Fernet Key:**  The `AIRFLOW__CORE__FERNET_KEY` environment variable is crucial for encrypting sensitive information, such as passwords and connections.  You *must* generate a unique Fernet key.  You can generate one using the following Python code:
