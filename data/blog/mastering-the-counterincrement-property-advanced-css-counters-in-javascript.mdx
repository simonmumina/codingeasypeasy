...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['css', 'css counters', 'counterIncrement', 'html dom', 'javascript', 'web development', 'styling', 'accessibility']
draft: false
...
<body>
  ...
  <script>
    ...
    incrementButton.addEventListener('click', function() {
      ...
      let currentIncrement = parseInt(window.getComputedStyle(counterDisplay).counterIncrement.replace('myDynamicCounter ', '')) || 1; //Default value is 1 if it is null
      // Add 1
