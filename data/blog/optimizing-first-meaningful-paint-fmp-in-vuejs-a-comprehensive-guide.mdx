...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['vuejs', 'performance', 'web performance', 'optimization', 'first meaningful paint', 'fmp', 'javascript', 'frontend']
draft: false
  ...
  setup() {
    onMounted(() => {
      if ('performance' in window) {
        ...
        setTimeout(() => {  // Delay slightly to allow the browser to update the layout
...
```html
<link rel="preload" href="styles.css" as="style" onload="this.onload=null;this.rel='stylesheet'" onerror="this.rel='stylesheet'">
