...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['bootstrapvue', 'vue.js', 'tables', 'data tables', 'b-table', 'dynamic data', 'frontend development']
draft: false
...
*   **Important:** In a real-world application, the `items` array should only contain the data for the *current* page.  You would typically fetch this data from your API based on the `currentPage` and `perPage` values. This example generates the whole array up front and simply displays slices of it.
