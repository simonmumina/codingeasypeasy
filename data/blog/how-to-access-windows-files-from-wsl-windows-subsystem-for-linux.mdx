...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['wsl', 'windows subsystem for linux', 'linux', 'windows', 'file access', 'mnt/c', 'filesystem', 'cross-platform development', 'development environment', 'ubuntu', 'debian', 'kali linux']
draft: false
