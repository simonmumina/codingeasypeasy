...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['yarn', 'yarn patch', 'npm', 'package management', 'bug fixes', 'patching dependencies', 'javascript', 'nodejs']
draft: false
...
**Important:**  The key in the `resolutions` object *must* match the package name as it appears in your `dependencies`.  The value is a special `patch:` URL pointing to the patch file's location relative to your `package.json` file.
