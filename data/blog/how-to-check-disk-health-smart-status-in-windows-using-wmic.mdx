...
1.  **Open the Command Prompt as Administrator:**
    ...
    ![Open Command Prompt as Administrator](./images/open-cmd-as-admin.png) _(Replace with your own image or remove if not available)_
...
![CrystalDiskInfo Screenshot](./images/crystaldiskinfo-example.png) _(Replace with your own image or remove if not available)_
