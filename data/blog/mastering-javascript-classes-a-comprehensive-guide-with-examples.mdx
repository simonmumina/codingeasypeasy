...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['javascript', 'classes', 'oop', 'object-oriented programming', 'es6', 'inheritance', 'polymorphism', 'prototypes']
draft: false
...
Importantly, JavaScript classes *are not* hoisted in the same way as function declarations.  This means you must declare your class before you attempt to use it.
...
*   **`super()` method:**  Calls the constructor of the parent class.  It *must* be called before you use `this` in the child class's constructor.
