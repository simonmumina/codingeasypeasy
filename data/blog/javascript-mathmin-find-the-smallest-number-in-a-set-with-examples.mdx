...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['javascript', 'math', 'minimum', 'min', 'number', 'array', 'function', 'programming', 'web development']
draft: false
...
Note: This example used `Math.max` which is the opposite of Math.min and restricts the *minimum* value possible. This demonstrates the principles applicable, just using the opposite function as the core logic.
