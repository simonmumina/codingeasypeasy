...
date: '2023-10-27'
lastmod: '2024-10-27'
tags: ['next.js', 'code splitting', 'dynamic imports', 'lazy loading', 'performance optimization', 'web development']
draft: false
...
*   **`ssr: false`:** This is a crucial option when the imported component relies on client-side APIs (like browser APIs) that are not available during server-side rendering.  Setting `ssr: false` tells Next.js to only render this component on the client-side.  If you *can* render server-side, definitely omit this option.
