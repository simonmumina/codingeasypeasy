...
*   **`window.getComputedStyle()`:**  Returns the *final* computed styles for an element, taking into account all applicable CSS rules, inheritance, and browser defaults.  This is useful for getting the actual values of properties after all CSS rules have been applied. However, it doesn't provide information about the origin of those styles.
