...
*   **Test-Driven Development (TDD):**  Unit testing is a key component of TDD, where you write tests *before* writing the actual code. This helps you define the desired behavior upfront and ensures that your code meets those requirements.
...
*   **Mock:** A mock is a more sophisticated type of test double that allows you to verify that specific methods were called with specific arguments. It's used to verify the *interactions* of the unit under test with its collaborators.
