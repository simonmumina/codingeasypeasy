...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['javascript', 'string', 'localeCompare', 'internationalization', 'i18n', 'comparison', 'unicode']
draft: false
...
*   **`string`:** The reference string you're comparing *from*.  This is the string the method is called upon.
*   **`compareString`:** The string you're comparing *to*. This is the string passed as the first argument.
