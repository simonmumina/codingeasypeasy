...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['spring boot', 'spring framework', 'spring.factories', 'autoconfiguration', 'java', 'configuration', 'extension', 'springboot']
draft: false
...
Now, when your Spring Boot application starts, `MyCustomInitializer` will be executed *before* any beans are created, giving you a chance to customize the `ApplicationContext`.
