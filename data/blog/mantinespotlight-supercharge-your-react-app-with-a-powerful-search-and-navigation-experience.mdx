...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['react', 'mantine', 'spotlight', 'search', 'navigation', 'ui-library', 'component-library', 'keyboard-shortcuts']
draft: false
  ...
  return (
    <MantineProvider
      ...
      theme={{
        colorScheme: 'light',
        colors: {
          brand: ['#228BE6', '#339AF0', '#495057', '#5F6368', '#74787D', '#898D92', '#9EA2A7', '#B3B7BC', '#C8CDD2', '#DDE2E7'],
        },
        primaryColor: 'brand',
      }}
    >
