...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['ecommerce', 'database design', 'schema', 'MySQL', 'PostgreSQL', 'SQL', 'products', 'customers', 'orders', 'payments', 'data modeling']
draft: false
...
*   `password`: **Important:**  Store *hashed* passwords, not plain text.  Use a strong hashing algorithm like bcrypt or Argon2.
...
*   `price`:  The price of the product *at the time of the order*. This is crucial for maintaining historical accuracy, as product prices can change over time.
