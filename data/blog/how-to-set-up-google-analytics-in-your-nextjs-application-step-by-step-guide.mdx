...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['next-js', 'google analytics', 'analytics', 'tracking', 'web analytics', 'performance', 'optimization', 'gtag', 'nextjs analytics', 'next js google analytics', 'react analytics']
draft: false
...
function HomePage() {
  return (
    <div>
      ...
      <MyButton onClick={() => { console.log("Button was clicked!") }} />
    </div>
  );
}
