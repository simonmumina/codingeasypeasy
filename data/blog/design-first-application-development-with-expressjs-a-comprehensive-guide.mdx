...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['express', 'nodejs', 'api-design', 'design-first', 'openapi', 'swagger', 'api-development', 'backend-development']
draft: false
...
let books = [
  { id: '1', title: 'The Hitchhiker\'s Guide to the Galaxy', author: 'Douglas Adams', isbn: '978-0345391803' },
