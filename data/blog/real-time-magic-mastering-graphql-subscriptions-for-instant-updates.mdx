...
import { ApolloClient, InMemoryCache, gql, useQuery, useMutation, useSubscription, split, HttpLink } from '@apollo/client';
...
3.  You should see the new comment appear in the *other* window instantly, without needing to refresh the page!
