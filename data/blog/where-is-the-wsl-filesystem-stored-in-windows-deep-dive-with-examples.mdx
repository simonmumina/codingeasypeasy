...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['wsl', 'windows subsystem for linux', 'filesystem', 'appdata', 'linux', 'windows', 'ubuntu', 'debian', 'kali', 'hyper-v']
draft: false
...
*   **Manage Disk Space:** If your WSL filesystem is consuming a lot of disk space, you can investigate the contents of `ext4.vhdx` to identify large files or directories that you can remove or move.  However, always do this from *within* WSL to avoid filesystem corruption.
