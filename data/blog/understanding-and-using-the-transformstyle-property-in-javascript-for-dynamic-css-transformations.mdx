...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['javascript', 'html', 'css', 'dom', 'transform', 'transformStyle', 'animation', 'web development']
draft: false
...
```html
<div id="myElement" style="width:100px; height:100px; background-color:lightgoldenrodyellow;" onmouseover="scaleUp()" onmouseout="scaleDown()"></div>
