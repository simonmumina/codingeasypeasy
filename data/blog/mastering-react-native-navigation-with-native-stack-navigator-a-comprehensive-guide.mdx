...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['react-native', 'navigation', 'native-stack-navigator', 'mobile-development', 'javascript', 'expo']
draft: false
...
function SignInScreen() {
  return <View><Text>Sign In Screen</Text></View>;
}

function SignUpScreen() {
  return <View><Text>Sign Up Screen</Text></View>;
}
```
