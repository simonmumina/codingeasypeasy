...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['node.js', 'joi', 'data validation', 'javascript', 'schema validation', 'backend development', 'API validation', 'request validation']
draft: false
...
const customSchema = Joi.object({
  birthDate: Joi.date().iso().required().custom((value, helpers) => {
