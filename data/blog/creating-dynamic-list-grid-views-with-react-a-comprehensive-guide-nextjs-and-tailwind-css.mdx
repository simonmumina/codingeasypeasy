...
date: "2024-10-27"
lastmod: "2024-10-27"
tags: ["react", "next-js", "tailwind-css", "grid-layout", "list-view", "ui-design", "frontend-development", "responsive-design", "javascript", "components"]
draft: false
...
const Item = ({ item, isGrid }) => {
  return (
    <div className={`border rounded-lg p-4 ${isGrid ? 'grid-item' : 'list-item'} `}>
      <img src={item.image} alt={item.name} className="mb-2 w-full object-cover rounded-md" style={{height: '150px'}} />
...
const ListGrid = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className={`
          ${isGrid ? 'grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4' : 'flex flex-col gap-2'}
      `}>
        {items.map((item) => (
