...
*   **Server Push:** Enables the server to proactively send resources to the client *before* they are explicitly requested. This is particularly useful for pushing CSS, JavaScript, and image assets that the client will likely need to render a page.
