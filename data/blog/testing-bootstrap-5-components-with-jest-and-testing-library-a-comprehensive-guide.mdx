...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['bootstrap', 'jest', 'testing-library', 'unit-testing', 'component-testing', 'javascript', 'frontend-testing']
draft: false
...
2.  **Create a Test File for the Modal Component:**
    ...
    describe('Modal Component', () => {
      test('renders when isOpen is true', () => {
        render(<Modal title="Test Modal" isOpen={true}>Modal Content</Modal>);
        const modalElement = screen.getByText('Test Modal');
        expect(modalElement).toBeInTheDocument();
      });

      test('does not render when isOpen is false', () => {
        const { container } = render(<Modal title="Test Modal" isOpen={false}>Modal Content</Modal>);
      ...
      test('calls onClose handler when close button is clicked', () => {
        ...
        render(<Modal title="Test Modal" isOpen={true} onClose={handleClose}>Modal Content</Modal>);
      ...
      test('renders children correctly', () => {
        render(<Modal title="Test Modal" isOpen={true}><div>Some Child Content</div></Modal>);
