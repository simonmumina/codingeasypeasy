...
date: '2024-10-27'
lastmod: '2024-10-28'
tags: ['mantine', 'react', 'ui library', 'modals', 'dialogs', 'web development', 'component library']
draft: false
...
function MyComponent() {
  ...
  return (
    <Button onClick={openUserModal}>Open User Modal</Button>
  );
}
