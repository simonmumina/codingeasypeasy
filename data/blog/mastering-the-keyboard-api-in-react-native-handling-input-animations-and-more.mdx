...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['react-native', 'keyboard-api', 'ios', 'android', 'input', 'animation', 'ui', 'keyboard-events', 'keyboard-avoiding-view']
draft: false
...
6.  **Event Types:** The key event names are `keyboardWillShow`, `keyboardDidShow`, `keyboardWillHide`, `keyboardDidHide`. The "Will" events are fired *before* the animation completes, and the "Did" events are fired *after* the animation completes. Choose the event that suits your needs.
