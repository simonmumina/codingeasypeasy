...
*   Ensure this code runs *before* you make any API requests from your Vue.js components.  This is typically done in your `resources/js/app.js` file or a similar entry point.
