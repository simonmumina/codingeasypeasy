...
const MyScreen = () => {
  const imageUrl = 'https://images.unsplash.com/photo-1604537580924-642d6254a9fc?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cmVhY3QlMjBuYXRpdmV8ZW58MHx8MHx8fDA%3D&w=1000&q=80'; // Replace with your image URL
