...
*   **Validation:**  Verifying that the input data meets specific criteria, such as data type, format, range, or allowed values.  Validation answers the question: "Is this input *acceptable*?"
*   **Sanitization:** Modifying the input data to remove or escape potentially harmful characters or code. Sanitization answers the question: "How can I make this input *safe*?"
