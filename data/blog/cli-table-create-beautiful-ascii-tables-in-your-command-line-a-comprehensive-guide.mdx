...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['cli-table', 'command-line', 'terminal', 'ascii-table', 'node.js', 'javascript', 'formatting', 'console', 'npm']
draft: false
...
table.push(
  ['A very long value 1', 'A very long value 2'],
  ['Value 3', 'Value 4']
);
  ...
  return new Promise(resolve => {
    setTimeout(() => {
      resolve([
        ...
        { name: 'Product C', price: 12.50, stock: 200 }
      ]);
