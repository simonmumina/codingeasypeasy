...
The `SQRT()` function returns the square root of a given number. The square root of a number *x* is a value *y* such that *y* * y* = *x*. For example, the square root of 9 is 3 because 3 * 3 = 9.
