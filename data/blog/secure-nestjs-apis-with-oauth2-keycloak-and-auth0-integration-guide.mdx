...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['nestjs', 'oauth2', 'keycloak', 'auth0', 'authentication', 'authorization', 'security', 'api', 'node.js']
draft: false
...
export class Auth0Strategy extends PassportStrategy(Strategy, 'auth0') {
  ...
  async validate(accessToken: string, refreshToken: string, extraParams: any, profile: Profile, done: any): Promise<any> {
