...
Make sure you've created the database and tables in each of the shard databases *before* running your Pyramid application.  You can use the `ShardManager.create_all()` method to create the tables in all shards.
