...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['next-js', 'react', 'javascript', 'framework', 'server-side rendering', 'static site generation', 'frontend', 'development']
draft: false
...
**What it is:** Server-side rendering means that the initial HTML of your web pages is generated on the server *before* being sent to the browser.
