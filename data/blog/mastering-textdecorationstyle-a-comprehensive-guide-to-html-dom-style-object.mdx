...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['textDecorationStyle', 'HTML DOM Style', 'CSS', 'JavaScript', 'web development', 'text styling', 'front-end development', 'tutorial']
draft: false
...
*   **Forgetting to Set `textDecorationLine`:** `textDecorationStyle` only defines the *style* of the decoration line.  You must use `textDecoration` or `textDecorationLine` (e.g., `underline`, `overline`, `line-through`) to actually create the decoration.
