...
date: '2024-02-29'
lastmod: '2024-10-27'
tags: ['Flask', 'SGX', 'Gramine', 'Occlum', 'Security', 'Enclave', 'Python', 'Application Security', 'Confidential Computing']
draft: false
...
Confidential Computing ensures that data is protected not just at rest or in transit, but also *in use*. This is achieved by creating a Trusted Execution Environment (TEE), often implemented using hardware-based security features.
