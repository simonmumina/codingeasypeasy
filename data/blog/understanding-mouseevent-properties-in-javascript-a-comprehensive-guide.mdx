...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['javascript', 'mouseevent', 'dom', 'event handling', 'web development', 'front-end development']
draft: false
...
*   **`clientX` and `clientY`**: These properties represent the horizontal and vertical coordinates of the mouse pointer relative to the *viewport* (the visible area of the browser window).
...
*   **`screenX` and `screenY`**: These properties represent the horizontal and vertical coordinates of the mouse pointer relative to the *screen* (the entire display).
...
*   **`offsetX` and `offsetY`**: These properties represent the horizontal and vertical coordinates of the mouse pointer relative to the *target element* where the event occurred.  These are often the most useful properties for determining where *within* an element a click occurred.
...
*   **`pageX` and `pageY`**: These properties represent the horizontal and vertical coordinates of the mouse pointer relative to the *document* (the entire page). These are especially useful when the page is scrollable.
