...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['react', 'horizontal scroll', 'css', 'javascript', 'scrollbar hiding', 'ui/ux', 'web development']
draft: false
...
const LibraryScroll = () => {
  ...
  const ArrowLeft = Arrow({ children: '<', disabled: false, onClick: () => console.log("Left Clicked") });
  const ArrowRight = Arrow({ children: '>', disabled: false, onClick: () => console.log("Right Clicked") });
