...
*   **Modifies Original Array (Potentially):** While `forEach()` itself doesn't return a new array, the callback function you provide *can* modify the original array if it interacts with the element values. This is an important distinction.
