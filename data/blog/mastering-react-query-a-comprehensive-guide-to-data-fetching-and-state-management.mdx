...
date: '2023-10-27'
lastmod: '2024-10-26'
tags: ['react', 'react query', 'data fetching', 'state management', 'javascript', 'frontend development']
draft: false
...
function PostItem({ post }) {
  ...
  return (
    <li>
      {post.title} - <button onClick={handleDelete} disabled={mutation.isLoading}>Delete</button>
    </li>
  );
}
```
