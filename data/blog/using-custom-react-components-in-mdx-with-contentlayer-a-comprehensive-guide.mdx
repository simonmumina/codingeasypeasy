...
<Callout>
  This is an information callout.  It's important!
</Callout>
...
*   **Pathing:** Make absolutely sure your import path is correct.  The path is relative to the *MDX file* itself. If the MDX file lives in `content/`, and your components are in `components/`, then the path should be something like `'../components/Callout'`. This is one of the most common sources of errors.
...
<Callout type={frontmatter.calloutType}>
  This callout type is defined in the frontmatter!
</Callout>
