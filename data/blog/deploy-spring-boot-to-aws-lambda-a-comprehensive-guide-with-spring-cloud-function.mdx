...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['spring-boot', 'aws-lambda', 'spring-cloud-function', 'serverless', 'java', 'deployment', 'cloud', 'aws']
draft: false
...
1.  **Create a Lambda Function:**  In the AWS Management Console, navigate to Lambda and create a new function.
    ...
    *   Select "Java 8" or "Java 11" as the runtime.  Note that the JDK you compile with *must* match the Lambda runtime or an earlier version.
