...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['material-ui', 'mui', 'stack', 'layout', 'react', 'components', 'styling', 'responsive-design']
draft: false
...
*   **`justifyContent`**:  Controls how items are aligned along the *main axis* (horizontal for `direction="row"`, vertical for `direction="column"`).  Possible values include: `'flex-start'`, `'flex-end'`, `'center'`, `'space-between'`, `'space-around'`, `'space-evenly'`.
*   **`alignItems`**: Controls how items are aligned along the *cross axis* (vertical for `direction="row"`, horizontal for `direction="column"`). Possible values include: `'flex-start'`, `'flex-end'`, `'center'`, `'stretch'`, `'baseline'`.
