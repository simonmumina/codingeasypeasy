...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['nestjs', 'undo redo', 'command pattern', 'event sourcing', 'typescript', 'backend development', 'cqrs', 'architectural patterns']
draft: false
...
export class AddTextCommand implements Command {
  ...
  constructor(private readonly eventBus: EventBus, documentState: DocumentState, textToAdd: string) {
