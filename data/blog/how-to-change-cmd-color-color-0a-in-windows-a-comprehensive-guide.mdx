...
This method changes the _default_ properties for all future Command Prompt windows.

1.  **Open Command Prompt:** Open the Command Prompt.
2.  **Access Properties:** Right-click on the title bar and select "Defaults". _Crucially, select "Defaults" and not "Properties."_
