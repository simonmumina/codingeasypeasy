...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['oauth2', 'github', 'express', 'nodejs', 'authentication', 'authorization', 'passportjs', 'security']
draft: false
...
app.get('/auth/github',
  passport.authenticate('github', { scope: [ 'user:email' ] })); //Requesting User email permissions
