...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['html', 'dom', 'javascript', 'events', 'onloadedmetadata', 'video', 'audio', 'web development']
draft: false
...
The `onloadedmetadata` event fires *after* the browser has loaded the metadata of the media file, but *before* the entire media file has been downloaded. This distinction is important. It allows you to access properties like:
