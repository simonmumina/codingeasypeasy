...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['bootstrap', 'bootstrap 5', 'netlify', 'vercel', 'deployment', 'website hosting', 'static site', 'frontend', 'web development']
draft: false
...
Your `index.html` file should reference the *built* files, not the source files (e.g., the compiled CSS and bundled JavaScript).
...
<head>
    ...
    <link rel="stylesheet" href="css/styles.css"> <!-- Reference the compiled CSS -->
...
<body>
    ...
    <script src="js/script.js"></script>  <!-- Reference the bundled JavaScript (if any) -->
