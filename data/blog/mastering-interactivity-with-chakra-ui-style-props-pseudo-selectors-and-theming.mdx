...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['chakra-ui', 'react', 'ui-library', 'frontend-development', 'interactive-design', 'style-props', 'pseudo-selectors', 'theming']
draft: false
...
function ValidatedInput() {
  ...
  return (
    <FormControl isInvalid={isError}>
      ...
      />
      {isError ? (
        <FormErrorMessage>Email must be at least 5 characters.</FormErrorMessage>
      ) : null}
    </FormControl>
  );
}
