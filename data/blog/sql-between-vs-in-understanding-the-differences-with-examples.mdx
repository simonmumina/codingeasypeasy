...
The `NOT BETWEEN` operator selects values *outside* the specified range.
...
The `NOT IN` operator selects values that do *not* match any value within the specified list.  **Important note:** `NOT IN` returns `NULL` if the list contains a `NULL` value. Therefore, you need to handle `NULL` cases explicitly when using `NOT IN`.
...
| Feature         | `BETWEEN`                                                                     | `IN`                                                                              |
| --------------- | ------------------------------------------------------------------------------ | --------------------------------------------------------------------------------- |
| **Purpose**      | Selects values within a *range*.                                               | Selects values that match any value in a *list*.                                 |
