...
date: '2024-02-29'
lastmod: '2024-03-05'
tags: ['apache', 'https', 'ssl', 'letsencrypt', 'web server security', 'certificate authority', 'security']
draft: false
...
*   **HTTP Strict Transport Security (HSTS):**  HSTS tells browsers to *always* access your website over HTTPS, even if a user types `http://`.  Certbot often configures HSTS automatically in the `/etc/letsencrypt/options-ssl-apache.conf` file.  Verify that it contains the following:
