...
*   **Caches Directory:**  Use this for temporary data that can be deleted by the system.  Data here is *not* backed up.  Good for storing images you fetch to be used offline, but which can be re-downloaded if necessary.
