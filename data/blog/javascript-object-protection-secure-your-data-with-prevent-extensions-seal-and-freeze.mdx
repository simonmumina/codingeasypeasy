...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['javascript', 'object protection', 'security', 'freeze', 'seal', 'prevent extensions', 'immutable', 'data integrity']
draft: false
...
`Object.preventExtensions()` prevents new properties from being added to an object.  Existing properties can still be modified or deleted.  Think of it as a one-way gate:  you can still change things *inside* the house, but you can't build any additions.
