...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['MySQL', 'RPAD', 'String Functions', 'Database', 'SQL', 'Padding', 'String Manipulation', 'Coding', 'Development']
draft: false
...
The `LPAD()` function is the counterpart to `RPAD()`.  While `RPAD()` pads on the *right* side of the string, `LPAD()` pads on the *left* side. The syntax is identical:
