...
date: '2023-10-27'
lastmod: '2024-01-26'
tags: ['nextjs', 'data fetching', 'getServerSideProps', 'getStaticProps', 'getStaticPaths', 'client-side rendering', 'server-side rendering', 'static site generation', 'API routes', 'useEffect', 'SWR', 'TanStack Query']
draft: false
