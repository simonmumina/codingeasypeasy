...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['react server components', 'chakra ui', 'next.js', 'ui library', 'react', 'server-side rendering']
draft: false
...
```jsx filename="components/Header.js"
'use client';
...
```jsx filename="components/Footer.js"
'use client';
...
```jsx filename="components/BlogPost.js"
'use client';
