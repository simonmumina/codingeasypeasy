...
*   **Organization within a Database:** Schemas exist *inside* a database. A single database can contain multiple schemas.
...
|--------------------|-----------------------------------------------|-------------------------------------------------|
| **Level**        | Top-level container                            | Organization *within* a database                  |
