...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['next-js', 'mdx', 'next-mdx-remote', 'content management', 'markdown', 'react', 'dynamic content', 'headless cms']
draft: false
...
3.  **Add a Syntax Highlighter component:**
    ...
    const CodeBlock = ({ children, className }) => {
      ...
      return (
        <SyntaxHighlighter style={dracula} language={language} children={children.trim()} />
      );
    };
...
4.  **Use it in your component:**
    ...
    **Now, your code blocks in MDX will be automatically syntax-highlighted using the Dracula theme.** Remember to include the `language-` prefix in your code block's class name (e.g., ```javascript`). If using rehype-prism-plus you can define the theme via props passed to it in the rehypePlugins array.
