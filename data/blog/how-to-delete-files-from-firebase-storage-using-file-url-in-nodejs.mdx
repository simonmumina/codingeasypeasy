...
date: '2024-01-05'
lastmod: '2024-01-05'
tags: ['firebase', 'firebase storage', 'node.js', 'file deletion', 'cloud storage', 'javascript', 'backend development']
draft: false
...
To interact with Firebase Storage, you need to initialize the Admin SDK.  This requires your Firebase project's service account credentials.
   ...
   *   **Download your Service Account Key:** In the Firebase Console, navigate to *Project settings > Service accounts*. Click "Generate new private key" and download the JSON file containing your service account credentials.  **Important: Keep this file secure and do not commit it to your version control system.**
...
*   **`storageBucket`:**  Replace `"your-firebase-storage-bucket-url.appspot.com"` with the actual URL of your Firebase Storage bucket. You can find this in the Firebase Console under *Storage > Files*. It will look something like `gs://your-project-id.appspot.com`.  You only need the `your-project-id.appspot.com` portion.
...
const fileURLToDelete = "https://firebasestorage.googleapis.com/v0/b/your-firebase-storage-bucket-url.appspot.com/o/images%2Fmy-image.jpg?alt=media&token=your-token";
