...
date: '2024-01-01'
lastmod: '2024-10-27'
tags: ['css', 'color', 'oklab', 'color spaces', 'web design', 'accessibility', 'front-end development', 'modern css']
draft: false
...
*   **L (Lightness):** Represents the perceived lightness of the color. It ranges from 0 (black) to 1 (white).  **Important:** Unlike traditional `lightness` values, OKLab's `L` is based on *perceived* lightness.
