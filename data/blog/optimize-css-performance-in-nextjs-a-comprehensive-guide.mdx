...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['next-js', 'css', 'performance', 'optimization', 'styling', 'web performance', 'code splitting', 'tree shaking']
draft: false
...
*   Defer loading the remaining CSS using techniques like the `preload` link with a `onload` event:
    ...
    ```html
    <link rel="preload" href="/path/to/your/non-critical.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
