...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['zod', 'typescript', 'schema validation', 'data validation', 'runtime validation', 'typesafe', 'javascript', 'nodejs']
draft: false
...
*   **code:** A string representing the type of error (e.g., "invalid\_type", "missing\_required\_error").
