...
function ImageAvatar() {
  return (
    <Avatar alt="John Doe" src="https://example.com/john-doe.jpg" />
  );
}
...
function SizedAvatar() {
  return (
    <>
      ...
      <Avatar sx={{ width: 48, height: 48, ml: 2 }} alt="Medium" src="https://example.com/john-doe.jpg" /> {/* ml: margin-left */}
      <Avatar sx={{ width: 72, height: 72, ml: 2 }} alt="Large" src="https://example.com/john-doe.jpg" />
    </>
  );
}
...
function ThemedAvatar() {
  return (
    <ThemeProvider theme={theme}>
      <Avatar variant="rounded" alt="Small" src="https://example.com/john-doe.jpg" sx={{width: theme.components.MuiAvatar.styleOverrides.small.width, height: theme.components.MuiAvatar.styleOverrides.small.height}}/>
      <Avatar variant="rounded" alt="Medium" src="https://example.com/john-doe.jpg" sx={{width: theme.components.MuiAvatar.styleOverrides.medium.width, height: theme.components.MuiAvatar.styleOverrides.medium.height, ml: 2 }}/>
      <Avatar variant="rounded" alt="Large" src="https://example.com/john-doe.jpg" sx={{width: theme.components.MuiAvatar.styleOverrides.large.width, height: theme.components.MuiAvatar.styleOverrides.large.height, ml: 2 }}/>
    </ThemeProvider>
  );
}
