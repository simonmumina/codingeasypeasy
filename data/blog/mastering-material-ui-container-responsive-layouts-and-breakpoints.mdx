...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['material-ui', 'mui', 'react', 'container', 'responsive design', 'breakpoints', 'layout', 'frontend development']
draft: false
...
function CustomContainer() {
  return (
    <Container maxWidth="md" sx={{ backgroundColor: 'beige', padding: '20px', borderRadius: '5px' }}>
...
function ConditionalContainer() {
  ...
  return (
    <Container maxWidth={isSmallScreen ? 'sm' : 'md'}>
      ...
      <p>
        This container's maxWidth changes based on the screen size. On small screens, it uses "sm," and on larger screens, it uses "md."
      </p>
    </Container>
  );
}
