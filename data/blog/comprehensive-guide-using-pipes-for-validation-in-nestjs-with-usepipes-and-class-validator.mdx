...
*   **`whitelist: true`:** Strips away any properties from the incoming request body that are *not* defined in the DTO class and do not have any decorators. This helps prevent malicious users from sending extra data.
