...
const BorderStyleExample = () => {
  ...
  return (
    <div>
      <div style={{ borderTopStyle: borderStyle, borderTopWidth: '5px', borderTopColor: 'blue', width: '200px', height: '50px', marginBottom: '10px' }}>
...
const BorderStyleDropdownExample = () => {
  ...
  return (
    <div>
      <div style={{ borderTopStyle: selectedStyle, borderTopWidth: '5px', borderTopColor: 'green', width: '200px', height: '50px', marginBottom: '10px' }}>
