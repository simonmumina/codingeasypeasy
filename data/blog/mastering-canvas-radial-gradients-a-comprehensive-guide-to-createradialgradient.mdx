...
date: '2024-01-02'
lastmod: '2024-10-27'
tags: ['canvas', 'javascript', 'html5', 'graphics', 'radial gradient', 'createRadialGradient', 'web development', 'tutorial', 'code example']
draft: false
...
*   The starting and ending circles do *not* have to be the same. You can create gradients with different centers and radii for various effects.
