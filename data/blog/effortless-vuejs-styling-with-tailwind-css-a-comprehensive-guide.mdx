...
date: '2024-02-29'
lastmod: '2024-03-08'
tags: ['vuejs', 'tailwind css', 'css', 'frontend development', 'styling', 'components', 'responsive design']
draft: false
...
```vue
<template>
  <div class="bg-gray-100 py-6 px-4 rounded-lg shadow-md">
    <h2 class="text-2xl font-bold text-gray-800 mb-2">Welcome to My Vue App!</h2>
