...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['svelte', 'ssr', 'ssg', 'server-side rendering', 'static site generation', 'sveltekit', 'performance', 'seo', 'web development']
draft: false
...
Each time a user requests this page, the server will execute the `load` function, fetch the data, and render the component with the fetched data *before* sending it to the browser.
