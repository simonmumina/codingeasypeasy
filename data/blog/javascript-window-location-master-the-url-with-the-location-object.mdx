...
date: '2024-01-26'
lastmod: '2024-01-27'
tags: ['javascript', 'web development', 'url', 'location object', 'browser api', 'front-end', 'window object', 'javascript tutorial', 'url manipulation']
draft: false
...
*   **`replace(url)`**:  Replaces the current document with a new one at the specified `url`.  **Crucially, this does *not* create a new entry in the browser's history.** This is useful when you want to redirect without allowing the user to navigate back to the previous page.
