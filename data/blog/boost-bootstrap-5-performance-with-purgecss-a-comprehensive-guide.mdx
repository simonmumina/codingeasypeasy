...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['bootstrap', 'purgecss', 'css optimization', 'front-end development', 'web performance', 'bootstrap 5']
draft: false
...
*   **Configure Webpack:**
    ...
    module.exports = {
      ...
      plugins: [
        new PurgeCSSPlugin({
          ...
          safelist: {
              standard: [/collapse/, /show/, /fade/, /collapsing/, /modal/, /d-block/, /d-none/, /position-fixed/, /dropdown-menu/, /dropdown-item/, /show/, /^tooltip/, /^bs-tooltip/, /^bs-popover/, /^popover/, /^carousel/, /^carousel-item/, /^carousel-control/, /^carousel-indicators/]
          },
          extractors: [
            {
    ...
    *   **`safelist`**:  This is a crucial option. It allows you to specify CSS selectors that should *never* be removed by PurgeCSS.  Bootstrap and other libraries often rely on JavaScript to dynamically add and remove classes. If PurgeCSS removes these classes, your website will break.  The example above includes common Bootstrap classes and functionalities that frequently need to be safelisted. Add any other classes you use dynamically.  We've included common Bootstrap classes. *Carefully analyze your project and add any missing classes to the `safelist`.*
