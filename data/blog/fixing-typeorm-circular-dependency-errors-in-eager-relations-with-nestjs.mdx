...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['nestjs', 'typeorm', 'circular dependency', 'eager relations', 'orm', 'database', 'typescript', 'nestjs best practices']
draft: false
...
While `forwardRef` can be used to break circular dependencies in NestJS's dependency injection, it's generally *not* the preferred solution for TypeORM eager relation issues. `forwardRef` defers the resolution of a dependency until runtime, which can mask underlying architectural problems and potentially introduce unexpected behavior.
