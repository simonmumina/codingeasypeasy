...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['material-ui', 'mui', 'react', 'drawer', 'navigation', 'ui-components', 'frontend-development', 'tutorial']
draft: false
...
The simplest type of drawer is the *permanent* drawer, also known as persistent drawer. This drawer is always visible and typically placed on the left side of the screen, especially on wider screens. It commonly remains on the page as a sidebar for navigation.
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <Typography paragraph>
          ...
          tempor incididunt ut labore et dolore magna aliqua. ... (rest of the content)
        </Typography>
      </Box>
    </Box>
  );
...
The *temporary* drawer is hidden by default and appears when triggered, often by clicking a hamburger menu icon.  It's ideal for mobile navigation.
...
The *persistent* drawer acts as a hybrid between permanent and temporary drawers. It's typically visible on larger screens but collapses into a temporary drawer on smaller screens.  This offers the best of both worlds in terms of responsiveness and user experience.
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          {['Inbox', 'Starred', 'Send email', 'Drafts'].map((text, index) => (
            <ListItem button key={text} sx={{ minHeight: 48, justifyContent: open ? 'initial' : 'center', px: 2.5, }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        <Typography paragraph>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
          tempor incididunt ut labore et dolore magna aliqua. ... (rest of content)
        </Typography>
      </Box>
    </Box>
  );
