...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['queueing theory', 'little law', 'performance modeling', 'system analysis', 'mathematical modeling', 'optimization', 'waiting lines', 'systems engineering']
draft: false
...
2.  **Calculate number of customer being served at each time:** This is equal to the number of agent * average service time. So L_s = 5 * 0.05 = 0.25
...
4.  **Apply Little's Law**: Using L = λ * W,  we have 10.25 = 100 * W
...
1.  **Apply Little's Law**: Using L = λ * W, we have 5 = 50 * W
...
1.  **Apply Little's Law**: Using L = λ * W, we have 1000 = 200 * W
...
*   **Doesn't Explain "Why":**  Little's Law tells you *what* the relationship is, but not *why* it is that way. It's a descriptive, not prescriptive, tool.
