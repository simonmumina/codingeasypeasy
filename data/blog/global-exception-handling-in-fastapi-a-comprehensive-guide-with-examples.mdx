...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['fastapi', 'python', 'exception handling', 'api development', 'error handling', 'global exception handler']
draft: false
...
*   Middleware sits *outside* the FastAPI dependency injection system.  Therefore, you cannot directly use dependencies within your middleware.
*   Middleware can significantly impact performance. Ensure your middleware logic is efficient.
*   Use middleware judiciously.  Exception handlers registered with `@app.exception_handler` are generally preferred for handling exceptions raised *within* route handlers.
