...
*   **`@use`**: Loads another stylesheet as a *module*, preventing global scope pollution. You access variables and mixins from the used module with a namespace (unless you explicitly hide or configure it).
