...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['permutation test', 'hypothesis testing', 'R programming', 'non-parametric test', 'statistical analysis', 'data science', 'statistical significance', 'resampling']
draft: false
...
*   **Alternatives**:  If your sample size is exceptionally small, consider exact permutation tests (where you iterate through *all* possible permutations, not just a sample).  These become computationally intractable quickly as sample sizes increase.
