...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['SQL', 'BETWEEN Operator', 'SQL Tutorial', 'Database Queries', 'SQL Range', 'SQL WHERE Clause']
draft: false
...
To select products with a price *outside* the range of $100 and $500, you can use the `NOT BETWEEN` operator:
...
*   **Inclusivity:** Remember that the `BETWEEN` operator is *inclusive*, meaning it includes both the starting and ending values in the range.
