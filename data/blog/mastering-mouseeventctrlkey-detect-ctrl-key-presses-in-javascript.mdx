...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['javascript', 'mouseevent', 'ctrlkey', 'event handling', 'web development', 'keyboard shortcuts']
draft: false
...
<div id="imageContainer" style="width: 500px; height: 300px; overflow: hidden;">
  <img id="myImage" src="your-image.jpg" alt="Zoomable Image" style="width: 100%; height: 100%; object-fit: contain;">
</div>
```
...
imageContainer.addEventListener('wheel', function(event) {
    event.preventDefault();
    if (event.ctrlKey) { // Only zoom if Ctrl key is pressed
