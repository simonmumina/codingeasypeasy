...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['react', 'wavesurfer.js', 'audio player', 'audio visualization', 'web audio', 'javascript', 'ui component']
draft: false
...
const App = () => {
  const audioUrl = 'https://file-examples.com/storage/fe61324f7a660a0316c2880/2017/11/file_example_MP3_1MG.mp3'; // Replace with your audio URL
