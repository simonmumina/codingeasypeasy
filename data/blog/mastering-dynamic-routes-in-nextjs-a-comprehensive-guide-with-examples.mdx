...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['next.js', 'dynamic routes', 'routing', 'server-side rendering', 'client-side routing', 'getStaticPaths', 'getStaticProps', 'getServerSideProps', 'ISR', 'incremental static regeneration']
draft: false
...
*   The fetched post data is then passed as the `post` prop to the `Post` component.  Notice we *don't* need `getStaticPaths` here.
