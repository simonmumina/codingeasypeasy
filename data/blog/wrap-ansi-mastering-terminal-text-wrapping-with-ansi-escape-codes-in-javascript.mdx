...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['wrap-ansi', 'ansi escape codes', 'terminal formatting', 'javascript', 'cli', 'console', 'text wrapping', 'node.js']
draft: false
...
const text = 'This is a long string of text that contains ANSI escape codes to add color and styling to the terminal output.';
...
const text = chalk.red('This is a long') + ' ' + chalk.green('string of text') + ' that contains ANSI escape codes to add color and styling to the terminal output.';
