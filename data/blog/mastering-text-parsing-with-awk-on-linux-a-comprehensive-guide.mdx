...
date: '2024-01-01'
lastmod: '2024-01-05'
tags: ['awk', 'linux', 'text processing', 'command line', 'scripting', 'data manipulation', 'text parsing', 'gawk']
draft: false
...
*   `BEGIN`:  This block is executed *before* any input lines are processed. It's often used to initialize variables or print a header.
*   `END`:  This block is executed *after* all input lines have been processed.  It's typically used to print summary information or perform final calculations.
