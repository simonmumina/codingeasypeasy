...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['CSS', 'Masking', 'Web Design', 'Front-End Development', 'Image Effects', 'Creative CSS', 'Clipping', 'Web Development', 'UI Design', 'UX Design']
draft: false
...
The `mask-mode` property determines *how* the `mask-image` is used. Key options include:
