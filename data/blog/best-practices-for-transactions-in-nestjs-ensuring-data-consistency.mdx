...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['nestjs', 'transactions', 'database', 'orm', 'typeorm', 'sequelize', 'data consistency', 'best practices']
draft: false
...
While some databases support nested transactions, they can be complex and difficult to manage.  Instead of nesting transactions, consider using *savepoints* if you need to create checkpoints within a transaction. Savepoints allow you to rollback to a specific point within a transaction without rolling back the entire transaction.
