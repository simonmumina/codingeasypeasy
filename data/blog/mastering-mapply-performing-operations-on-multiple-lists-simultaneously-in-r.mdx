...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['R programming', 'mapply', 'functional programming', 'list operations', 'data manipulation', 'vectorization']
draft: false
