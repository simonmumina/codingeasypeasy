...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['tailwind css', 'theme variables', 'configuration', 'css variables', 'customization', 'design system', 'frontend development']
draft: false
...
*   **`theme`**:  This object is where you define your custom theme variables.  Within the `theme` object, you can:
    *   **`extend`**:  This is the most common way to customize the theme.  The `extend` object allows you to *add* new values to the default theme without completely overriding it.
