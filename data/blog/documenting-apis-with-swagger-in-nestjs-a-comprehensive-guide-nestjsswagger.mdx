...
date: '2024-01-16'
lastmod: '2024-01-16'
tags: ['nestjs', 'swagger', 'api documentation', 'openapi', 'typescript', 'rest api', 'nestjs/swagger', 'api design', 'backend']
draft: false
...
export class Item {
  @ApiProperty({ description: 'The ID of the item', example: '123e4567-e89b-12d3-a456-426614174000' })
  id: string;
