...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['canvas', 'javascript', 'html5', 'graphics', 'imageData', 'pixel manipulation', 'web development', 'performance']
draft: false
...
*   **`existingImageData` (ImageData):**  An existing `ImageData` object.  This form creates a new `ImageData` object with the same dimensions as the provided `existingImageData`. Importantly, it creates a *new* `ImageData` object, copying the dimensions but **not** the pixel data.
