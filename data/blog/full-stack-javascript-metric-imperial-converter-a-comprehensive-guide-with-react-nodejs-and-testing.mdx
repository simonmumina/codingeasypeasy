...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['javascript', 'react', 'node.js', 'express', 'metric-imperial', 'converter', 'full-stack', 'testing', 'mocha', 'chai', 'frontend', 'backend', 'api']
draft: false
...
1.  **Create `converter.js`:** This file will contain the conversion functions.
    ...
    function convertToImperial(value, unit) {
        switch (unit) {
            case 'km': return { value: value * 0.621371, unit: 'mi' };
            case 'm': return { value: value * 3.28084, unit: 'ft' };
            case 'cm': return { value: value * 0.393701, unit: 'in' };
            case 'g': return { value: value * 0.035274, unit: 'oz' };
            case 'kg': return { value: value * 2.20462, unit: 'lb' };
            case 'l': return { value: value * 0.264172, unit: 'gal' };
    ...
    function convertToMetric(value, unit) {
        switch (unit) {
            case 'mi': return { value: value * 1.60934, unit: 'km' };
            case 'ft': return { value: value * 0.3048, unit: 'm' };
            case 'in': return { value: value * 2.54, unit: 'cm' };
            case 'oz': return { value: value * 28.3495, unit: 'g' };
            case 'lb': return { value: value * 0.453592, unit: 'kg' };
            case 'gal': return { value: value * 3.78541, unit: 'l' };
            default: return null; // Invalid unit
        }
    }
    ...
    function App() {
      ...
      return (
        <div style={{ fontFamily: 'Arial', padding: '20px' }}>
          ...
          <button onClick={handleConvert} style={{ padding: '10px', backgroundColor: '#4CAF50', color: 'white', border: 'none', cursor: 'pointer' }}>
            Convert
          </button>
