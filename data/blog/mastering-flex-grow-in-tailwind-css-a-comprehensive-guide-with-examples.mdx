...
date: '2024-10-27'
lastmod: '2024-10-28'
tags: ['tailwind', 'flexbox', 'flex-grow', 'css', 'responsive design', 'ui development', 'tailwind css tutorial']
draft: false
...
<div className="flex w-full bg-gray-100">
  ...
  <div className="bg-green-200 p-4 flex-grow">Item 2 (Grows)</div>
</div>
```
...
If you want to ensure an item *doesn't* grow, use `flex-grow-0`:

```jsx
<div className="flex w-full bg-gray-100">
  <div className="w-32 bg-blue-200 p-4 flex-grow">Item 1 (Grows)</div>
  <div className="w-32 bg-red-200 p-4 flex-grow-0">Item 2 (No Growth)</div>
  <div className="w-32 bg-yellow-200 p-4 flex-grow">Item 3 (Grows)</div>
</div>
```
...
```jsx
<div className="flex w-full bg-gray-100">
  <div className="w-32 bg-blue-200 p-4 flex-grow-1">Item 1</div>
  <div className="w-32 bg-green-200 p-4 flex-grow-2">Item 2</div>
  <div className="w-32 bg-yellow-200 p-4 flex-grow-3">Item 3</div>
</div>
```
...
```jsx
<div className="flex w-full bg-gray-100">
  <div className="w-32 bg-blue-200 p-4 flex-grow md:flex-grow-0">Item 1</div>
  <div className="bg-green-200 p-4 flex-grow">Item 2</div>
</div>
```
...
*   On medium screens and larger, "Item 1" will *not* grow (`md:flex-grow-0`).  "Item 2" will expand to fill the remaining space.
...
```jsx
<div className="flex w-full bg-gray-100 justify-between">
  <div className="w-32 bg-blue-200 p-4 flex-shrink-0">Item 1</div>
  <div className="bg-green-200 p-4 flex-grow">Item 2</div>
  <div className="w-32 bg-yellow-200 p-4 flex-shrink-0">Item 3</div>
</div>
```
