...
date: '2024-02-29'
lastmod: '2024-10-27'
tags: ['reactjs', 'react', 'css', 'javascript', 'styling', 'classnames', 'tailwindcss', 'conditional classes']
draft: false
...
function MyComponent({ isActive }) {
  return (
    <div
      className={`my-component my-component--default ${
  ...
  return (
    <div
      className={classnames(
        'bg-gray-100 p-4 rounded-md', // Base Tailwind classes
        {
