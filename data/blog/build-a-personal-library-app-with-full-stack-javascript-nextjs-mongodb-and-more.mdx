...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['next.js', 'javascript', 'mongodb', 'full-stack', 'personal-library', 'mern-stack', 'react', 'node.js', 'web-development', 'coding-tutorial']
draft: false
            ...
            {books.map((book) => (
              <li key={book._id} className={styles.bookItem}>
                ...
                <div className={styles.bookActions}>
                  <button onClick={() => handleEdit(book)} className={styles.editButton} aria-label="Edit"><FaEdit /></button>
                  <button onClick={() => handleDelete(book._id)} className={styles.deleteButton} aria-label="Delete"><FaTrash /></button>
                </div>
              </li>
            ))}
          </ul>
