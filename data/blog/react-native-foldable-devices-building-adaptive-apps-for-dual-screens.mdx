...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['react-native', 'foldable devices', 'dual screen', 'android', 'mobile development', 'adaptive layout', 'UI design', 'device posture', 'expo', 'javascript']
draft: false
...
const App = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.contentContainer, isSpanned ? styles.spannedContent : styles.singleScreenContent]}>
