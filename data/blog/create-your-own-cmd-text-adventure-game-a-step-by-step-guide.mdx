...
date: '2024-01-01'
lastmod: '2024-01-01'
tags: ['cmd', 'batch scripting', 'text adventure game', 'game development', 'command line', 'tutorial', 'windows', 'beginner']
draft: false
...
*   `set key=0`: Initializes a variable named `key` to `0`.  This represents the player *not* having the key.
