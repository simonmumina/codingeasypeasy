...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['javascript', 'jquery', 'web development', 'front-end', 'javascript framework', 'dom manipulation', 'performance', 'modern javascript']
draft: false
...
Essentially, jQuery is built *on top* of JavaScript.  It provides a layer of abstraction that simplifies common JavaScript tasks.
