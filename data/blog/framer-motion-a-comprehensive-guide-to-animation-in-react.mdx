...
*   **Ease of Use:** Framer Motion offers a declarative API, making animations easier to define and manage.  You specify *what* you want to animate, not *how* to animate it.
...
function VariantsExample() {
  return (
    ...
    >
      <motion.li variants={itemVariants} style={{ marginBottom: "10px" }}>Item 1</motion.li>
      <motion.li variants={itemVariants} style={{ marginBottom: "10px" }}>Item 2</motion.li>
      <motion.li variants={itemVariants} style={{ marginBottom: "10px" }}>Item 3</motion.li>
    </motion.ul>
  );
}
