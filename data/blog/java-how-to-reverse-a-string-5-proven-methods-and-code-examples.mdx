...
This method reverses the string *in-place* by swapping characters from the beginning and end of the string until the middle is reached. It's an efficient approach that doesn't require creating additional data structures. It also utilizes XOR swapping, which can be faster under some circumstances.
