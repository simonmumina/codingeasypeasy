...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['node.js', 'fs module', 'file system', 'javascript', 'asynchronous programming', 'synchronous programming', 'file handling', 'streams', 'file operations', 'nodejs tutorial']
draft: false
...
*   `fs.rmdir()` and `fs.rmdirSync()` delete an *empty* directory.
