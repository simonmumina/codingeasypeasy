...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['dataframes', 'python', 'r', 'data analysis', 'pandas', 'dplyr', 'data science', 'data manipulation']
draft: false
...
While you *can* create a data.frame directly in R, `dplyr` works seamlessly with them, and importing data is typically the way to start.
