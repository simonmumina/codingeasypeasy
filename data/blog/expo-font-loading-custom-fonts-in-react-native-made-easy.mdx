...
date: '2023-10-27'
lastmod: '2024-01-05'
tags: ['react-native', 'expo', 'font', 'custom fonts', 'expo-font', 'app development', 'mobile development']
draft: false
...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      <Text style={{ fontFamily: 'custom-font', fontSize: 24 }}>This text uses my custom font!</Text>
