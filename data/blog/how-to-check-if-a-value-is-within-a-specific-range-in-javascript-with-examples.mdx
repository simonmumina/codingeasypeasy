...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['javascript', 'range checking', 'number validation', 'conditional logic', 'programming tutorial', 'javascript examples']
draft: false
...
The code above uses *inclusive* range checking, meaning that the minimum and maximum values are included in the range.  If you need an *exclusive* range (where the minimum and maximum values are *not* included), you would use `>` and `<` instead of `>=` and `<=`.
