...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['mysql', 'database', 'sql', 'conv', 'number base conversion', 'decimal to binary', 'decimal to hexadecimal']
draft: false
...
This converts the number 210 in base-3 to its equivalent in base-5.  In base-10, 210 (base-3) is (2 * 3^2) + (1 * 3^1) + (0 * 3^0) = 18 + 3 + 0 = 21.  And 21 (base-10) is 14 in base-5 (1 * 5^1) + (4 * 5^0) = 5 + 4 = 9.  Oops! Let's try that again:
