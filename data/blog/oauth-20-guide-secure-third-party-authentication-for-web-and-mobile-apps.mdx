...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['oauth', 'authentication', 'security', 'third-party authentication', 'api', 'openid connect', 'authorization', 'web development', 'mobile development', 'node.js', 'react', 'next.js']
draft: false
...
OAuth 2.0 (Open Authorization) is an authorization framework that allows a third-party application (your application) to access resources hosted by a resource server (e.g., Google, Facebook) on behalf of a user, *without* requiring the user to share their credentials (username and password) with your application. Instead, the user authorizes your application to access specific data or perform actions on their behalf.
