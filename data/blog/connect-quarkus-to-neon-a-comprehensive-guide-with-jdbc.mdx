...
date: '2024-01-01'
lastmod: '2024-10-27'
tags: ['quarkus', 'neon', 'postgresql', 'jdbc', 'database', 'java', 'cloud database', 'serverless', 'connection pooling', 'orm']
draft: false
...
2.  **Add the following configuration properties:**  Replace the placeholders with your actual Neon connection details.
    ...
    *   **`quarkus.flyway.migrate-at-start`**:  If you are not using Flyway for database migrations, disable it to prevent errors.  If you *are* using Flyway, configure it appropriately.
