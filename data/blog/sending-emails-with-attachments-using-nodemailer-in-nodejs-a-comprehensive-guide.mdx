...
**Important Security Note:**  For production environments, **never** hardcode your email credentials directly in your code.  Use environment variables or a secure configuration management system.  For this tutorial, we'll show the direct approach for simplicity, but *remember to use environment variables in your own projects!*
