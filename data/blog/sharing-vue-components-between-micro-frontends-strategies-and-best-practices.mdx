...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['vue', 'micro-frontends', 'component sharing', 'web development', 'javascript', 'frontend architecture', 'federated modules', 'vue cli', 'single spa']
draft: false
...
*   **`shared: ['vue']`:**  This is **crucial** to avoid loading multiple instances of Vue.  Include it in *both* the providing and consuming applications. Ensure the Vue versions match (or are compatible) for both.
