...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['python', 'TypeError', 'int object is not iterable', 'debugging', 'python errors', 'iterable', 'loops', 'data structures']
draft: false
...
If you're dealing with strings that represent numbers, remember to convert them to integers *before* performing arithmetic operations or using them where integers are expected.
