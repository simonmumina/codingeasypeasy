...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['linux', 'swap space', 'memory management', 'performance tuning', 'sysadmin', 'virtual memory']
draft: false
...
Disabling swap entirely should be done with extreme caution and is generally *not* recommended unless you have a very specific use case and a thorough understanding of your system's memory requirements.  Disabling swap can lead to:
