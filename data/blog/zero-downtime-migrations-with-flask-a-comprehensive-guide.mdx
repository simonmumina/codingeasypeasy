...
date: "2024-10-26"
lastmod: "2024-10-27"
tags: ["flask", "database migrations", "alembic", "zero downtime deployment", "python", "devops", "blue green deployment", "application deployment"]
draft: false
...
This is a *very* simplified example and production setups will require more configuration.
