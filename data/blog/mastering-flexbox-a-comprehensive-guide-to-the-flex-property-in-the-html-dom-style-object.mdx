...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['flexbox', 'css', 'html', 'dom', 'javascript', 'flex property', 'web development', 'responsive design', 'front-end', 'style object']
draft: false
...
The `flex-basis` property specifies the initial size of the flex item before any available space is distributed. It's similar to `width` or `height`, but it applies specifically to the flex item's main size (depending on `flex-direction` – either width or height).
