...
date: '2024-01-02'
lastmod: '2024-10-27'
tags: ['css', 'color-mix', 'color blending', 'css functions', 'web development', 'front-end', 'css tutorial', 'css tips']
draft: false
...
```jsx live
<div style={{backgroundColor: 'color-mix(in srgb, red 75%, blue 25%)', color: 'white', padding: '10px'}}>
...
```jsx live
<div style={{backgroundColor: 'color-mix(in srgb, #FF0000 60%, #0000FF 40%)', color: 'white', padding: '10px'}}>
...
```jsx live
<div style={{backgroundColor: 'color-mix(in srgb, white 90%, black 10%)', color: 'black', padding: '10px'}}>
...
```jsx live
<div>
  <div style={{backgroundColor: 'color-mix(in srgb, red, green)', color: 'white', padding: '10px', marginBottom: '5px'}}>
    sRGB Blend: Red + Green
  </div>
  <div style={{backgroundColor: 'color-mix(in lch, red, green)', color: 'white', padding: '10px'}}>
    LCH Blend: Red + Green
  </div>
</div>
```
