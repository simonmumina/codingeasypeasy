...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['react', 'data visualization', 'click events', 'interactive charts', 'javascript', 'user interface', 'ui development', 'dynamic text', 'event handling', 'state management']
draft: false
...
// src/data.js
const data = [
  { id: 1, name: 'Category A', value: 25, description: 'This category represents a significant portion of the data.' },
  { id: 2, name: 'Category B', value: 40, description: 'Category B shows a growing trend over the past year.' },
  { id: 3, name: 'Category C', value: 15, description: 'Category C remains relatively stable.' },
  { id: 4, name: 'Category D', value: 20, description: 'Category D has experienced recent fluctuations.' },
];
