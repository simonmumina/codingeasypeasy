...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['d3.js', 'data visualization', 'javascript', 'interactive charts', 'svg', 'front-end development', 'data-driven documents']
draft: false
...
D3.js revolves around the concept of *selections*. A selection is a group of DOM elements that you can manipulate. You can select elements using CSS-style selectors:
...
The power of D3.js lies in its ability to *bind* data to DOM elements. This means that D3.js will iterate over your data and create or update elements based on the data.  The primary methods for data binding are `.data()` and `.join()`:
