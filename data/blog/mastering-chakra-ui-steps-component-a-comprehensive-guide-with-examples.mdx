...
function BasicSteps() {
  const { activeStep, isFirstStep, isLastStep, nextStep, prevStep, setStep } =
    useSteps({
      initialStep: 0,
    })
...
<StepIndicator>
    <StepStatus
        complete={<StepIcon as={CheckIcon} />}
        incomplete={<Box bg="gray.200" color="gray.600" borderRadius="full" width="24px" height="24px" display="flex" alignItems="center" justifyContent="center"><Text fontSize="sm">1</Text></Box>}
        active={<Box bg="blue.200" color="blue.600" borderRadius="full" width="24px" height="24px" display="flex" alignItems="center" justifyContent="center"><Text fontSize="sm">1</Text></Box>}
    />
</StepIndicator>
```
...
function FormikSteps() {
  const { activeStep, isFirstStep, isLastStep, nextStep, prevStep } =
    useSteps({
      initialStep: 0,
    })
