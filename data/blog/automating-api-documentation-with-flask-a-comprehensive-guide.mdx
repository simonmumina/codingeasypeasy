...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['flask', 'api documentation', 'swagger', 'openapi', 'automation', 'python', 'rest api', 'apispec', 'flasgger']
draft: false
...
3.  **Define API Endpoint:**  We define a Flask route `/users/<int:user_id>` for retrieving a user by ID.  Crucially, we include a docstring using the "---" separator to define the OpenAPI specification for this endpoint *within* the docstring.  This includes the HTTP method (`get`), a description, parameters, and responses.
