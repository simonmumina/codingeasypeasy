...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['pandas', 'data analysis', 'python', 'indexing', 'conditional selection', 'data manipulation', 'dataframe', 'series']
draft: false
...
`.loc[]` also supports slicing using labels.  **Crucially, slicing with `.loc[]` is *inclusive* of the end label.**
...
`.iloc[]` also supports slicing using integer positions. **Slicing with `.iloc[]` is *exclusive* of the end position.**
