...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['chakra-ui', 'react', 'portal', 'overlay', 'modal', 'javascript', 'accessibility', 'ui-components', 'web-development']
draft: false
...
1.  We create a new `div` element dynamically using `document.createElement('div')` and give it an ID (`my-portal-container`). This avoids potential conflicts with existing elements in the DOM.  Critically, we append it to `document.body` *after* creation.
