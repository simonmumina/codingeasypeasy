...
2.  **Implement the API Logic:**
    ...
    function generatePrompt(ingredients, cuisine, restrictions, difficulty) {
      const ingredientList = ingredients.split(',').map(item => item.trim()).join(', ');
      ...
      prompt += " Please provide a detailed recipe, including instructions and ingredient quantities.";
      return prompt;
    }
    ```
      ...
      return (
        <div className="container mx-auto p-4">
          ...
          <form onSubmit={handleSubmit} className="mb-4">
            ...
            <div className="mb-2">
              <label htmlFor="restrictions" className="block text-gray-700 text-sm font-bold mb-2">
