...
date: '2024-01-01'
lastmod: '2024-10-27'
tags: ['bootstrap', 'bootstrap 5', 'utility api', 'css utilities', 'front-end development', 'web development', 'responsive design']
draft: false
summary: 'Unlock the power of Bootstrap 5's Utility API! This comprehensive guide explains how to customize and extend Bootstrap 5 using the Utility API, providing code examples and best practices for efficient and maintainable CSS.'
authors: ['default']
---
...
Once Sass is set up, import Bootstrap's Sass files into your own Sass file (e.g., `custom.scss`).  **Important:**  Make sure you import Bootstrap's functions, variables, and mixins *before* importing the main Bootstrap file. This allows you to override the default Bootstrap variables and utilities.
...
```html
<p class="fs-sm fs-md-lg">This paragraph will be small on small screens and large on medium screens and larger.</p>
```
