...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['git', 'branching', 'version control', 'older commit', 'historical branch', 'development workflow']
draft: false
...
2.  **Create the New Branch:**  Use the `git branch` command followed by the new branch name and the commit hash:
    ...
    This command creates the branch `my-new-branch` pointing to the commit `a1b2c3d4e5f6`.  However, it does *not* switch you to the new branch.
