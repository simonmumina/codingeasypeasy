...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['material-ui', 'mui', 'react', 'app-bar', 'navbar', 'ui-components', 'frontend-development', 'material-ui-tutorial']
draft: false
  ...
  return (
    <React.Fragment>
      ...
      <Typography paragraph>
        ...
        ut labore et dolore magna aliqua. ... (and so on, for a long paragraph)
      </Typography>
      <Typography paragraph>
