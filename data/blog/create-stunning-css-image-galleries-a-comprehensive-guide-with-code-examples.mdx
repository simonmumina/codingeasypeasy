...
date: "2024-01-26"
lastmod: "2024-10-27"
tags: ["CSS", "Image Gallery", "HTML", "Web Design", "Frontend Development", "Responsive Design", "CSS Grid", "CSS Flexbox", "Lightbox", "Image Optimization"]
draft: false
...
lightbox.addEventListener('click', (e) => { // Close the modal if click outside the image
