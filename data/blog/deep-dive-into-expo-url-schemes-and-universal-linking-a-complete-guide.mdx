...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['expo', 'react-native', 'url-schemes', 'universal-linking', 'deep-linking', 'mobile-development', 'ios', 'android']
draft: false
...
*   The file should contain JSON that describes which paths on your website should be associated with your app.  Here's an example:
    ...
    *   **`appID`**:  This is your app's *Team ID* followed by a dot (`.`) and your app's *Bundle Identifier*.  You can find your Team ID and Bundle Identifier in your Apple Developer account.
...
*   **HTTPS for Universal Linking:** Your website *must* be served over HTTPS for Universal Linking to work correctly.
