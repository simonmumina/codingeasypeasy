...
**Important Note:** Slices create _views_ of the original array, not copies. Modifying a slice will modify the original array. To create a copy, use the `.copy()` method:
