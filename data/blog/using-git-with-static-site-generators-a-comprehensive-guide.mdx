...
date: '2024-01-26'
lastmod: '2024-01-27'
tags: ['git', 'static site generator', 'version control', 'github', 'netlify', 'vercel', 'deployment', 'development workflow', 'jamstack']
draft: false
...
2.  **Create a `.gitignore` File:**  This file tells Git which files or folders to ignore during the version control process. Common items to ignore in static site projects include:
    ...
    *   `/public` or `/dist` (or whatever your build output folder is - unless you *really* want to track the generated files)
