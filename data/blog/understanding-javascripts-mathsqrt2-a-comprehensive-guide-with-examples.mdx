...
Imagine a grid where moving diagonally costs `Math.SQRT2` while moving horizontally or vertically costs 1. This isn't a _direct_ calculation of Euclidean distance, but rather represents a movement cost scenario often used in game development or pathfinding.
...
**4. Trigonometry (Illustrative, rarely a _direct_ use):**
