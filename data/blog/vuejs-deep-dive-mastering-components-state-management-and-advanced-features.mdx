...
date: '2023-10-27'
lastmod: '2024-02-29'
tags: ['vuejs', 'javascript', 'frontend development', 'components', 'state management', 'vuex', 'pinia', 'composition api', 'options api']
draft: false
...
<template>
  <div>
    ...
    <my-component /> <!-- Use the globally registered component -->
  </div>
</template>
...
<template>
  <div>
    ...
    <my-component name="Bob" /> <!-- Uses the default greeting -->
  </div>
</template>
```
