...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['pyramid framework', 'error logging', 'python', 'web development', 'debugging', 'logging configuration']
draft: false
...
```json
{"event": "User logged in", "user_id": 123, "username": "john.doe", "timestamp": "2024-10-27T10:00:00.000Z"}
```
