...
These properties return the interior width and height of the browser window, respectively, in pixels. This _excludes_ any browser toolbars, scrollbars, or window borders. These are read-only properties.
