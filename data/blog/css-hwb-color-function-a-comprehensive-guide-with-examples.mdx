...
- `hsl()` uses _saturation_ and _lightness_ to define colors. Saturation represents the intensity of the color, while lightness determines how bright or dark the color is.

- `hwb()` uses _whiteness_ and _blackness_.
