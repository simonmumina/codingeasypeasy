...
*   Always end your `font-family` list with a generic font family (serif, sans-serif, monospace, cursive, fantasy). This is crucial as it guarantees that *some* font will be displayed.
...
The `font-synthesis` property controls whether the browser can synthesize bold or italic versions of a font if they are not available.  By default, browsers *can* synthesize bold and italic, but the results are often less than ideal.
