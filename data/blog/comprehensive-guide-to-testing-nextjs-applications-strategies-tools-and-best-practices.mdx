...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['nextjs', 'testing', 'jest', 'react-testing-library', 'cypress', 'end-to-end testing', 'unit testing', 'integration testing', 'component testing', 'storybook']
draft: false
...
*   **Testing Input Changes:**
    ...
    describe('Input Component', () => {
      it('should update the input value when the user types', () => {
        ...
        expect(handleChange).toHaveBeenCalledWith(expect.objectContaining({ target: { value: 'test' } })); // Verify event object
      });
    });
    ```
