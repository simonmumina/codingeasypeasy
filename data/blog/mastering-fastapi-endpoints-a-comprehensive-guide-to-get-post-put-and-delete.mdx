...
date: '2024-01-01'
lastmod: '2024-01-08'
tags: ['fastapi', 'python', 'api', 'rest', 'endpoints', 'get', 'post', 'put', 'delete', 'tutorial', 'web development']
draft: false
...
```json
{"name": "Example Item", "description": "A sample item", "price": 99.99, "tax": 9.99, "price_with_tax": 109.98}
```
