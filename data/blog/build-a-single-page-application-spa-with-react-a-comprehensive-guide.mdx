...
date: '2024-02-29'
lastmod: '2024-10-27'
tags: ['react', 'spa', 'single-page application', 'javascript', 'react router', 'front-end development', 'web development', 'tutorial']
draft: false
        ...
        <Router>
          <div>
            ...
            <Routes>
              ...
              <Route path="/about" element={<About />} />
              <Route path="/contact" element={<Contact />} />
              <Route path="/users" element={<Users />} /> {/* Add a route for the Users component */}
            </Routes>
          </div>
        </Router>
      );
