...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['linux', 'networking', 'tcp/ip', 'network-configuration', 'network-administration', 'linux-commands', 'ssh', 'firewall', 'routing']
draft: false
...
This command *temporarily* sets the hostname. To make the change permanent, you'll need to edit the `/etc/hostname` file and reboot.
