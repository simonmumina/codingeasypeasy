...
<div class="border-image-example">
  This is some content with a custom border image.
</div>
```
...
<div class="gradient-border">
  This is content with a gradient border.
</div>
```
...
<div class="fancy-border">
  This div has a fancy border image.
</div>
```
...
*   **Transparency:** Images with transparency often work best for border images. Make sure the parts of the image that *aren't* part of the border are fully transparent to avoid strange overlapping effects.
