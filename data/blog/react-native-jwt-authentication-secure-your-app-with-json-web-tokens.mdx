...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['react-native', 'jwt', 'authentication', 'security', 'mobile development', 'javascript', 'token-based authentication']
draft: false
...
function generateRefreshToken(user) {
  const refreshToken = jwt.sign({ id: user.id }, jwtSecret + '_REFRESH', { // different secret or algorithm recommended in production.
