...
A **free vector** is a vector that is not tied to a specific starting point. Only its magnitude and direction are important. This is often the implicit understanding of what a vector _is_ in many mathematical contexts.
