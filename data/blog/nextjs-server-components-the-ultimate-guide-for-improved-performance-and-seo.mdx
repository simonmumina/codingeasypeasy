...
```javascript filename="app/components/DataFetcher.js"
...
```javascript filename="app/components/Counter.js"
'use client'
...
```javascript filename="app/components/Posts.js"
...
```javascript filename="app/components/PostsWithSuspense.js"
