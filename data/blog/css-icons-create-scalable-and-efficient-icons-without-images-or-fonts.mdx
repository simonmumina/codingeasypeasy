...
date: '2024-01-01'
lastmod: '2024-10-27'
tags: ['css', 'icons', 'web development', 'performance', 'accessibility', 'scalable vector graphics']
draft: false
...
While this *technically* uses a font, it's a good example of using pseudo-elements to add icon-like characters. The more powerful technique, and what we'll focus on is using shapes:
