...
date: '2024-02-29'
lastmod: '2024-03-05'
tags: ['Node.js', 'Video Call', 'WebRTC', 'Socket.IO', 'JavaScript', 'Real-time Communication', 'Web Development']
draft: false
...
*   **Signaling:**  The process of exchanging metadata between peers to establish a connection.  This includes information like session descriptions (SDP) and ICE candidates.  Signaling is *not* part of WebRTC itself;  it's a separate mechanism that uses a server (in our case, Socket.IO) to facilitate this exchange.
