...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['mongodb', 'nosql', 'database', 'nodejs', 'javascript', 'data storage', 'document database', 'aggregation framework', 'mongoose', 'atlas']
draft: false
...
async function main() {
  const uri = "mongodb+srv://<your_user>:<your_password>@<your_cluster_url>/test?retryWrites=true&w=majority"; // Replace with your Atlas connection string
...
```javascript
mongoose.connect('mongodb+srv://<your_user>:<your_password>@<your_cluster_url>/mydatabase?retryWrites=true&w=majority', {
