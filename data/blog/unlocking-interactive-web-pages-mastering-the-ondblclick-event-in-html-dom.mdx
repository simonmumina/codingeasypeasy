...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['HTML', 'DOM', 'JavaScript', 'Events', 'ondblclick', 'Web Development', 'Interactive Web', 'Event Handling']
draft: false
...
*   **Event Capturing:** This is the opposite of bubbling.  The event travels down the DOM tree, starting from the window, to the target element. Event handlers attached in the capturing phase are executed *before* those in the bubbling phase.
