...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['nodejs', 'script path', 'process', '__filename', '__dirname', 'module', 'require', 'path module', 'file system', 'absolute path', 'relative path', 'javascript']
draft: false
...
`process.cwd()` returns the current working directory of the Node.js process.  This is the directory from which the `node` command was executed.  It's *not* necessarily the same as the directory containing the script.
