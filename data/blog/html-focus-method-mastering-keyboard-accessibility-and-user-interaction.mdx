...
date: '2024-01-26'
lastmod: '2024-01-27'
tags: ['html', 'javascript', 'dom', 'accessibility', 'focus', 'keyboard navigation', 'user interaction']
draft: false
...
<form id="myForm">
  ...
  <div id="errorMessage" style="color: red; display:none;" tabindex="-1">Please enter a valid name.</div>
</form>
