...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['expo', 'react-native', 'local authentication', 'biometrics', 'fingerprint authentication', 'face id', 'passcode', 'security', 'mobile development']
draft: false
        ...
        {isBiometricAvailable ? (
          <>
            <Text>Biometrics Available</Text>
             {biometryType === LocalAuthentication.AuthenticationType.FINGERPRINT && <Text>Biometry Type: Fingerprint</Text>}
             {biometryType === LocalAuthentication.AuthenticationType.FACIAL_RECOGNITION && <Text>Biometry Type: Face ID</Text>}
