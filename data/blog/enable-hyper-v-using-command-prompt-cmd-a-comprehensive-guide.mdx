...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['Hyper-V', 'Windows', 'Command Prompt', 'CMD', 'Virtualization', 'Enable Hyper-V', 'DISM', 'Microsoft-Hyper-V-All', 'Tutorial']
draft: false
...
*   **Windows Edition:** You need a Windows 10 or Windows 11 version that supports Hyper-V.  This typically includes Windows 10/11 Pro, Enterprise, or Education editions. Home editions generally do *not* support Hyper-V.
