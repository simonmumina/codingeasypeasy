...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['cassandra', 'database', 'nosql', 'repair', 'failure recovery', 'operations', 'maintenance', 'data consistency']
draft: false
...
* **Recovery:**
  ...
  1. **Run an incremental repair:**
     ...
     The `-pr` flag tells Cassandra to only repair the *primary range* for the node, meaning the data this node is primarily responsible for.  This is a much faster and less disruptive operation than a full repair.
