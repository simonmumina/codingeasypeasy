...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['javascript', 'instanceof', 'prototype', 'object-oriented programming', 'type checking', 'coding guide']
draft: false
...
4. **Duck Typing:**  Focus on what methods and properties an object *has*, rather than its explicit type. If it walks like a duck and quacks like a duck, then it's probably a duck.  This approach is common in dynamically typed languages like JavaScript.
