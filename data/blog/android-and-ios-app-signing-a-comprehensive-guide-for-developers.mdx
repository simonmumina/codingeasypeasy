...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['android', 'ios', 'app signing', 'code signing', 'keystore', 'provisioning profile', 'developer certificate', 'google play store', 'app store', 'mobile development', 'security', 'publishing']
draft: false
