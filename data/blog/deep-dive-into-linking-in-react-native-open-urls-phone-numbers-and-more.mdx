...
date: '2024-01-01'
lastmod: '2024-01-05'
tags: ['react-native', 'linking', 'url schemes', 'mobile development', 'ios', 'android', 'deep linking']
draft: false
...
*   **`android:host`:** The `android:host` attribute is optional.  If you omit it, your app will handle *any* URL with the specified scheme.  If you include it, your app will only handle URLs with the specified scheme *and* host.
