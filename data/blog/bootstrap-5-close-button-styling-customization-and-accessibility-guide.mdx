...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['bootstrap', 'bootstrap 5', 'close button', 'styling', 'accessibility', 'javascript', 'web development', 'front-end development']
draft: false
...
*   `data-bs-dismiss="modal"`: This is the key attribute. When this attribute is added to a button *within* a modal, clicking the button will automatically close the modal.  Bootstrap's JavaScript handles the closing logic.
