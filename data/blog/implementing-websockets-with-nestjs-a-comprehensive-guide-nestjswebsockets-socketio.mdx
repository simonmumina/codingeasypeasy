...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['nestjs', 'websockets', 'socket.io', 'realtime', 'backend', 'javascript', 'typescript', 'guide', 'tutorial']
draft: false
...
<body>
  ...
  <script src="https://cdn.socket.io/4.7.2/socket.io.min.js" integrity="sha384-MZTJczjhkW0XUj+jKxMvA+Qe+W+r9QGj456Og5wQ1/jS2+9rpbw4M2qQ3g9D3H" crossorigin="anonymous"></script>
  <script>
