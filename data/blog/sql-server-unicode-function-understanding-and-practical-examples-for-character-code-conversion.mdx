...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['SQL Server', 'UNICODE()', 'Character Codes', 'ASCII', 'Unicode', 'Database', 'TSQL', 'Transact-SQL', 'String Functions', 'Character Conversion']
draft: false
...
The `UNICODE()` function only evaluates the *first* character of the string.
...
You can combine `UNICODE()` with other string functions for more complex operations.  For example, to get the Unicode value of the *second* character in a string:
