...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['probability', 'mathematics', 'paradox', 'expected value', 'st. petersburg paradox', 'game theory', 'risk aversion', 'decision theory']
draft: false
...
*   **Outcome *n* (H...HT):** Probability = 1/2<sup>n</sup>, Payout = \$2<sup>n</sup>
