...
const GridExample1 = () => {
  return (
    ...
    >
      ...
      <div style={{ backgroundColor: 'lightyellow', gridRowStart: '2', gridRowEnd: '4' }}>
        Item 4 (Row 2 to 4)
      </div>
...
const GridExample2 = () => {
  return (
    ...
    >
      ...
      <div style={{ backgroundColor: 'lightgreen' }}>Item 2</div>
      <div style={{ backgroundColor: 'lightcoral' }}>Item 3</div>
      <div style={{ backgroundColor: 'lightyellow', gridRowStart: '2', gridRowEnd: 'span 2' }}>
        Item 4 (Span 2 rows)
      </div>
      <div style={{ backgroundColor: 'lightpink' }}>Item 5</div>
      <div style={{ backgroundColor: 'lightsalmon' }}>Item 6</div>
  ...
  return (
    <div
      style={{
        display: 'grid',
        gridTemplateRows:
          '[header-start] 100px [header-end main-start] 200px [main-end footer-start] 100px [footer-end]',
        gridTemplateColumns: '1fr 1fr 1fr',
        gap: '10px',
        width: '300px',
      }}
