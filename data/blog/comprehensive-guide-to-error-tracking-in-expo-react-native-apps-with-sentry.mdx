...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['expo', 'react-native', 'sentry', 'error tracking', 'bug reporting', 'mobile development', 'javascript']
draft: false
...
Sentry.init({
  ...
  beforeSend(event, hint) {
    if (hint.originalException instanceof Error && hint.originalException.message.includes('IgnoredError')) {
