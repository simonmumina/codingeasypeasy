...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['C Programming', 'Pointers', 'Memory Management', 'Data Structures', 'Algorithms', 'C Language', 'Beginner', 'Advanced']
draft: false
...
*   **Pass by Reference:** The memory address of the variable is passed to the function. Changes made to the parameter (accessed through the pointer) *do* affect the original variable.
...
*   Because we passed the *address* of `x` to the function, the changes made inside the function directly affect the original variable `x`.
