...
date: '2024-01-25'
lastmod: '2024-01-25'
tags: ['MySQL', 'SQL', 'SUBSTR', 'Substring', 'Database', 'Function', 'Query', 'Data Manipulation', 'String Manipulation', 'Tutorial']
draft: false
...
Let's say we want to extract everything *after* the first three characters of the `product_code`.
