...
date: '2023-10-27'
lastmod: '2024-08-16'
tags: ['react', 'video.js', 'video player', 'web development', 'media player', 'react component', 'javascript']
draft: false
...
const App = () => {
  ...
  return (
    <div style={{ width: '80%', margin: '0 auto' }}> {/* Added a container for better layout */}
