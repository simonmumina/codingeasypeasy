...
date: "2024-10-27"
lastmod: "2024-10-28"
tags: ["git", "github", "git pull", "version control", "collaboration", "remote repository", "branching", "command line", "terminal"]
draft: false
...
The `--rebase` option provides an alternative to merging.  Instead of creating a merge commit, rebasing rewrites your branch's history as if you had branched off the remote branch *after* the remote branch's last commit.
