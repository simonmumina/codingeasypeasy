...
*   **Debouncing:**  Guarantees that the function is only called *after* a period of inactivity. It delays the function call until the input stops changing for the specified time period.
