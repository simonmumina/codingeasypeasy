...
On platforms like GitHub, GitLab, and Bitbucket, merging is typically done through *merge requests* (GitLab) or *pull requests* (GitHub, Bitbucket).  These requests provide a way to review the changes before they are merged into the main branch.
