...
date: '2024-01-01'
lastmod: '2024-10-27'
tags: ['bootstrap', 'react', 'vue', 'javascript', 'spa', 'frontend', 'troubleshooting', 'bootstrap 5', 'web development']
draft: false
...
*   **Import Bootstrap's JavaScript correctly:**  Instead of directly linking to Bootstrap's JavaScript file in your `index.html`, import the required modules in your React or Vue components.
    ...
    *   We use `useEffect` in React and `onMounted` in Vue to ensure the code that initializes Bootstrap components runs *after* the component has been mounted to the DOM. This is crucial because Bootstrap needs the DOM elements to exist before it can initialize tooltips, modals, etc.
...
*   **Use React/Vue Refs:**  When you *need* to interact with DOM elements directly, use React refs or Vue refs to get a reference to the element.
