...
2.  **Adding a Back Button Title:**
    ...
    ```javascript
    <Stack.Screen name="Details" component={DetailsScreen} options={{headerBackTitle: 'Back to Home'}} />
    ```
    ...
    const App = () => {
      return (
        <NavigationContainer>
          ...
          >
            <Tab.Screen name="Home" component={HomeStack} options={{headerShown: false}} />  // Use HomeStack here
