...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['react-native', 'navigation', 'performance', 'unmount', 'remount', 'stack-navigator', 'tab-navigator', 'screen-optimization', 'memoization']
draft: false
...
If you *absolutely* need to provide a key, ensure it's stable and doesn't change unnecessarily.
...
Avoid conditionally rendering entire screens based on volatile state.  If you need to show or hide a screen, consider conditionally rendering parts of the screen *content* instead of the entire `Screen` component itself. This allows the core screen component to remain mounted.
