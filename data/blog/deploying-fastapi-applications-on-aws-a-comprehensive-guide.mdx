...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['fastapi', 'aws', 'deployment', 'cloud', 'docker', 'ecs', 'ec2', 'lambda', 'api gateway', 'serverless']
draft: false
...
2.  **Create a Deployment Package:**  Create a directory structure like this:
    ...
    Create a zip file containing your code and dependencies.  Install the dependencies *inside* a `package` directory, then zip the `package` directory *and* `main.py`. This is important!
