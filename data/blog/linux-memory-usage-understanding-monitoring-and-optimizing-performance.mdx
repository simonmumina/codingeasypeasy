...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['linux', 'memory usage', 'performance monitoring', 'memory management', 'system administration', 'linux performance', 'vmstat', 'free', 'htop', 'memory optimization']
draft: false
...
*   **si:** Amount of memory swapped *in* from disk (/s).  High values indicate a problem.
*   **so:** Amount of memory swapped *out* to disk (/s).  High values indicate a problem.
