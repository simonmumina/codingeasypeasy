...
*   **Web Client ID and Android/iOS Client IDs:**  You'll need to configure these correctly in both the Firebase console *and* the respective social provider's developer console.
