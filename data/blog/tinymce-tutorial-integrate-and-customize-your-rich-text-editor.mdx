...
date: '2024-03-08'
lastmod: '2024-03-08'
tags: ['tinymce', 'rich text editor', 'html editor', 'javascript', 'web development', 'wysiwyg', 'text editing', 'tinymce integration', 'tinymce customization']
draft: false
...
tinymce.init({
  ...
  style_formats: [
    { title: 'My Custom Style', selector: 'p', classes: 'my-custom-class' }
  ]
});
```
...
tinymce.init({
  ...
  toolbar: 'undo redo | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image media table | wordcount',
