...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['react', 'performance', 'optimization', 'react-fast-compare', 'memoization', 'equality check', 'javascript']
draft: false
...
*   When you need to ensure that your components only re-render when the *values* of the props or state have changed, not just their references.
