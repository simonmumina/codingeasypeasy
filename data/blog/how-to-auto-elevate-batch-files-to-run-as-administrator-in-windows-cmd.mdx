...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['batch script', 'cmd', 'administrator', 'auto-elevate', 'windows', 'run as admin', 'elevation', 'powershell', 'VBScript', 'UAC']
draft: false
