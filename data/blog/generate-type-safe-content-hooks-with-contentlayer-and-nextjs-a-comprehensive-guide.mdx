...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['contentlayer', 'nextjs', 'typescript', 'contentful', 'headless CMS', 'type-safe', 'react hooks', 'mdx', 'content management']
draft: false
...
*   **`filter` logic:**  Allows you to pass in a filter function that will apply *after* the data is fetched.
