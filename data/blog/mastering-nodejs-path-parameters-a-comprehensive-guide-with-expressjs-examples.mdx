...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['node.js', 'express.js', 'path parameters', 'routing', 'web development', 'javascript', 'backend']
draft: false
...
Visiting `/profile` will display "Default Profile", and visiting `/profile/johnDoe` will display "Profile for user: johnDoe". This approach relies on defining separate routes to handle both scenarios. While not *technically* optional in the routing definition itself, this provides the equivalent functionality.
