...
*   **Popper.js:** Bootstrap popovers rely on Popper.js for positioning.  Make sure it's included in your project *before* Bootstrap's JavaScript. The Bootstrap bundle typically includes Popper.js.
...
**Important:**  Place the JavaScript code *after* the HTML elements you want to target, or wrap it in a `DOMContentLoaded` event listener to ensure the elements are available when the script runs:
