...
date: "2024-10-26"
lastmod: "2024-10-26"
tags: ["fastapi", "llm", "openai", "server-sent events", "streaming", "python", "real-time", "sse", "api"]
draft: false
...
<body>
  ...
  <script>
    const eventSource = new EventSource("http://localhost:8000/stream", { withCredentials: false }); // Set withCredentials to false
