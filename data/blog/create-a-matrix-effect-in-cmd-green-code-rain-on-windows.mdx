...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['cmd', 'batch script', 'matrix effect', 'windows terminal', 'programming', 'code rain', 'visual effects', 'command prompt', 'hacking aesthetic']
draft: false
