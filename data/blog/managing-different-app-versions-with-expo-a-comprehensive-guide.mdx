...
date: '2024-01-26'
lastmod: '2024-10-27'
tags: ['expo', 'react-native', 'app versions', 'versioning', 'deployment', 'updates', 'eas build', 'eas update', 'mobile development', 'ci/cd']
draft: false
...
const AppVersion = () => {
  ...
  const buildNumber = Platform.OS === 'ios' ? Constants.expoConfig?.ios?.buildNumber : Constants.expoConfig?.android?.versionCode.toString();
            ...
            [
              {
                ...
                onPress: () => {
                  ...
                  Linking.openURL(Platform.OS === 'ios' ? 'YOUR_APP_STORE_URL' : 'YOUR_PLAY_STORE_URL');
                },
              },
            ],
            { cancelable: false }
