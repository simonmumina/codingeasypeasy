...
date: '2024-01-01'
lastmod: '2024-01-05'
tags: ['contentlayer', 'nextjs', 'filtering', 'sorting', 'date', 'tags', 'markdown', 'blog', 'development']
draft: false
        ...
        <div>
          {tags.map((tag) => (
            <button
              ...
              className={`px-4 py-2 rounded-md ${selectedTags.includes(tag) ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
            >
              {tag}
            </button>
          ))}
