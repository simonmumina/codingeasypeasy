...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['vue', 'bootstrap-vue', 'b-toast', 'toast notifications', 'notification system', 'javascript', 'frontend']
draft: false
...
*   **`html: true`:**  This is crucial.  You *must* set `html: true` in the options object for the toast to render the HTML within the message correctly.  Without this, the HTML will be displayed as plain text.
