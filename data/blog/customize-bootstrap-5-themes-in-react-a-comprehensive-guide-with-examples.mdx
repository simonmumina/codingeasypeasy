...
date: '2024-01-26'
lastmod: '2024-01-27'
tags: ['react', 'bootstrap', 'css', 'theming', 'customization', 'frontend', 'ui', 'javascript', 'web development']
draft: false
...
const StyledButton = styled.button`
  background-color: ${props => props.primary ? '#007bff' : '#6c757d'}; /* Primary or Secondary colors */
  color: white;
  border: none;
  padding: 10px 20px;
  border-radius: 5px;
...
function CustomButton({ children, primary, onClick }) {
  return <StyledButton className="btn" primary={primary} onClick={onClick}>{children}</StyledButton>;
}
...
function App() {
  return (
    <div className="container mt-5">
      <h1>Bootstrap Customization Example</h1>
      <CustomButton primary onClick={() => alert('Primary Button Clicked!')}>Primary Button</CustomButton>
