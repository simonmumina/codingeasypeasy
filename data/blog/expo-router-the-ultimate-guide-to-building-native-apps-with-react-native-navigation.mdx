...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['expo', 'react-native', 'expo-router', 'navigation', 'mobile-development', 'javascript', 'app-development', 'universal-apps', 'file-based-routing']
draft: false
...
export default function HomeScreen() {
  ...
  return (
    <View>
      ...
      />
      <Button
        title="Go to User Details (ID: 123)"
