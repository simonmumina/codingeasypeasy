...
date: '2024-01-01'
lastmod: '2024-10-27'
tags: ['expo', 'expo-router', 'react-native', 'navigation', 'stack-navigator', 'mobile-development', 'react-navigation']
draft: false
...
1.  **Navigate with Query Parameters:**
    ...
    export default function Home() {
      return (
        <View style={styles.container}>
          <Text style={styles.title}>Home Screen</Text>
          <Link href={{ pathname: '/details', params: { name: 'John', age: 30 } }} style={styles.link}>
