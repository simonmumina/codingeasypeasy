...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['vuejs', 'shadowdom', 'webcomponents', 'javascript', 'frontend development', 'component development']
draft: false
...
*   `shadowRoot: { mode: 'open' }`: This is *crucial*.  It tells `defineCustomElement` to create a Shadow DOM for the component and use `open` mode which allows access to the shadow root.
...
*   The CSS defined inside the `<style scoped>` block in your Vue component is scoped to the Shadow DOM.  The CSS in the main HTML page is *not*.
