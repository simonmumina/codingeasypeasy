...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['react-native', 'flash-list', 'shopify', 'performance', 'listview', 'optimization', 'mobile development', 'ui/ux']
draft: false
...
const App = () => {
  ...
  useEffect(() => {
    ...
    if (itemHeights.length > 0) {
      const averageHeight = itemHeights.reduce((sum, height) => sum + height, 0) / itemHeights.length;
