...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['yarn', 'package manager', 'npm', 'cli', 'command line', 'javascript', 'node.js', 'yarn bin', 'executables']
draft: false
...
Yarn automatically adds `node_modules/.bin` to your `PATH` environment variable *within* Yarn's execution context. This means you can directly run executables installed in your project using `yarn <executable>`.
