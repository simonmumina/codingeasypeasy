...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['vuejs', 'vue3', 'effectscope', 'reactivity', 'composition-api', 'vue-components', 'javascript']
draft: false
...
The core idea is to create an `EffectScope` instance and then perform reactive operations (like `computed`, `watch`, or creating custom reactive functions) *within* that scope.  When the scope is disposed of, all the effects created within it are stopped automatically.
