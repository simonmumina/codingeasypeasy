...
function MyComponent() {
  return (
    <CloseButton aria-label="Close panel" onClick={() => {
...
```jsx
import { CloseButton, Modal, ModalOverlay, ModalContent, ModalHeader, ModalBody, ModalCloseButton, Button, useDisclosure, Stack } from '@chakra-ui/react';
