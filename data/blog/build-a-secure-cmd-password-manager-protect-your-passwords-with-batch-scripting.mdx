...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['cmd', 'batch script', 'password manager', 'security', 'automation', 'windows', 'cli', 'encryption', 'decryption']
draft: false
...
3.  **Decryption:** Each character of the ciphertext is XORed with the *same* character from the master password used for encryption. This reverses the encryption process, recovering the original plaintext password.
