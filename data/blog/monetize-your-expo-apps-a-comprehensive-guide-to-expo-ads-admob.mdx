...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['expo', 'react-native', 'admob', 'ads', 'monetization', 'mobile-development', 'google-admob', 'expo-ads-admob']
draft: false
...
2.  **Use the `useRewardedAd` hook:**
    ...
    * Important:  You should reward the user only *after* the `onRewarded` event is triggered.  This event is automatically handled by the `useRewardedAd` hook internally.
