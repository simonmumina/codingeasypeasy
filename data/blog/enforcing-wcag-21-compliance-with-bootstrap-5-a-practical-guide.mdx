...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['WCAG', 'Accessibility', 'Bootstrap 5', 'Web Development', 'Inclusive Design', 'ARIA', 'Web Accessibility']
draft: false
...
```html
<input type="text" id="age" name="age" class="form-control is-invalid" aria-invalid="true" aria-describedby="ageError">
