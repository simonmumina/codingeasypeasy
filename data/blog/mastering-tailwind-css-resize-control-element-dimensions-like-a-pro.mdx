...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['tailwind css', 'resize', 'responsive design', 'ui development', 'web development', 'css', 'utility classes']
draft: false
...
```jsx
<textarea className="w-full h-32 border p-2 resize-none" placeholder="Enter your text here..."></textarea>
```
...
```jsx
<textarea className="w-full h-32 border p-2 resize" placeholder="Enter your text here..."></textarea>
```
...
```jsx
<textarea className="w-full h-32 border p-2 resize-y" placeholder="Enter your text here..."></textarea>
```
...
```jsx
<textarea className="w-full h-32 border p-2 resize-x" placeholder="Enter your text here..."></textarea>
```
...
```jsx
<textarea className="w-full h-32 border p-2 resize-block" placeholder="Enter your text here..."></textarea>
```
...
```jsx
<textarea className="w-full h-32 border p-2 resize-inline" placeholder="Enter your text here..."></textarea>
```
...
```jsx
<textarea className="w-full h-32 border p-2 resize-none sm:resize-y" placeholder="Enter your text here..."></textarea>
```
