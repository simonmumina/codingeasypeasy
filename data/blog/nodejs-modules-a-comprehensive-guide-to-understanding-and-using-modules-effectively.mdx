...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['node.js', 'modules', 'require', 'exports', 'module.exports', 'esm', 'import', 'export', 'javascript', 'package manager', 'npm', 'yarn']
draft: false
...
*   Using `module.exports` allows you to export a single value directly.  If you assign a new value to `exports` *after* assigning to `module.exports`, your `exports` assignment will be ignored.  `module.exports` takes precedence.

**Important Note:** If you assign a new value to `exports` *after* assigning to `module.exports`, the `exports` assignment is ignored. `module.exports` takes precedence.
...
exports = { // this assignment will be ignored
  goodbye: () => "Goodbye!"
};
