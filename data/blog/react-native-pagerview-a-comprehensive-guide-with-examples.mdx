...
*   We define three `View` components as children of `PagerView`, each representing a page.  Each child *must* have a unique `key` prop for proper rendering and performance.
