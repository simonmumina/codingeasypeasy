...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['vuejs', 'v-for', 'performance', 'optimization', 'large lists', 'vue rendering', 'keyed v-for', 'virtual scrolling', 'pagination', 'computed properties']
draft: false
...
<template>
  <div>
    {{ item.name }} - {{ item.someStableProperty }}
  </div>
</template>
