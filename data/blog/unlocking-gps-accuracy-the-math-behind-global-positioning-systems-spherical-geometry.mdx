...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['GPS', 'Mathematics', 'Spherical Geometry', 'Trilateration', 'Navigation', 'Algorithms', 'Satellite Navigation']
draft: false
...
Spherical geometry differs significantly from the familiar Euclidean geometry we learn in school.  For instance, the shortest distance between two points on a sphere is not a straight line (which would pass *through* the sphere), but rather a *great circle* arc - a segment of a circle whose center coincides with the center of the sphere. Airlines take advantage of this when flying over long distances.
