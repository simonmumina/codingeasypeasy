...
The `useStaticQuery` hook is a React hook provided by Gatsby that allows you to query your GraphQL data layer during the build process.  This means the data is fetched *before* the website is deployed, and the fetched data is embedded directly into your static HTML and JavaScript files.
