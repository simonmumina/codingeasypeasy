...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['vue.js', 'vue router', 'lazy loading', 'performance optimization', 'dynamic imports', 'javascript']
draft: false
...
5.  You should see that the JavaScript chunk for each component is only loaded when you navigate to that route for the *first* time (unless caching is enabled, in which case the browser serves it from the cache).
