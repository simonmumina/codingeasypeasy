...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['react-native', 'machine-learning', 'mlkit', 'tensorflowjs', 'mobile-development', 'javascript', 'ai', 'artificial-intelligence']
draft: false
...
```json
{
  "expo": {
    "plugins": [
      ["expo-gl", { "importFrom": "react-native-unimodules" }]
    ]
  }
}
```
      ...
      {predictions && (
          <View>
              ...
              {predictions.map((pred, index) => (
                  <Text key={index}>Class {pred.index}: {pred.value.toFixed(3)}</Text>
              ))}
          </View>
      )}
...
module.exports = (async () => {
  ...
  return {
    ...
    resolver: {
      ...
      sourceExts: [...sourceExts, "svg", "glb", "gltf", "bin", "mtl", "obj", "ts", "tsx", "jsx", "js"]
    }
  };
})();
```
