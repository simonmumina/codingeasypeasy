...
<head>
    ...
    {% block extra_css %}{% endblock %}  <!-- Allows adding custom CSS in child templates -->
...
<body>
    ...
    {% block extra_js %}{% endblock %} <!-- Allows adding custom JS in child templates -->
...
*   **Customizing Bootstrap:**  Create a custom CSS file (e.g., `static/css/custom.css`) and link it *after* the Bootstrap CSS file in your `base.html`. This allows you to override Bootstrap's default styles.

```html
<!-- base.html -->
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet"> <!-- Or the local link -->
...
*   **Bootstrap styling not appearing:**
    *   Check the order of your CSS files in `base.html`. Custom CSS should come *after* Bootstrap CSS.
