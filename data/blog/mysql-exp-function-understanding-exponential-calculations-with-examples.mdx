...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['mysql', 'sql', 'database', 'exponential function', 'exp()', 'mathematical functions', 'data analysis', 'database tutorial', 'sql examples']
draft: false
...
The `EXP()` function in MySQL returns the exponential value of a given numeric expression. In mathematical terms, it calculates *e* raised to the power of the input number, where *e* is Euler's number (approximately 2.71828).  The result is always a floating-point number.
...
This returns the value of *e* (Euler's number) as expected.
