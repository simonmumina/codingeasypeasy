...
date: '2024-01-01'
lastmod: '2024-01-05'
tags: ['fastapi', 'python', 'api', 'query parameters', 'request parameters', 'web development', 'backend']
draft: false
...
You can also make a query parameter *required* by setting its default value to `...` (ellipsis):
