...
*   **Handle deferred deep linking.** If a user clicks on a deep link *before* installing your app, a deferred deep linking solution will persist the deep link information and automatically navigate the user to the correct content *after* the app is installed.  This requires a third-party service.
