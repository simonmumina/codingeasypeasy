...
date: '2024-01-26'
lastmod: '2024-01-27'
tags: ['linux', 'tail', 'command line', 'file manipulation', 'log files', 'system administration', 'terminal']
draft: false
...
Instead of displaying the last *n* lines, you can display all lines starting from the *n*th line. You do this by prefixing the line number with a `+` sign.
