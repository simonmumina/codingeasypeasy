...
date: '2024-01-01'
lastmod: '2024-01-01'
tags: ['melting', 'casting', 'metalworking', 'foundry', 'metals', 'jewelry making', 'lost wax casting', 'investment casting', 'sand casting', 'metal art']
draft: false
...
While you can't *actually* simulate the physical act of investment casting in code, you can simulate the process flow and some of the calculations involved. This example focuses on the volume calculation of the wax pattern:
