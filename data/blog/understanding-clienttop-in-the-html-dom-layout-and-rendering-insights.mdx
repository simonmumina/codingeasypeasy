...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['javascript', 'html', 'dom', 'clientTop', 'layout', 'rendering', 'browser', 'web development']
draft: false
...
In this example, the `moveChild` function positions the child element 20 pixels below the top border of the parent element.  We explicitly add `parent.clientTop` to account for the parent's top border, ensuring accurate positioning. Without this adjustment, the child would start its 20px offset relative to the *outer* edge of the parent.
