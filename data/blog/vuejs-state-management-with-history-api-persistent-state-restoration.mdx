...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['vue', 'vuejs', 'state management', 'history api', 'state restoration', 'spa', 'single page application', 'javascript', 'web development']
draft: false
...
export default {
  ...
  computed: {
    filteredProducts() {
      return this.showAvailable ? this.products.filter(product => product.available) : this.products;
    },
  },
  mounted() {
    this.restoreState();
