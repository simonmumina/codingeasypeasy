...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['contentlayer', 'nextjs', 'isr', 'incremental static regeneration', 'static site generation', 'content management', 'mdx']
draft: false
...
3.  **Request After Revalidation:**  When a user visits the updated blog post *after* the `revalidate` interval (e.g., 60 seconds), they will initially see the cached, old version.
