...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['SQL', 'Database', 'CREATE DATABASE', 'Database Management', 'SQL Tutorial', 'Relational Databases', 'Database Design']
draft: false
...
**Relationship between Character Set and Collation:** You *must* choose a collation that is compatible with the character set you have selected. The collation determines how data within the chosen character set is sorted and compared.
