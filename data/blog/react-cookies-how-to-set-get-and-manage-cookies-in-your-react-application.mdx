...
function SetCookieExample() {
  ...
  return (
    <button onClick={handleClick}>Set Username Cookie</button>
  );
}
...
function GetCookieExample() {
  ...
  return (
    <button onClick={handleClick}>Get Username Cookie</button>
  );
}
...
function DeleteCookieExample() {
  ...
  return (
    <button onClick={handleClick}>Delete Username Cookie</button>
  );
}
