...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['node.js', 'ssr', 'server-side-rendering', 'ejs', 'templates', 'javascript', 'web-development', 'express']
draft: false
...
<body>
  ...
  <main>
    <%- body %>  <!--  This is where the content of other templates will be inserted -->
  </main>
...
<div class="product-list">
  <% products.forEach(product => { %>
    <%- include('partials/product_card', { product: product }) %> <!-- Include the partial -->
  <% }); %>
</div>
```
