...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['R Programming', 'Statistics', 'Skewness', 'Kurtosis', 'Data Analysis', 'Data Visualization', 'Data Science', 'Statistical Analysis']
draft: false
...
The `kurtosis()` function from the `moments` package calculates the kurtosis of a dataset. Remember this calculates the *kurtosis* not *excess kurtosis*.
...
*   The kurtosis values for the right and left skewed data depend on the *shape* of the skew, but generally won't be as dramatically different from 3 as the leptokurtic data.
