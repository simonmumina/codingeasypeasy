...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['html', 'dom', 'javascript', 'input number', 'input type number', 'html forms', 'number validation', 'html dom api']
draft: false
...
*   **`checkValidity()`**: Returns `true` if the element has no validation errors; otherwise, returns `false`. This does *not* trigger a visual error report.
