...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['javascript', 'screen size', 'browser window', 'dimensions', 'responsive design', 'web development', 'viewport', 'innerWidth', 'innerHeight', 'outerWidth', 'outerHeight', 'screen.width', 'screen.height']
draft: false
