...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['Pyramid Framework', 'Python', 'Web Development', 'route_url', 'route_path', 'URL Generation', 'Routing', 'WSGI']
draft: false
...
*   `route_url()` generated the *absolute* URL: `http://localhost:6543/user/Pyramid%20User`
*   `route_path()` generated the *relative* URL path: `/user/Pyramid%20User`
