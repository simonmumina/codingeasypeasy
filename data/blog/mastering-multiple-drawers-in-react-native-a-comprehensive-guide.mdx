...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['react-native', 'drawer-navigation', 'mobile-development', 'ui-ux', 'javascript', 'navigation']
draft: false
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="Settings" component={SettingsDrawer} options={{ presentation: 'modal' }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
};
