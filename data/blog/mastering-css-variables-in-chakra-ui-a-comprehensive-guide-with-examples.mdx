...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['chakra-ui', 'css variables', 'theming', 'react', 'front-end development', 'ui components', 'customization', 'design tokens']
draft: false
...
While the above is simpler, here's how you *could* do it with CSS Variables (though less direct):
