...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['linux', 'command line', 'process management', 'system administration', 'unix', 'terminal', 'ps', 'top', 'kill', 'bg', 'fg', 'nohup']
draft: false
...
*   **`ps aux`:**  A widely used option combination that shows information about *all* processes running on the system, including those owned by other users and system processes.  This is the most comprehensive way to see what's going on.
...
When you run a command in the terminal, it typically runs in the *foreground*, meaning the terminal is blocked until the command completes. You can move processes between the foreground and background.
