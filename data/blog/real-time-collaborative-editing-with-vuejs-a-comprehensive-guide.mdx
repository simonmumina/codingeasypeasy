...
date: '2024-03-08'
lastmod: '2024-03-08'
tags: ['vuejs', 'realtime', 'collaborative editing', 'yjs', 'websockets', 'javascript', 'frontend development']
draft: false
...
<template>
  <div class="editor-container">
    ...
    <div v-for="cursor in cursors" :key="cursor.clientId" :style="{ left: cursor.position + 'px', top: '0px', backgroundColor: cursor.color }" class="cursor">
