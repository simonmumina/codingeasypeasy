...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['css', 'javascript', 'animations', 'icons', 'web development', 'frontend', 'accessibility', 'ux', 'ui']
draft: false
...
const AnimatedIconJavaScript = () => {
  ...
  return (
    <>
      <i ref={iconRef} className="fa fa-cog fa-spin" style={{ fontSize: '2em', color: '#f39c12' }} aria-hidden="true"></i>
    </>
  );
};
...
const AnimatedIconGSAP = () => {
  ...
  return (
    <>
      <i ref={iconRef} className="fa fa-sync fa-spin" style={{ fontSize: '2em', color: '#9b59b6' }} aria-hidden="true"></i>
    </>
  );
};
