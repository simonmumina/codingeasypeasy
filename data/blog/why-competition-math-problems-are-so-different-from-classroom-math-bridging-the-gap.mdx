...
**Classroom Math:** You might be asked to calculate the area of a triangle given its base and height. This is a direct application of the formula: Area = (1/2) _ base _ height.
...
**Competition Math:** Competition math emphasizes creative thinking and problem-solving skills. You're not just expected to apply formulas but to think outside the box, develop novel solutions, and adapt to unexpected challenges. It's about finding elegant and efficient solutions, often by leveraging underlying principles and making insightful connections. It's about _inventing_ the formula, not just applying it.
