...
date: '2024-01-27'
lastmod: '2024-01-27'
tags: ['javascript', 'date', 'utc', 'setUTCFullYear', 'date manipulation', 'programming', 'web development', 'ecmascript']
draft: false
...
*   `setFullYear()`: Sets the year according to the *local* time of the user's browser.
*   `setUTCFullYear()`: Sets the year according to *Universal Coordinated Time (UTC)*.
