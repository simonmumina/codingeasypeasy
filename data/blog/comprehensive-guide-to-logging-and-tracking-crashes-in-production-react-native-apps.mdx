...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['react-native', 'crash-reporting', 'error-tracking', 'debugging', 'mobile-development', 'production-debugging']
draft: false
...
```javascript
Bugsnag.leaveBreadcrumb("User pressed the 'Submit' button", {
  buttonName: 'Submit',
  formId: 'myForm',
  formType: 'feedback'
}, "user");
