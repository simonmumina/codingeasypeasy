...
- **Slicing:** Slicing creates a _view_ of the original array. Modifying a slice will modify the original array.
...
- **`ndarray.copy()`:** Creates a _copy_ of the array, allocating new memory. Modifications to the copy will not affect the original array.
