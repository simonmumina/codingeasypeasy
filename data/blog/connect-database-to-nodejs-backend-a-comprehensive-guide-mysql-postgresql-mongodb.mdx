...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['node.js', 'database', 'backend', 'mysql', 'postgresql', 'mongodb', 'javascript', 'express.js', 'orm', 'sequelize', 'mongoose']
draft: false
...
*   `sequelize.sync()`: Synchronizes the model with the database.  `{ force: true }` will drop and recreate the table, which is useful during development but should *not* be used in production as it will erase your data.
