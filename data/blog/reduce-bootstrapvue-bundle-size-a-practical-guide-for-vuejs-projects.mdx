...
date: '2024-02-29'
lastmod: '2024-03-15'
tags: ['vue.js', 'bootstrapvue', 'bundle size', 'performance optimization', 'webpack', 'tree shaking', 'code splitting', 'vue cli']
draft: false
...
In this example, `MyModal.vue` will only be loaded when it's first needed (e.g., when the user opens the modal). This is a simple but powerful technique for improving initial load times.  Remember to import the required BootstrapVue components *within* `MyModal.vue` itself for proper tree shaking.
