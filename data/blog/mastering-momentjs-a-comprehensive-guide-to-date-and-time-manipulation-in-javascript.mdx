...
date: '2023-10-27'
lastmod: '2024-10-27'
tags: ['momentjs', 'javascript', 'date manipulation', 'time formatting', 'date parsing', 'timezone', 'i18n', 'deprecated']
draft: false
...
One key limitation of Moment.js is that its objects are *mutable*.  This means that methods like `add()` and `subtract()` modify the original `moment` object directly.  This can lead to unexpected side effects if you're not careful.
