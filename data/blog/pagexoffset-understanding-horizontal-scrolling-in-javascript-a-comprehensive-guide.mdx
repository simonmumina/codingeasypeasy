...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['javascript', 'dom', 'window', 'pageXOffset', 'pageYOffset', 'scrolling', 'browser-compatibility', 'web-development']
draft: false
...
The `pageXOffset` property (also sometimes accessed as `window.scrollX`) represents the number of pixels that the document has been scrolled *horizontally* from the left edge of the visible content. In simpler terms, it tells you how far the user has scrolled to the right.
