...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['html', 'dom', 'javascript', 'images', 'document', 'object property', 'frontend development', 'web development', 'image collection', 'image manipulation']
draft: false
...
*   **`HTMLCollection`:**  Not an array, though it behaves similarly.  Important difference is that the collection is *live*.
*   **Read-Only:** You cannot directly *set* the `document.images` collection.  Instead, you modify the DOM by adding or removing `<img>` elements.
