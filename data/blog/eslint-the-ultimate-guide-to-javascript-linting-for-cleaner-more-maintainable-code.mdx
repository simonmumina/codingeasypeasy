...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['eslint', 'javascript', 'linting', 'code quality', 'coding standards', 'prettier', 'vscode', 'web development']
draft: false
...
*   **How would you like to use ESLint?** Choose one of the following options:
    *   *To check syntax, find problems, and enforce code style* (recommended for most projects)
    *   *To check syntax only*
    *   *To find problems only*
...
*   **How would you like to define a style for your project?**
    *   *Use a popular style guide* (Recommended. Choose from Airbnb, Standard, Google, etc.)
...
*   `'prettier'` is added to the `extends` array.  **Important:**  `prettier` should be the *last* element in the `extends` array to override any conflicting rules from other configurations.
