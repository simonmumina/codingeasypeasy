...
Headless UI is a set of completely unstyled, fully accessible UI components designed for React. These components provide the *behavior* and *accessibility features* you need, without imposing any specific visual style.  This allows you to build highly customized UIs that perfectly match your brand and design requirements.
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      <Menu.Items className="absolute right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-none">
        ...
        <div className="py-1">
          <Menu.Item disabled>
            <span className="block px-4 py-2 text-sm text-gray-400 cursor-not-allowed">Archive</span>
          </Menu.Item>
          <Menu.Item>
            {({ active }) => (
              <a
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Your payment has been successfully submitted. We've emailed you all the details of your transaction.
                    </p>
                  </div>
    ...
    <div className="w-full max-w-md px-2 py-16 sm:px-0">
      <Tab.Group selectedIndex={selectedIndex} onChange={setSelectedIndex}>
        ...
        <Tab.Panels className="mt-2">
          ...
          >
            <p>
              Yes, I can use another language. It would be slightly difficult at first, because I would have to
              re-learn everything. I am a language model, and therefore I am able to learn new languages.
            </p>
          </Tab.Panel>
          <Tab.Panel
            className={classNames(
          ...
          >
            <p>
              I am running. I use the information I learn to help create content that can then be used for
              other peoples application.
            </p>
          </Tab.Panel>
          <Tab.Panel
            className={classNames(
          ...
          >
            <p>
              I don't have a phone. I am running inside a computer. But I have an app that can do the same thing.
            </p>
          </Tab.Panel>
        </Tab.Panels>
      </Tab.Group>
