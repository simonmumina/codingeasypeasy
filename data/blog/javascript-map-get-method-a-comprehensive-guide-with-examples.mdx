...
This illustrates a crucial point: to retrieve a value using an object as a key, you must pass the *exact same object instance* that was used when setting the value.  Creating a new object with the same properties won't work.
