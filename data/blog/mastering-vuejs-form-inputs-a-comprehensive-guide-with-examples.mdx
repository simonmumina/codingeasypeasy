...
date: '2024-02-29'
lastmod: '2024-03-08'
tags: ['vuejs', 'vue', 'form inputs', 'forms', 'javascript', 'frontend', 'data binding', 'event handling', 'validation']
draft: false
    ...
    *   **Multiple Checkboxes:** When bound to an array, the checkbox's `value` is added to or removed from the array when the checkbox is checked or unchecked.
        ...
        <template>
          <div>
            ...
            <label>
              Red: <input type="checkbox" value="red" v-model="favoriteColors">
            </label><br>
            <label>
              Blue: <input type="checkbox" value="blue" v-model="favoriteColors">
            </label><br>
            <label>
              Green: <input type="checkbox" value="green" v-model="favoriteColors">
            </label>
...
*   **Radio Buttons (`<input type="radio">`):** `v-model` binds to the shared data property.  Only one radio button in a group can be selected at a time.
    ...
    <template>
      <div>
        ...
        <label>
          Other: <input type="radio" value="other" v-model="gender">
        </label>
