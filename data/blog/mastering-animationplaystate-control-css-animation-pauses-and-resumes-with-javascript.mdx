...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['animationPlayState', 'CSS Animation', 'JavaScript', 'HTML DOM', 'CSS Properties', 'Web Development']
draft: false
...
3.  On button click:
    *   We pause the animation *before* changing the duration. This is crucial to avoid glitches or unexpected behavior.
...
*   **Pause Before Change:**  Always pause the animation *before* modifying properties like `animationDuration`, `animationTimingFunction`, or `animationIterationCount`. This prevents visual artifacts.
