...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['javascript', 'defineProperty', 'object properties', 'descriptors', 'getters', 'setters', 'immutability', 'proxy']
draft: false
...
**Important Note:** A descriptor can be either a *data descriptor* or an *accessor descriptor*, but it cannot be both.
