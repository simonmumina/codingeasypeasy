...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['linux', 'cp command', 'copy files', 'terminal', 'command line', 'linux tutorial', 'linux commands', 'file management']
draft: false
...
*   **`--no-preserve=ATTRIBUTE_LIST`**: The opposite of `--preserve`. Specifies attributes *not* to preserve.
...
*   **With `-r`:**  `cp` will follow the symbolic link and copy the *target* file or directory. This means you'll end up with a copy of the actual data, not the symbolic link.
