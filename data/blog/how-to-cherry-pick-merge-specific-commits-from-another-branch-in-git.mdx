...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['git', 'cherry-pick', 'branching', 'version control', 'merge commit', 'git commands', 'developer workflow', 'code management']
draft: false
...
*   **`-n` or `--no-commit`:**  This option applies the changes from the commit to your working directory and staging area but *doesn't* create a new commit.  This is useful if you want to make further modifications to the changes before committing.
