...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['yarn', 'package manager', 'versioning', 'development', 'javascript', 'node.js', 'build from source', 'custom yarn version']
draft: false
...
*   `yarn`: This command uses your *existing* Yarn installation to install the dependencies required to build Yarn itself. This uses the version of yarn that is installed globally, or in the current project if you have a yarn version already set locally.
