...
date: '2024-03-08'
lastmod: '2024-03-08'
tags: ['python', 'pyramid', 'web frameworks', 'routing', 'traversal', 'url dispatch', 'web development']
draft: false
...
*   **Traversal:** A more abstract and object-oriented approach that navigates a tree-like structure of *resources*. The URL represents a path through this resource tree.
*   **URL Dispatch:** A more traditional approach that maps URL patterns directly to *views*.
...
*   **Context:** The *current* resource being accessed. The view callable (the code that handles the request) receives the context as its first argument.
...
6.  The final resource reached becomes the *context* for the view.
