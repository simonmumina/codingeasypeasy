...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['statistics', 'anomaly detection', 'outlier detection', 'grubbs test', 'data analysis', 'python', 'data science']
draft: false
...
**G<sub>critical</sub> = (t<sub>(α / (2n), n-2)</sub> * (n - 1)) / √(n * (n - 2 + t<sub>(α / (2n), n-2)</sub><sup>2</sup>))**
