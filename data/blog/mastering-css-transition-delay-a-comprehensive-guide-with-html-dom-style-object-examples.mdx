...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['CSS Transitions', 'transitionDelay', 'HTML DOM Style', 'JavaScript', 'Web Development', 'Front-End Development', 'Animation', 'CSS Animation']
draft: false
...
*   The CSS styles the `div`.  Critically, it *does not* include any `transition` properties. Those will be added dynamically via JavaScript.
