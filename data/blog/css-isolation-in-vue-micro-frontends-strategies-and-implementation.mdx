...
date: '2024-01-25'
lastmod: '2024-01-25'
tags: ['vuejs', 'microfrontends', 'css isolation', 'web development', 'frontend architecture', 'css modules', 'scoped css', 'shadow dom']
draft: false
...
*   **Child Component Styling:**  Scoped CSS does *not* automatically apply to child components. If you need to style a child component, you'll need to use a more specific selector or use one of the other techniques described here.
