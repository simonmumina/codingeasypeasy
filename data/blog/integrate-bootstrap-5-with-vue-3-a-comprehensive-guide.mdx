...
2.  **Create a Custom Sass File:** Create a file (e.g., `src/assets/scss/custom.scss`) and import Bootstrap's source Sass files.  Override the default variables *before* importing Bootstrap:
...
*   **Bootstrap Styles Not Applied:**
    ...
    *   Ensure your custom CSS overrides are imported *after* Bootstrap's CSS.
