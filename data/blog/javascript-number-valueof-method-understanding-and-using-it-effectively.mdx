...
- **`valueOf()`:** Returns the _primitive value_ of the object. For `Number` objects, this is the numeric value itself.
- **`toString()`:** Returns a _string representation_ of the object. For `Number` objects, this is a string containing the number.
