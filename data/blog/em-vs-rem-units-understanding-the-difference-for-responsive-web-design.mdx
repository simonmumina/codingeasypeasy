...
date: '2024-08-26'
lastmod: '2024-08-26'
tags: ['em units', 'rem units', 'css units', 'responsive design', 'web development', 'accessibility', 'front-end development', 'font-size', 'typography', 'scaling']
draft: false
