...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['nextjs', 'api routes', 'middleware', 'authentication', 'authorization', 'request validation', 'server-side', 'javascript', 'typescript']
draft: false
...
*   **`/dashboard((?!_next).*)`:**  Matches all paths under `/dashboard` *except* for those starting with `_next` (useful for excluding Next.js internal files).
