...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['vercel', 'ai', 'sdk', 'next.js', 'react', 'openai', 'generative ai', 'streaming', 'serverless functions', 'edge functions', 'prompt engineering']
draft: false
...
export default function Home() {
  return (
    <div>
      <h1 className="text-2xl font-bold mb-4 text-center">Vercel AI SDK Chat Example</h1>
      <ChatInterface />
    </div>
  );
}
