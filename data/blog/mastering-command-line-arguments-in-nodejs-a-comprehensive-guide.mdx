...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['node.js', 'command line arguments', 'process.argv', 'cli', 'javascript', 'programming', 'tutorial']
draft: false
...
const argv = yargs(hideBin(process.argv))
  ...
  .command('greet <name>', 'Greets the user', (yargs) => {
...
*   **`.parse(process.argv)`**: Parses the command-line arguments using `process.argv`.  Crucially, `commander` *does* require the whole `process.argv`.
