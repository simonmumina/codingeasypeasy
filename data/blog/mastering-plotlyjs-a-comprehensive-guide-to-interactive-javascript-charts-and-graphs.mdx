...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['plotly.js', 'javascript', 'charts', 'graphs', 'data visualization', 'interactive charts', 'data analysis']
draft: false
...
Plotly.newPlot('myDiv', [{x: [1,2,3], y: [4,5,6], type: 'scatter'}], {title: 'Clickable Chart'});
```
