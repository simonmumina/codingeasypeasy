...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['react-native', 'expo', 'screenshot', 'media-library', 'expo-screen-capture', 'image-processing', 'mobile-development', 'javascript']
draft: false
...
const useMediaLibraryPermissions = () => {
  ...
  useEffect(() => {
    (async () => {
      if (Platform.OS === 'ios') { // Only necessary on iOS
