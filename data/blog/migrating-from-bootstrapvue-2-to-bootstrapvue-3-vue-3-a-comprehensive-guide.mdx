...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['bootstrap-vue', 'vue3', 'migration', 'upgrade', 'frontend', 'javascript', 'web-development', 'components']
draft: false
...
*   **Link in your `index.html`:** This is the most straightforward but can lead to loading order issues.
    ...
    <head>
      ...
      <link rel="stylesheet" href="https://unpkg.com/bootstrap-vue-next/dist/bootstrap-vue-next.css" />
    </head>
    <body>
      <div id="app"></div>
...
However, if you *prefer* explicit registration, you can do so for specific components to optimize bundle size.
