...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['nestjs', 'testing', 'mocking', 'database', 'unit testing', 'integration testing', 'typeorm', 'jest', 'e2e testing']
draft: false
...
describe('UserService', () => {
  ...
  describe('createUser', () => {
    it('should create a new user', async () => {
      ...
      expect(userRepository.create).toHaveBeenCalledWith({ name: 'Test User', email: 'test@example.com' });
