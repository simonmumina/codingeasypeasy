...
date: '2024-02-29'
lastmod: '2024-10-27'
tags: ['azure', 'azure functions', 'serverless', 'cloud computing', 'microsoft azure', 'event driven architecture', 'azure portal', 'function app', 'c#', 'python', 'javascript', 'trigger', 'binding', 'http trigger', 'queue trigger', 'blob trigger', 'durable functions', 'azure monitoring', 'application insights', 'azure cli', 'azure powershell', 'ci/cd', 'devops', 'azure devops']
draft: false
...
Think of Azure Functions as small, independent pieces of code that execute in response to a trigger.  A *trigger* is what causes a function to run. Common triggers include:
...
Each function also often has *bindings*. Bindings provide a declarative way to connect to other Azure services or external resources.  They simplify the process of reading data from, or writing data to, other services without writing boilerplate code.
