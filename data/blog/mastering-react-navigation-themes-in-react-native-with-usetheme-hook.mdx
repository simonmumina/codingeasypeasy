...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['react-native', 'react-navigation', 'theme', 'usetheme', 'styling', 'customization', 'dark-mode', 'accessibility']
draft: false
...
export default function Root() {  // Wrap App with ThemeProvider
  return (
    <ThemeProvider>
      <App />
    </ThemeProvider>
