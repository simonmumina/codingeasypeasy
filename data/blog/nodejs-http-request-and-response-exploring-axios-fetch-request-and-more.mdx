...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['node.js', 'http request', 'http response', 'axios', 'fetch', 'request', 'node-fetch', 'request module', 'superagent', 'web development', 'javascript']
draft: false
...
const options = {
  ...
  method: 'POST',
  json: { // Use 'json' option to automatically stringify the body
    title: 'My New Todo',
    completed: false,
    userId: 1
  }
