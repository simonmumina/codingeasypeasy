...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['git', 'version control', 'branching strategy', 'git workflow', 'development workflow', 'feature branching', 'gitflow', 'github flow', 'gitlab flow', 'trunk-based development']
draft: false
