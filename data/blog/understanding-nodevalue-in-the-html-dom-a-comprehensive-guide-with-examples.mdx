...
*   **`textContent`:** Gets or sets the text content of the *node and its descendants*. It concatenates all text nodes within the element. This is the preferred way to access or modify the text content of an element.
