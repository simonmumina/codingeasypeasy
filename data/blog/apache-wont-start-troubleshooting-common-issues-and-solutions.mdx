...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['apache', 'web server', 'troubleshooting', 'httpd', 'xampp', 'wamp', 'linux', 'windows', 'error logs', 'port 80', 'port 443', 'ssl', 'virtual hosts']
draft: false
...
You can use the `apachectl configtest` (Linux) or `httpd.exe -t` (Windows) command to check the syntax of your Apache configuration files *before* starting Apache.  This can help you catch errors early.
