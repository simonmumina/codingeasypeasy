...
*   **Selecting a Single Element:**
    ...
    The `d3.select()` method selects the *first* element that matches the given selector.
...
*   **Selecting Multiple Elements:**
    ...
    The `d3.selectAll()` method selects *all* elements that match the given selector.
