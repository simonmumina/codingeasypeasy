...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['svelte', 'form validation', 'sveltekit', 'javascript', 'frontend development', 'web development']
draft: false
...
export const actions = {
  default: async ({ request }) => {
    ...
    if (form.data.email.endsWith('.ru')) {
      form.errors.email = "That email domain is not allowed, as this company is avoiding Russian clients.";
      return fail(400, { form });
    }
