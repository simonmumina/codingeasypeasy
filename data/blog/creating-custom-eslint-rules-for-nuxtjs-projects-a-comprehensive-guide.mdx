...
module.exports = {
  meta: {
    ...
    docs: {
      description: 'Enforce component names in the components/ directory to end with "Component.vue"',
    ...
    messages: {
      missingSuffix: 'Component name "{{name}}" in the components/ directory should end with "Component.vue".',
    },
  },
...
*   If an `asyncData` property is found and the component is *not* a page component, we report an error.
...
module.exports = {
  meta: {
    type: 'suggestion',
    docs: {
      description: 'Enforce component names in the components/ directory to end with a specific suffix.',
      category: 'Stylistic Issues',
      recommended: 'warn',
      url: null,
    },
    ...
    messages: {
      missingSuffix: 'Component name "{{name}}" in the components/ directory should end with "{{suffix}}".',
    },
  },
...
*   **Write Thorough Tests:**  Create test cases that cover both valid and invalid code to ensure your rules are working correctly.  ESLint provides a testing framework specifically for custom rules.  (Example tests were not included for brevity but are *highly* recommended.)
