...
date: '2024-02-29'
lastmod: '2024-03-05'
tags: ['spring boot', 'azure functions', 'java', 'serverless', 'cloud computing', 'microsoft azure', 'event driven architecture', 'function as a service', 'spring cloud function']
draft: false
