...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['react-native', 'offline-sync', 'data-persistence', 'redux-persist', 'sqlite', 'realm', 'netinfo', 'mobile-development']
draft: false
...
const fetchRemoteData = async () => {
  ...
  return [{id:1, name: 'Item 1 from server'}, {id:2, name: 'Item 2 from server'}];
};
