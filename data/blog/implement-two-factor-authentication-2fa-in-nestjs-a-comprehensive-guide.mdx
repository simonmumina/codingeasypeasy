...
date: '2024-01-02'
lastmod: '2024-10-27'
tags: ['nestjs', 'two-factor authentication', '2fa', 'security', 'nodejs', 'typescript', 'totp', 'google authenticator']
draft: false
...
export class TwoFactorAuthService {
  ...
  async isTwoFactorAuthenticationCodeValid(twoFactorAuthenticationCode: string, userSecret: string) {
...
*   **`register`:**
    ...
    *   **Crucially**, it *should* store the `base32` secret in your database, associated with the user. **This example skips the database part for brevity!  Adapt this example to store the secret in your database**.
