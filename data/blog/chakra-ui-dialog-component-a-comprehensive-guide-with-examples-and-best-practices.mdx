...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['chakra-ui', 'react', 'dialog', 'modal', 'accessibility', 'ui-components', 'frontend-development']
draft: false
    ...
    <>
      ...
      {isOpen && (
        <Portal container={modalRoot}>
          <Modal isOpen={isOpen} onClose={onClose} finalFocusRef={document.getElementById('your-button')}>
            <ModalOverlay />
            <ModalContent>
    ...
    <>
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          />
          <ModalBody>
            This modal has a custom close button!
          </ModalBody>
        </ModalContent>
      </Modal>
    </>
    ...
    <>
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalCloseButton />
          <ModalBody>
            Clicking the overlay won't close this modal.
          </ModalBody>
        </ModalContent>
      </Modal>
    </>
