...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['react-native', 'drawerlayoutandroid', 'android', 'ui-component', 'mobile-development', 'navigation']
draft: false
...
const App = () => {
  ...
  const navigationView = (
    <View style={[styles.container, styles.navigationContainer]}>
      ...
      <TouchableOpacity style={styles.menuItem} onPress={() => { /* Navigate to Home */ drawer.current?.closeDrawer(); }}>
        <Text>Home</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.menuItem} onPress={() => { /* Navigate to Settings */ drawer.current?.closeDrawer(); }}>
        <Text>Settings</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.menuItem} onPress={() => { /* Navigate to Profile */ drawer.current?.closeDrawer(); }}>
        <Text>Profile</Text>
      </TouchableOpacity>
      <Button
        title="Close Drawer"
