...
date: '2024-01-01'
lastmod: '2024-01-01'
tags: ['SQL', 'LIKE', 'Pattern Matching', 'Database', 'Query', 'Wildcard', 'Percent', 'Underscore', 'SQL Tutorial']
draft: false
...
You can also use `NOT LIKE` to find records that *do not* match a specified pattern. For example, to find all customers whose first name does *not* start with 'J':
