...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['vuejs', 'data passing', 'component communication', 'props', 'events', 'vuex', 'provide/inject', 'emit']
draft: false
...
*   **Mutations:** Mutations are functions that *synchronously* modify the state. They are the *only* way to change the state in Vuex.  The `increment` and `decrement` mutations increment and decrement the `count` state, respectively.
