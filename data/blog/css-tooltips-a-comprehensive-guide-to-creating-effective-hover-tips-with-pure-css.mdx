...
date: '2023-10-27'
lastmod: '2024-10-27'
tags: ['css', 'tooltips', 'hover', 'accessibility', 'web design', 'frontend development', 'css tricks', 'web accessibility']
draft: false
...
*   **Tooltips on Focus Only (for Accessibility):** You might want tooltips to *only* appear on focus, not on hover.  This can be a better user experience, especially for keyboard users.  Simply remove the `:hover` selector and keep the `:focus` selector.
