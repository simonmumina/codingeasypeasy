...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['linear algebra', 'matrices', 'systems of equations', 'gauss-jordan elimination', 'row reduction', 'mathematics', 'algebra', 'numerical methods']
draft: false
...
2.  The leading entry (the first non-zero entry) of each non-zero row is 1 (called a *leading 1*).
