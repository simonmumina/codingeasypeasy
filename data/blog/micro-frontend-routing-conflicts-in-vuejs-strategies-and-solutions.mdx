...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['micro-frontend', 'vuejs', 'routing', 'architecture', 'single-spa', 'qiankun', 'web-components']
draft: false
...
const routes = [
  {
    ...
    props: route => ({ appName: 'app1', currentPath: route.params.pathMatch ? '/' + route.params.pathMatch : '/' })
  },
  {
    path: '/app2/:pathMatch(.*)*', // Capture all routes under /app2
    component: () => import('./micro-frontends/app2'), // Lazy load the app2 micro-frontend
    props: route => ({ appName: 'app2', currentPath: route.params.pathMatch ? '/' + route.params.pathMatch : '/' })
  },
  {
    path: '/',
