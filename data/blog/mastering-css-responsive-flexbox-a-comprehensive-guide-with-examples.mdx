...
These properties are applied to the _parent_ element (the flex container):
...
These properties are applied to the _children_ of the flex container (the flex items):
...
<div class="container">
  <div class="left-column">
    <h2>Left Column</h2>
    <p>
      This is the content of the left column. It may contain more or less text than the right
      column.
    </p>
  </div>
