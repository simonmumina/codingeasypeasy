...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['javascript', 'url', 'location', 'web development', 'front-end development', 'how to', 'tutorial']
draft: false
...
While `URLSearchParams` is the modern and preferred method, you *could* use regular expressions, but it's generally more complex and error-prone.
