...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['canvas', 'html5 canvas', 'save()', 'restore()', 'graphics', 'animation', 'javascript', 'context', 'transformation']
draft: false
...
In this example, we define a rectangular clipping region.  The circle is clipped to this region.  Then, we save the state *including* the clipping region.  Restoring removes the clip, and the orange rectangle is drawn without being clipped.
