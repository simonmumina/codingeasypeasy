...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['canvas', 'html5', 'javascript', 'direction', 'bidirectional text', 'rtl', 'ltr', 'web development', 'accessibility', 'graphics']
draft: false
...
*   The `direction` property only affects the drawing direction of the *text itself*. It does not affect the horizontal alignment of the text within the canvas. Use `textAlign` for that purpose (more on that later).
...
*   The X coordinate acts as the *rightmost* point of the text when `direction` is `rtl`.
