...
When adding objects to a `Set`, it's crucial to understand how JavaScript compares object references.  Two objects are considered different if they are not the *same* object, even if they have the same properties and values.
