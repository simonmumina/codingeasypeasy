...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['chakra ui', 'react', 'ui library', 'component library', 'theming', 'colors', 'accessibility', 'customization', 'design system']
draft: false
...
The best practice for customizing your theme is to *extend* the default theme using the `extendTheme` function. This ensures that you don't accidentally remove any important default styles or tokens.
