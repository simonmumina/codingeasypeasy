...
draft: false
summary: 'Learn how to use the `box-decoration-break` utility in Tailwind CSS to control how an element\'s background, border, and box-shadow are rendered when the element is fragmented, such as across multiple lines or pages.'
authors: ['default']
---
