...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['react-native', 'navigation', 'react-navigation', 'nesting', 'screens', 'stacks', 'tabs', 'drawers']
draft: false
...
In some cases, you might want to nest a tab navigator *inside* a stack navigator. This is useful when the tab bar is only relevant to a specific section of your app, accessible after navigating through a stack.
