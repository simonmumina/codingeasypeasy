      ...
      {({ open }) => (
        <>
          ...
          <div className="relative mt-1">
            <Listbox.Button className="relative w-full cursor-default rounded-md bg-white py-2 pr-10 pl-3 text-left text-gray-900 shadow-sm ring-1 ring-gray-300 ring-inset focus:ring-2 focus:ring-indigo-500 focus:outline-none sm:text-sm">
...
```jsx
<Listbox.Button className="relative w-full cursor-default rounded-md bg-blue-500 py-2 pr-10 pl-3 text-left text-white shadow-sm ring-1 ring-gray-300 ring-inset focus:ring-2 focus:ring-blue-500 focus:outline-none sm:text-sm">
  {/* ... */}
</Listbox.Button>
```
