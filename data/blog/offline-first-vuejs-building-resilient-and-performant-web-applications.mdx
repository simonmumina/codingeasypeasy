...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['vuejs', 'offline-first', 'pwa', 'service workers', 'web development', 'vuex', 'cache', 'resilience', 'performance']
draft: false
...
self.addEventListener('fetch', event => {
  if (event.request.url.startsWith('/api')) { // Replace '/api' with your API endpoint prefix
    event.respondWith(
