...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['javascript', 'array methods', 'with()', 'immutable updates', 'programming', 'es2023', 'modern javascript']
draft: false
...
While this is simple, it *mutates* the original array, which can lead to problems in scenarios where you rely on immutability.  Here's a comparison:

| Feature          | `with()`                               | `array[index] = value`                |
|-------------------|-----------------------------------------|---------------------------------------|
| Immutability     | Preserves the original array           | Modifies the original array          |
| Return Value    | Returns a *new* array with the change | Returns the assigned value              |
