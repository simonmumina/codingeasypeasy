...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['contentlayer', 'vercel', 'nextjs', 'deployment', 'mdx', 'static site generation', 'cms-free', 'blog', 'performance']
draft: false
...
*   **Configure Deployment Settings (Crucial for Contentlayer):**
    ...
    *   Vercel will automatically detect your Next.js project.  However, you might need to adjust the build and output settings. The defaults *should* work, but it's good to double-check.
