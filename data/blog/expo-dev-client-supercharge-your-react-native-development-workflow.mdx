...
date: '2024-01-26'
lastmod: '2024-10-27'
tags: ['react-native', 'expo', 'development', 'workflow', 'dev client', 'debugging', 'native modules', 'expo go']
draft: false
...
After adding the native module, you *must* rebuild the dev client using `npx expo run:ios` or `npx expo run:android` to incorporate the changes.
