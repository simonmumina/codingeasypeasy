...
date: '2024-02-29'
lastmod: '2024-03-07'
tags: ['git', 'repository', 'mirror', 'backup', 'version control', 'tutorial', 'clone', 'command line', 'devops']
draft: false
...
*   **Simple Mirror (One-Time Copy):** This involves creating a complete copy of the repository at a specific point in time. Subsequent changes to the original repository are *not* automatically reflected in the mirror.  It's primarily useful for creating initial backups or snapshots.
