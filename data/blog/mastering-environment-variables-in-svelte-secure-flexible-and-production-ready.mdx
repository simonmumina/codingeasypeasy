...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['svelte', 'environment variables', 'dotenv', 'production', 'security', 'frontend', 'configuration', 'sveltekit']
draft: false
...
**Important Security Note:** The `process.env: env` makes *all* environment variables available in the browser.  This is highly undesirable because it exposes sensitive information to the client-side code. You should be selective about which environment variables are exposed to the browser.
