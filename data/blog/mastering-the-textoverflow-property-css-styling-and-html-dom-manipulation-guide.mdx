...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['textOverflow', 'CSS', 'HTML DOM', 'JavaScript', 'styling', 'text-overflow', 'overflow', 'ellipsis', 'clip', 'string-set']
draft: false
...
<div class="clip-container">
  This is a very long sentence that will overflow the container. This is a very long sentence that will overflow the container.
</div>
...
toggleButton.addEventListener('click', () => {
  ...
  toggleButton.textContent = toggleContainer.classList.contains('expanded') ? 'Show Less' : 'Show More';
