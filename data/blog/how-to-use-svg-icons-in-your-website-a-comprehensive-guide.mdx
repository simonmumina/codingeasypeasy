...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['svg icons', 'website design', 'front-end development', 'react', 'html', 'css', 'accessibility', 'icon design', 'scalable vector graphics']
draft: false
...
```html
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" role="img" aria-label="Add">
  <circle cx="12" cy="12" r="10"></circle>
  <line x1="2" y1="12" x2="22" y2="12"></line>
  <line x1="12" y1="2" x2="12" y2="22"></line>
</svg>
...
**Addressing Accessibility Issues (if you *must* use icon fonts):**
...
const MyComponent = () => {
  return (
    <div>
      ...
      <HomeIcon aria-label="Go to homepage" onClick={() => alert('Clicked!')}/> {/* Custom aria-label and onClick handler */}
    </div>
  );
};
