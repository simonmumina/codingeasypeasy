...
date: '2024-01-01'
lastmod: '2024-01-01'
tags: ['nodejs', 'module.exports', 'require', 'modules', 'javascript', 'backend development', 'package manager', 'npm', 'CommonJS']
draft: false
...
You might sometimes see code that uses just `exports` instead of `module.exports`.  Under the hood, `exports` is initially a reference to `module.exports`.  However, if you reassign `exports` to a *new* object, you break that reference.
...
```javascript filename="bad_example.js"
// DON'T DO THIS
exports = function() {
