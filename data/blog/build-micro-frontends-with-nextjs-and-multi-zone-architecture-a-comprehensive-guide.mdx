...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['nextjs', 'microfrontends', 'architecture', 'frontend development', 'multi-zone', 'module federation', 'javascript', 'react']
draft: false
    ...
    if (!options.isServer) {
      config.plugins.push(
        new NextFederationPlugin({
          name: 'container',
          remotes: {
            productListing: 'productListing@http://localhost:3001/_next/static/chunks/remoteEntry.js',
