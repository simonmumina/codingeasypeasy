...
*   **Internationalization (i18n):**  Designing and developing applications so that they can be adapted to various languages and regions without requiring engineering changes.  It's about making the application *adaptable*.  Think of it as enabling your application to be multilingual-ready.  The "18" represents the number of letters between the 'i' and the 'n' in "internationalization."
*   **Localization (l10n):** Adapting a product or content to a specific target market or locale. This involves translating text, adjusting date formats, currency symbols, and other locale-specific elements. It's about *adapting* the application to a specific language and region. The "10" represents the number of letters between the 'l' and the 'n' in "localization."
