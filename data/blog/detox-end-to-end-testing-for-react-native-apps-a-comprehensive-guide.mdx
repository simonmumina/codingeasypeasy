...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['detox', 'react-native', 'end-to-end testing', 'e2e testing', 'mobile testing', 'javascript testing']
draft: false
...
describe('Login Flow', () => {
  ...
  it('should successfully login with valid credentials', async () => {
    ...
    await waitFor(element(by.text('Login Successful!'))).toBeVisible().withTimeout(5000);
  ...
  it('should display an error message with invalid credentials', async () => {
    ...
    await waitFor(element(by.text('Invalid username or password'))).toBeVisible().withTimeout(5000);
  });
});
```
...
const LoginScreen = () => {
  ...
  return (
    <View testID="home-screen"> {/* Add home-screen testID for successful login verification */}
      <Text>Login</Text>
      <TextInput
