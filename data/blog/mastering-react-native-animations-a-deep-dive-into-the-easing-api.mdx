...
*   **Increased Perceived Performance:**  Interestingly, the *perception* of speed and responsiveness can be influenced by easing.  A well-eased animation can make an app *feel* faster, even if the animation duration is the same.
...
Back easing creates an effect where the animation initially goes slightly *backwards* before moving towards the target value.
