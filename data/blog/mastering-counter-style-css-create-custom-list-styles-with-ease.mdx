...
* **`my-custom-list`:** This is the *name* you choose for your custom counter style.  It's important to pick a descriptive name that you can easily remember and reference later.  It must be a valid CSS identifier.
