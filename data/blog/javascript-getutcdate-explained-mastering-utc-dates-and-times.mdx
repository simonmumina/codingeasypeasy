...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['javascript', 'date', 'utc', 'getUTCDate', 'date methods', 'programming', 'web development', 'timezones']
draft: false
...
Even though the date is created with an EST offset, `getUTCDate()` correctly extracts the day of the month *as if* the date were in UTC.
