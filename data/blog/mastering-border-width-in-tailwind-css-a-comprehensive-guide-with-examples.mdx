...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['tailwind-css', 'border-width', 'css', 'utility-classes', 'responsive-design', 'web-development']
draft: false
...
```jsx
<div className="border border-2 border-blue-500 p-4">
  This element has a 2px blue border.
</div>
```
...
```jsx
<div className="border border-2 md:border-4 lg:border-8 border-green-500 p-4">
  This element has a 2px border on small screens, a 4px border on medium screens, and an 8px border on large screens.
</div>
```
