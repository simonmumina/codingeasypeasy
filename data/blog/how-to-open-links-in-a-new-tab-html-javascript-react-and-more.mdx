...
date: '2023-10-27'
lastmod: '2024-10-27'
tags: ['html', 'javascript', 'react', 'new tab', 'open link', 'target blank', 'noopener', 'noreferrer', 'web development', 'accessibility']
draft: false
...
function MyComponent() {
  return (
    <div>
      ...
      <button onClick={() => window.open('https://www.example.com', '_blank', 'noopener,noreferrer')}>
