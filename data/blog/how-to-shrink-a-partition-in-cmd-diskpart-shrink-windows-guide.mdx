...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['windows', 'cmd', 'diskpart', 'shrink partition', 'partition management', 'command line', 'disk management', 'volume resizing']
draft: false
...
*   **Extend an existing partition:**  You can extend an adjacent partition to include the unallocated space, giving it more storage capacity.  Note that the unallocated space *must* be immediately adjacent to the partition you wish to extend.
