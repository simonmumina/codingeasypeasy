...
2.  **Incorrect CSS Order:** The order in which CSS files are loaded matters. If your custom styles are loaded *before* Bootstrap, they might be overwritten.
...
CSS order is crucial.  Make sure your custom styles are loaded *after* Bootstrap's CSS.  This ensures that your styles will override Bootstrap's defaults when necessary.

*   **`preview.js` Ordering:**  In your `.storybook/preview.js`, make sure you import Bootstrap CSS *before* any custom CSS files.
