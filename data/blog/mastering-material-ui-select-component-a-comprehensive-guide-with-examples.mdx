...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['material-ui', 'mui', 'react', 'select', 'component', 'dropdown', 'ui-design', 'frontend-development']
draft: false
...
The `Select` component can be either controlled or uncontrolled. In the example above, we've created a *controlled* component. This means that the `Select`'s value is managed by the React component's state.
...
Here's how you might use an *uncontrolled* Select component using `defaultValue`:
