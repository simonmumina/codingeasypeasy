...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['nodejs', 'exports', 'modules', 'javascript', 'development', 'backend', 'require', 'module.exports', 'named exports', 'default exports']
draft: false
...
The key difference is that `exports` is a *reference* to `module.exports`.  Reassigning a completely new value to `exports` will break this link and won't result in anything being exported. However, reassigning `module.exports` *will* change what is returned by `require()`.
...
```javascript filename="mathOperations.js"
exports.add = (a, b) => {
  return a + b;
};
...
If you want to expose a single function, class, or object as the *default* export, you can directly assign it to `module.exports`.

```javascript filename="greeting.js"
module.exports = (name) => {
  return `Hello, ${name}!`;
};
```
...
```javascript filename="mixedExports.js"
exports.add = (a, b) => a + b;
