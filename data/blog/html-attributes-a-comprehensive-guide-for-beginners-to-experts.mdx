...
date: '2024-01-05'
lastmod: '2024-10-27'
tags: ['html', 'html attributes', 'web development', 'front-end development', 'html tutorial', 'web design', 'accessibility', 'semantics']
draft: false
...
2.  **Global Attributes:** These attributes can be used on *any* HTML element.
...
*   **`id`**: Specifies a unique ID for an element. Used for styling with CSS, selecting elements with JavaScript, and creating internal links within a page.  IDs *must* be unique within a document.
