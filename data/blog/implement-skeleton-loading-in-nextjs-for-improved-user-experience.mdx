...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['nextjs', 'skeleton loading', 'react', 'user experience', 'performance', 'frontend development', 'UI/UX', 'loading states']
draft: false
...
*   **Improve first contentful paint (FCP):** Get *something* on the screen quickly, improving FCP and other performance metrics.
...
export default function CardSkeleton() {
  return (
    <div className="border border-gray-300 shadow rounded-md p-4 w-full max-w-sm mx-auto animate-pulse">
      <div className="bg-gray-200 h-6 w-3/4 mb-2 rounded-md"></div>
      <div className="bg-gray-200 h-4 w-1/2 mb-2 rounded-md"></div>
...
export default function MyComponent() {
  ...
  return (
    <div className="border border-gray-300 shadow rounded-md p-4 w-full max-w-sm mx-auto">
      <h1>{data.title}</h1>
      <p>{data.content}</p>
    </div>
  );
