...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['HTML', 'DOM', 'JavaScript', 'Web Development', 'Front-end Development', 'HTML Elements', 'DOM Manipulation']
draft: false
...
**Important Note:** `querySelectorAll` returns a NodeList. While similar to an HTMLCollection, a NodeList is *not* a live collection. Changes to the DOM after the NodeList is created will *not* be reflected in the NodeList. NodeLists also support the `forEach` method, which simplifies iteration.
