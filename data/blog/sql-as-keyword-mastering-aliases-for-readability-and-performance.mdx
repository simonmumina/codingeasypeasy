...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['sql', 'alias', 'as keyword', 'database', 'query optimization', 'sql tutorial', 'sql examples', 'data analysis']
draft: false
...
When multiple tables in a query have columns with the same name, you *must* use table aliases to specify which column you are referring to. Failure to do so will result in an error.
