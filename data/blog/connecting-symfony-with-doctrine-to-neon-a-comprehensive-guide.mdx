...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['symfony', 'doctrine', 'neon database', 'php', 'database connection', 'orm', 'cloud database', 'serverless']
draft: false
...
**SSL Mode:**  Neon *requires* SSL connections.  Make sure the `sslmode=require` parameter is included in your connection string. This ensures that your connection to the database is encrypted.
