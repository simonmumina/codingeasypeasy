...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['vuejs', 'graphql', 'ssr', 'server-side-rendering', 'apollo', 'nuxt', 'optimization', 'vue-apollo']
draft: false
...
No special client-side code is *required* for basic hydration.  However, you will typically re-initialize Apollo Client on the client to handle future client-side data fetching.
...
While Nuxt is generally recommended, you *can* configure SSR with GraphQL using the standard Vue CLI. This requires more manual configuration.  This is less common due to the complexity compared to Nuxt.
