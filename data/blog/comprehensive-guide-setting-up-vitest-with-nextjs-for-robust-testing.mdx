...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['next-js', 'vitest', 'testing', 'javascript', 'react', 'unit testing', 'integration testing', 'e2e testing']
draft: false
...
export default defineConfig({
  ...
  test: {
    ...
    include: ['**/*.test.{ts,tsx}'],
    exclude: ['**/node_modules/**', '**/dist/**', '**/cypress/**', '**/.{idea,git,cache,output,temp}/**', '**/{karma,rollup,webpack,vite,parcel,esbuild}.config.*/**',]
...
export default defineConfig({
  ...
  test: {
    ...
    include: ['**/*.test.{ts,tsx}'],
    exclude: ['**/node_modules/**', '**/dist/**', '**/cypress/**', '**/.{idea,git,cache,output,temp}/**', '**/{karma,rollup,webpack,vite,parcel,esbuild}.config.*/**',],
    environmentVariables: { // Set environment variables for tests
