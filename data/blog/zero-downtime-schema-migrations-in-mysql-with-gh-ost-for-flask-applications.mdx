...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['mysql', 'flask', 'database migrations', 'schema changes', 'gh-ost', 'zero downtime', 'online schema change', 'application development', 'python', 'devops', 'database management']
draft: false
