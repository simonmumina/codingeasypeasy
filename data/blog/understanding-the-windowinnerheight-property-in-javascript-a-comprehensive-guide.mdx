...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['javascript', 'window object', 'browser dimensions', 'responsive design', 'web development', 'innerHeight']
draft: false
...
The `window.innerHeight` property returns the *inner height* of the browser window in pixels. What exactly is the "inner height"?  It represents the height of the document's viewing area, *excluding* browser UI elements like toolbars, scrollbars (if present), and window borders.  Think of it as the height of the browser's canvas where your web content is rendered.
...
*   **`window.outerHeight`**: This property returns the *outer height* of the browser window, including the browser UI (toolbars, scrollbars, borders, etc.).  In essence, it represents the total height of the browser window as a whole.
...
*   **`screen.height`**: This property returns the total height of the user's *screen*.  It's not specific to the browser window.
