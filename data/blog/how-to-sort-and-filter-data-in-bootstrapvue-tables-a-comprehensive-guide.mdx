...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['bootstrapvue', 'vue.js', 'data tables', 'sorting', 'filtering', 'frontend development', 'javascript', 'web development']
draft: false
...
This backend example now includes filtering logic based on the `filter` parameter.  It filters the data *before* sorting it.
