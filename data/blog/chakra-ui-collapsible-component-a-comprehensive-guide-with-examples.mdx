...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['chakra-ui', 'react', 'collapsible', 'ui-components', 'accessibility', 'frontend-development']
draft: false
    ...
    <Box>
      ...
      <Collapse in={show} animateOpacity>
        <Box
          ...
          shadow="sm"
        >
          This is the content that will be collapsed or expanded. You can include any HTML elements, components, or data here. This example uses a Box with some styling for better visibility. This is an example demonstrating the flexibility of content allowed. This content can be more complex, perhaps containing data fetched from an API.
        </Box>
      </Collapse>
    </Box>
  );
    ...
    <Box>
      ...
      <Collapse in={show} animateHeight>
        <Box
          ...
          shadow="sm"
        >
          This content will expand and collapse in height. It's a good choice when you want a smooth vertical transition.
        </Box>
      </Collapse>
    </Box>
  );
    ...
    <Box>
      ...
      <Collapse in={show} animateOpacity>
        <Box
          ...
          shadow="sm"
        >
          This content is toggled by clicking on the heading. This demonstrates using a non-button element as the trigger.
        </Box>
      </Collapse>
    </Box>
  );
