...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['windows', 'cmd', 'net user', 'user accounts', 'command prompt', 'list users', 'windows administration', 'user management']
draft: false
...
*   **YOUR\_COMPUTER\_NAME:**  This represents the name of your computer or the domain you are connected to.
