...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['python', 'pyramid', 'fastapi', 'web development', 'hybrid application', 'microservices', 'api', 'wsgi', 'uvicorn']
draft: false
...
*   The `WsgiToAsgi` class converts the Pyramid WSGI application into an ASGI-compatible application.  This allows Uvicorn (an ASGI server) to serve both Pyramid and FastAPI. **IMPORTANT:**  This is a *legacy* method, and not ideal for truly asynchronous operations.  It basically runs the WSGI app in a thread pool.
