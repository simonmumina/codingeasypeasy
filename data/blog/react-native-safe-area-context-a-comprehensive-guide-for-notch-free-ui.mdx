...
date: '2023-10-27'
lastmod: '2024-10-27'
tags: ['react-native', 'safe area context', 'ui development', 'ios development', 'android development', 'notch support', 'cross-platform', 'mobile development', 'responsive design']
draft: false
...
const MyComponent = () => {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom, paddingLeft: isLandscape ? insets.left : 0, paddingRight: isLandscape ? insets.right : 0 }]}>
