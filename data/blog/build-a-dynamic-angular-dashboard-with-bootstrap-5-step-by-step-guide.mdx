...
date: "2024-10-26"
lastmod: "2024-10-26"
tags: ["angular", "bootstrap 5", "dashboard", "web development", "frontend", "responsive design", "angular components", "data visualization", "dynamic dashboard"]
draft: false
...
export class DashboardComponent implements OnInit {
  ...
  cards = [
    ...
    { title: 'Pending Tickets', value: '89', icon: 'fas fa-exclamation-triangle', color: 'warning' },
...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-3" *ngFor="let card of cards">
      <app-card [title]="card.title" [value]="card.value" [icon]="card.icon" [color]="card.color"></app-card>
    </div>
  </div>
</div>
```
...
export class DataService {
  ...
  getDashboardData(): Observable<CardData[]> {
    ...
    const data: CardData[] = [
      { title: 'Total Users', value: Math.floor(Math.random() * 2000).toString(), icon: 'fas fa-users', color: 'primary' },
      { title: 'New Orders', value: Math.floor(Math.random() * 1000).toString(), icon: 'fas fa-shopping-cart', color: 'success' },
      { title: 'Pending Tickets', value: Math.floor(Math.random() * 200).toString(), icon: 'fas fa-exclamation-triangle', color: 'warning' },
      { title: 'Revenue', value: '$' + Math.floor(Math.random() * 15000).toString(), icon: 'fas fa-dollar-sign', color: 'info' }
    ];
