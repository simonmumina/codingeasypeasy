...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['database design', 'database schema', 'web application', 'relational database', 'NoSQL', 'data modeling', 'SQL', 'data architecture']
draft: false
...
While normalization is beneficial, it can also lead to more complex queries.  Sometimes, a degree of *denormalization* (intentionally introducing redundancy) can improve performance for read-heavy applications.
