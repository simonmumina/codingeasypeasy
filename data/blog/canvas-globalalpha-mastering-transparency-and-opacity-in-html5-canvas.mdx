...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['html5 canvas', 'canvas api', 'globalAlpha', 'javascript graphics', 'canvas tutorial', 'transparency', 'opacity', 'web development', 'front-end development']
draft: false
...
3.  **Draw with Transparency:** The `ctx.fillStyle = 'red';` and `ctx.fillRect(10, 10, 100, 100);` lines draw a red rectangle with 50% transparency because `globalAlpha` was set *before* the `fillRect` call.
