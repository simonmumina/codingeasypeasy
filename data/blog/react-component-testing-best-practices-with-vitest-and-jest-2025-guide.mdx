...
date: "2025-01-26"
lastmod: "2025-01-26"
tags: ["react", "testing", "vitest", "jest", "unit testing", "component testing", "test driven development", "tdd"]
draft: false
...
Before diving into the how-to, let's quickly recap *why* testing is so important:
...
*   `setupFilesAfterEnv: ['<rootDir>/src/setupTests.js']` (optional) similar to Vitest's `setupFiles`, this configures a file to run *after* the test environment is set up.
...
Write clear and descriptive test names that explain *what* the test is verifying.  This makes it easier to understand the purpose of each test and to diagnose failures.
