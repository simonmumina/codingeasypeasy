...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['opentelemetry', 'nextjs', 'observability', 'tracing', 'metrics', 'logs', 'performance monitoring', 'node.js', 'monitoring']
draft: false
...
**Important:**  Make sure to import `otel.js` at the very top of the file *before* any other imports. This ensures that OpenTelemetry is initialized before any other modules are loaded.
