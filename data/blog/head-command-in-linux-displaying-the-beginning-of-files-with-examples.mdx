...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['linux', 'head command', 'command line', 'terminal', 'file handling', 'system administration', 'linux basics', 'text processing']
draft: false
...
Instead of displaying the *first* N lines, you can tell `head` to display all lines *except* the last N lines. This is done by providing a negative number to the `-n` option.
