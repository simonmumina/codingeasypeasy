...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['tailwind', 'css', 'background-size', 'background images', 'responsive design', 'front-end development']
draft: false
...
```jsx
<div className="h-64 w-96 bg-[url('/images/pattern.png')] bg-cover bg-no-repeat bg-center bg-gray-200">
  {/*
