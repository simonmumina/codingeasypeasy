...
date: '2024-10-27'
lastmod: '2024-10-28'
tags: ['javascript', 'xmlhttprequest', 'ajax', 'post', 'data visualization', 'web development', 'http requests', 'api', 'fetch api alternative']
draft: false
...
While you *can* manually format form data, the `FormData` object provides a convenient and reliable way to handle form submissions.
