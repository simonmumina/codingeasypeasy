...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['continued fractions', 'number theory', 'mathematics', 'rational numbers', 'irrational numbers', 'Diophantine approximation']
draft: false
...
*   `a₀` is called the *integer part* or *initial term*.
*   `a₁, a₂, a₃,...` are called the *partial quotients*.

**Rational vs. Irrational Numbers:**

*   A **finite** continued fraction (i.e., one that terminates) represents a **rational number**.
*   An **infinite** continued fraction represents an **irrational number**.  Moreover, the representation of an irrational number as a continued fraction is *unique*.
...
A *convergent* of a continued fraction is a rational number obtained by truncating the continued fraction at a certain point.  These convergents provide increasingly accurate rational approximations of the original number.
