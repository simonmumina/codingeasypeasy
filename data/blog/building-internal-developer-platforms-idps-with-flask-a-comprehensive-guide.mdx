...
date: "2024-01-26"
lastmod: "2024-01-26"
tags: ["internal developer platform", "IDP", "flask", "python", "devops", "developer experience", "platform engineering", "infrastructure as code", "automation", "microservices"]
draft: false
...
<body>
    ...
    <form method="post">
        ...
        <select id="pipeline_name" name="pipeline_name">
            ...
            <option value="microservice-deploy">Microservice Deployment</option>
        </select><br><br>
