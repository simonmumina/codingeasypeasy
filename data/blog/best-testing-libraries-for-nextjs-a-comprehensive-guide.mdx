...
date: '2023-10-27'
lastmod: '2024-10-27'
tags: ['nextjs', 'testing', 'jest', 'react testing library', 'cypress', 'playwright', 'unit testing', 'integration testing', 'end-to-end testing']
draft: false
...
const customJestConfig = {
  ...
  moduleNameMapper: {
    ...
    '\\.(jpg|jpeg|png|gif|eot|otf|webp|svg|ttf|woff|woff2|mp4|webm|wav|mp3|m4a|aac|oga)$': '<rootDir>/__mocks__/fileMock.js', // Mock file imports (images, fonts, etc.)
...
describe('Contact Form Submission', () => {
  it('should successfully submit the contact form', () => {
    ...
    cy.on('window:alert', (str) => {
      expect(str).to.equal('Name: John Doe, Email: john.doe@example.com, Message: This is a test message.');
    });
  });
});
```
...
test('Contact Form Submission', async ({ page }) => {
  ...
  page.on('dialog', async dialog => {
    expect(dialog.message()).toBe('Name: John Doe, Email: john.doe@example.com, Message: This is a test message.');
