...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['javascript', 'web development', 'responsive design', 'screen size', 'availWidth', 'browser object model', 'BOM', 'layout optimization']
draft: false
...
*   **`window.screen.availWidth`**: Returns the available screen width, *excluding* persistent UI elements. It reflects the *physical* screen and OS constraints. This value will generally remain the same, even if the browser is resized.

*   **`window.innerWidth`**: Returns the width of the browser's viewport, including scrollbars. This value changes as the browser window is resized. It reflects the *browser's* viewport size.
