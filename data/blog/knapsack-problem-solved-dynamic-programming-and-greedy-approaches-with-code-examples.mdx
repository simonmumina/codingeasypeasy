...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['knapsack problem', 'dynamic programming', 'greedy algorithm', 'optimization', 'algorithm', 'coding interview', 'JavaScript', 'problem solving']
draft: false
...
*   **Fractional Knapsack (also known as Continuous Knapsack):** You *can* take fractions of items. If, for example, you only have room for half of an item, you can take exactly that half and receive half of its value.
...
Greedy algorithms make locally optimal choices at each step, hoping to find a global optimum.  While generally faster than Dynamic Programming, they don't always guarantee the optimal solution for the 0/1 Knapsack.  However, they *do* guarantee an optimal solution for the **Fractional Knapsack** problem.
