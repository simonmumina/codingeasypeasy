...
date: '2024-01-01'
lastmod: '2024-01-05'
tags: ['mysql', 'localtime', 'date and time', 'database', 'sql', 'function', 'timestamp', 'current time', 'syntax']
draft: false
...
where `fsp` stands for *fractional seconds precision*, and can range from 0 to 6.  This determines the number of digits after the decimal point in the seconds portion of the timestamp.
