...
date: '2023-10-27'
lastmod: '2024-10-27'
tags: ['CSS', 'translate', 'transformation', 'web development', 'animation', 'CSS3', 'front-end development', 'responsive design']
draft: false
...
*   `tx`, `ty`, `tz`:  Represent the translation distance. These can be:
    ...
    *   **`<percentage>`**: Relative to the width (`translateX`) or height (`translateY`) of the *element itself*.  `translateZ` does not accept percentage values.
