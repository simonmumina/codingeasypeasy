...
Actions are plain JavaScript objects that describe an event that has occurred in your application. They are the *only* way to trigger a state change in Redux.
