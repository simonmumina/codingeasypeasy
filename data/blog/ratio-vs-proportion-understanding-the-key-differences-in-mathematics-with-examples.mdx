...
date: '2024-01-26'
lastmod: '2024-01-27'
tags: ['ratio', 'proportion', 'mathematics', 'math', 'algebra', 'difference between ratio and proportion', 'ratio examples', 'proportion examples']
draft: false
...
*   **Cross-multiplication:** A fundamental property of proportions is that the product of the extremes (a and d) is equal to the product of the means (b and c).  That is, a * d = b * c.  This is often used to solve for an unknown value in a proportion.
