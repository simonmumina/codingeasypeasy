...
<html xmlns="http://www.w3.org/1999/xhtml"
  ...
  <body>
    ...
    <tal:block define="start python:import timeit; timer = timeit.default_timer; start_time = timer()">
    </tal:block>

    <p tal:content="python:'This is some content.'"></p>

    <tal:block define="end_time python:timer()">
    </tal:block>
...
*   **Clean up your template:** Remove the `timeit` code *before* deploying to production.
