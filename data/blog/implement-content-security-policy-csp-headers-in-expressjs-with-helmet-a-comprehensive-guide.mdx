...
**Important:**  If the script content changes *at all*, the hash will change, and the script will be blocked.  Hashes are best suited for static, rarely-modified inline scripts.
