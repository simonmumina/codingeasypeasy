...
5.  **Create the Database (First Time):**
    ...
    Add this block of code *after* defining the `Book` class:
    ...
    This creates the `books.db` file in your project directory the *first* time you run your application.  You will need to comment this out after the database is created, unless you intentionally want to recreate it.
