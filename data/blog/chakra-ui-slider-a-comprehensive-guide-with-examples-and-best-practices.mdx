...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['chakra-ui', 'react', 'slider', 'ui-component', 'frontend-development', 'accessibility', 'design-system']
draft: false
...
function RangeSliderExample() {
  ...
  return (
    <>
      <RangeSlider aria-label={['min', 'max']} defaultValue={[20, 80]} onChange={handleSliderChange} min={0} max={100} step={10}>
      ...
      <p>Range: {sliderValues[0]} - {sliderValues[1]}</p>
    </>
  );
}
