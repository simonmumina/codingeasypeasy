...
*   **"Username and Password not accepted" error:**
    ...
    *   **"Less secure app access":** If you are *trying* to use the deprecated "Less secure app access" method, ensure that you have enabled it in your Google Account settings *and* that your account does *not* have 2-Step Verification enabled. However, as noted before, using "Less secure app access" is strongly discouraged.
