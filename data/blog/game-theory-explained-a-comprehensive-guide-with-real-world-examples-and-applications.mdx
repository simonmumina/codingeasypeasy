...
At its core, game theory studies _strategic interactions_. This means the outcome of a decision isn't solely based on your own choice, but also on the choices made by others involved. These "others" are called _players_. Each player has a set of possible _strategies_, and the _payoff_ for each player depends on the strategies chosen by all players.
