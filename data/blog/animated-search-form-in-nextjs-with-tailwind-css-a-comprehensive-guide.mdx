...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['next-js', 'react', 'tailwind-css', 'animation', 'search-form', 'ui-design', 'frontend-development']
draft: false
  ...
  return (
    <div className="relative">
      <animated.input
        ...
        type="text"
        placeholder="Search..."
        className="bg-white border border-gray-300 rounded-full transition-all duration-300 focus:outline-none focus:border-blue-500 placeholder-gray-500 text-gray-700 absolute top-0 left-0 h-full"
        style={spring}
        aria-label="Search"
      />
      <button
        onClick={handleToggle}
        className="absolute top-0 right-0 h-full w-10 flex items-center justify-center text-gray-500 hover:text-gray-700 focus:outline-none"
