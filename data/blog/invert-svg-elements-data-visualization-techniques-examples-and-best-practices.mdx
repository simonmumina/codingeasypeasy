...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['svg', 'data visualization', 'javascript', 'd3.js', 'web development', 'accessibility', 'frontend', 'css', 'inversion', 'color schemes', 'interactive charts']
draft: false
      ...
      <div style={{ width: '300px' }}>
        <svg viewBox="0 0 100 100">
          <circle
            ...
            cy="50"
            r="40"
            fill={inverted ? invertColor('blue') : 'blue'}
          />
          <text
            x="50"
            y="50"
