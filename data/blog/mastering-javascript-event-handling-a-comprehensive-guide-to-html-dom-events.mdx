...
To make your web page interactive, you need to *attach* event listeners to HTML elements.  An event listener is a function that will be executed when a specific event occurs on that element. There are several ways to attach event listeners:
