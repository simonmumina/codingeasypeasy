...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['git', 'mobile development', 'ios', 'android', 'version control', 'source control', 'team collaboration', 'github', 'gitlab', 'bitbucket', 'branching strategy', 'merge requests', 'pull requests', 'code review']
draft: false
