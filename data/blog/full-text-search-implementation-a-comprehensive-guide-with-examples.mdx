...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['full-text search', 'database search', 'sql', 'postgresql', 'elasticsearch', 'indexing', 'search algorithms', 'search engine', 'data retrieval', 'performance optimization']
draft: false
...
PostgreSQL's full-text search is powerful and well-integrated. It uses the concept of *tsvector* (a document optimized for search) and *tsquery* (a query optimized for search).
