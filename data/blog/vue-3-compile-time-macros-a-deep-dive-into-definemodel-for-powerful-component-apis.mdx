...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['vuejs', 'vue3', 'compile-time-macros', 'defineModel', 'javascript', 'typescript', 'vue-component', 'vue-3.3']
draft: false
...
*   The `addItem` function creates a *new* array using the spread operator (`...`) and assigns it to `modelValue.value`. This triggers the `update:modelValue` event and updates the parent component's array.
