...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['node.js', 'javascript', 'promises', 'modules', 'export', 'import', 'async', 'await', 'es6 modules', 'commonjs']
draft: false
...
*   We use the `export` keyword to expose the `fetchData` function.  This is a *named export*.
...
You can also use *default exports* in ESM. In this case, you export a single value directly:
...
**Important Note:** With default exports, you can choose any name for the imported value (e.g., `promiseFromA` in this case). However, the import must be *without* curly braces.  With named exports, you *must* use curly braces and the exact name of the exported variable.
