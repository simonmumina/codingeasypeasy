...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['nestjs', 'lifecycle hooks', 'onmoduleinit', 'onapplicationbootstrap', 'dependency injection', 'modules', 'nestjs best practices']
draft: false
...
The `OnModuleInit` hook is called *after* all dependencies of a module have been resolved and the module has been instantiated.  This makes it ideal for tasks that require other providers or services within the module to be available.
...
The `OnApplicationBootstrap` hook is called *once* the entire application has been fully initialized, including all modules and their dependencies. This is the ideal place to perform tasks that require the entire application context to be available. It's called *after* all `OnModuleInit` hooks have completed across all modules.
