...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['node.js', 'streams', 'data handling', 'performance', 'readable stream', 'writable stream', 'duplex stream', 'transform stream', 'pipe']
draft: false
...
*   `on('finish', () => { ... })`: Emitted when the stream has finished writing all data. This is emitted *after* all data has been flushed to the underlying system.
