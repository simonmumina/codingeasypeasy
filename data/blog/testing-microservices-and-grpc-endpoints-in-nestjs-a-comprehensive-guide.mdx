...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['nestjs', 'microservices', 'grpc', 'testing', 'e2e testing', 'unit testing', 'integration testing', 'jest', 'supertest', 'testcontainers']
draft: false
...
*   **Testcontainers Setup:**
    ...
    *   `.start()` starts the container *before* the tests run.
