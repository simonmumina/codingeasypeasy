...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['expo', 'expo-router', 'react-native', 'navigation', 'shared-ui', 'components', 'mobile-development', 'react-navigation']
draft: false
...
2.  **Create a `_layout.js` (or `_layout.tsx`) file inside the `(settings)` directory:**
    ...
    ```javascript title="app/(settings)/_layout.js"
    import { Stack } from 'expo-router';
    import { View, Text, StyleSheet } from 'react-native';
...
3.  **Create screens within the `(settings)` directory:**
    ...
    ```javascript title="app/(settings)/profile.js"
    import { View, Text, StyleSheet } from 'react-native';
    ...
    ```javascript title="app/(settings)/notifications.js"
    import { View, Text, StyleSheet } from 'react-native';
