...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['react-native', 'image', 'mobile development', 'image optimization', 'performance', 'styling', 'cache', 'network images', 'local images']
draft: false
...
const MyComponent = () => {
  const base64Image = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w+GzGwMDw8M4QYA5E4Jz0XQYexAAAAABJRU5ErkJggg=='; // Replace with your base64 string
