...
date: '2024-02-29'
lastmod: '2024-03-08'
tags: ['canvas API', 'javascript', 'html5', 'graphics', 'animation', 'setTransform', 'transformations', '2D graphics', 'web development']
draft: false
...
**Think of it like this:**  The canvas starts with an identity matrix: `[1, 0, 0, 1, 0, 0]`.  This means no scaling, rotation, skewing, or translation.  `setTransform()` lets you *completely replace* this matrix with a new one.
...
In this example, the first rectangle is drawn at coordinates (50, 50).  After resetting the transformation matrix and then translating it, the second rectangle is also drawn at coordinates (50, 50) *relative to the translated origin*.  Therefore, it appears at (250, 150) on the canvas.
