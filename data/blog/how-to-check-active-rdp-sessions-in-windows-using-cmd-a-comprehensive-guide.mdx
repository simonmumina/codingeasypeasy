...
date: '2024-01-01'
lastmod: '2024-10-27'
tags: ['RDP', 'Remote Desktop Protocol', 'CMD', 'Command Prompt', 'Windows', 'Active Sessions', 'Query Sessions', 'QWinsta', 'RWinsta', 'Troubleshooting', 'Remote Access', 'Server Management']
draft: false
...
The `rwinsta` command (Reset Windows Station) allows you to disconnect or log off a specific RDP session.  *Use this command with caution*, as it will abruptly terminate the user's session without saving their work.
