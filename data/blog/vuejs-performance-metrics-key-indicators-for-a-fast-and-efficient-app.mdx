...
**Definition:** LCP measures the time it takes for the largest content element (typically an image or text block) visible within the viewport to render. It focuses on the point when the *main* content has loaded.
