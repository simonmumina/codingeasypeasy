...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['javascript', 'web-development', 'page-transition', 'performance', 'caching', 'browser-history', 'web-performance']
draft: false
...
*   **`persisted: false`**: The page is *not* being loaded from the bfcache. This typically means the page is being loaded from the server or is being loaded for the first time.
