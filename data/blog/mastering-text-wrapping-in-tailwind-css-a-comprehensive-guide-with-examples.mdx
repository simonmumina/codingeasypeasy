...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['tailwind css', 'text wrapping', 'css', 'frontend development', 'responsive design', 'tailwindcss']
draft: false
...
*   `text-wrap`: Allows words to break if they exceed the container width. This is the *default* behavior in most browsers but is important to understand for explicitly setting this behaviour.
...
<div className="w-64 bg-gray-100 p-4">
  <p className="text-wrap">
    This is a long sentence that will wrap to the next line when it reaches the end of the container.  This is the default browser behaviour.
  </p>
</div>
```
...
`text-balance` is a fantastic (but still relatively new) CSS feature that tries to balance the lines of text in a paragraph, making it more visually appealing, especially in headings or short blocks of text. It distributes words to create more even line lengths.  This class is *not* part of the core Tailwind CSS and requires the installation of the Typography plugin.
...
<div className="w-64 bg-gray-100 p-4">
  <p className="text-balance">
    This is a short paragraph that will have its lines balanced for a more visually appealing effect.
  </p>
</div>
```
...
<div className="w-64 bg-gray-100 p-4">
  <p className="break-normal">
    This is a sentence that will break normally.
  </p>
</div>
```
...
<div className="w-64 bg-gray-100 p-4">
  <p className="break-words">
    ThisIsAVeryLongWordThatWillBeBrokenToPreventOverflow.
  </p>
</div>
```
