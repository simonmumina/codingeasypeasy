...
date: '2024-01-26'
lastmod: '2024-01-27'
tags: ['R programming', 'R tutorial', 'vector manipulation', 'replace function', 'data analysis', 'data wrangling', 'R coding', 'programming basics']
draft: false
...
Here, we replace any sales values that are either negative *or* less than 10 with `NA`.
