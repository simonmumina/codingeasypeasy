...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['javascript', 'date', 'setUTCMinutes', 'utc', 'time', 'time manipulation', 'coding', 'programming', 'development']
draft: false
...
*   **`getTime()` vs. `setUTCMinutes()` return:** The `getTime()` method returns the number of milliseconds between midnight of January 1, 1970, UTC and the specified date.  The return value of the `setUTCMinutes()` method is the *same* type of millisecond timestamp *after* the modifications have been made.
