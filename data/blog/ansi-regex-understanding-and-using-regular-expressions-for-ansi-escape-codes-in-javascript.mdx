...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['ansi escape codes', 'regex', 'regular expressions', 'javascript', 'terminal', 'colors', 'string manipulation', 'ansi-regex']
draft: false
...
Let's say you have an array of strings, some of which contain ANSI escape codes. You can use `ansi-regex` to filter the array and keep only the strings that *don't* contain ANSI codes:
