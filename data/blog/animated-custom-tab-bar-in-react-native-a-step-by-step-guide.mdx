...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['react-native', 'javascript', 'animation', 'tab-bar', 'ui-design', 'mobile-development', 'react-navigation']
draft: false
      ...
      <View style={styles.tabsContainer}>
        {state.routes.map((route, index) => {
          ...
          return (
            ...
            >
              <Text style={[styles.tabLabel, { color: isFocused ? 'blue' : 'gray' }]}>
                {label}
              </Text>
            </TouchableOpacity>
          );
        ...
        {state.routes.map((route, index) => {
          ...
          return (
            <TouchableOpacity
              ...
              style={styles.tabButton}
            >
              <Icon name={iconName} size={isFocused ? iconSizes.focused : iconSizes.unfocused} color={isFocused ? 'blue' : 'gray'} />
            </TouchableOpacity>
          );
        })}
      </View>
