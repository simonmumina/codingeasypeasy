...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['chakra-ui', 'css cascade layers', 'css', 'web development', 'frontend', 'styling', 'components', 'performance']
draft: false
...
*   The `overrides` layer *intentionally* overrides the font size, demonstrating how you can selectively control precedence.
