...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['javascript', 'dom', 'innertext', 'html', 'web-development', 'text-manipulation', 'front-end']
draft: false
...
*   Returns the text content of *all* elements within the node, regardless of visibility.
