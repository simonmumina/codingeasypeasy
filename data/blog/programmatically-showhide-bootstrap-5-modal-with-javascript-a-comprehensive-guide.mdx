...
date: '2024-01-25'
lastmod: '2024-01-26'
tags: ['bootstrap', 'bootstrap 5', 'modal', 'javascript', 'frontend development', 'web development', 'dom manipulation']
draft: false
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          This is the content of my Bootstrap 5 modal.
        </div>
...
To hide the modal programmatically, you use the `hide()` method.  Let's add a button *inside* the modal that hides it:
...
*   **`backdrop`:**  Determines whether to include a backdrop element.  Possible values:
    ...
    *   `false`: No backdrop element. Clicking outside the modal will *not* close it.
    *   `'static'`: Includes a backdrop element. Clicking outside the modal will *not* close it, and the modal will not be dismissed when pressing Esc.
...
*   We get the modal element using `document.getElementById('myModal')`. *This is important to remember: the events are fired on the element, not the Modal instance!*
...
<script>
  ...
  openModalButton.addEventListener('click', function() {
    ...
    setTimeout(() => {
      modalBodyContent.innerHTML = '<p>Data loaded successfully!</p><p>This is some dynamic content.</p>';
      myModal.show();
