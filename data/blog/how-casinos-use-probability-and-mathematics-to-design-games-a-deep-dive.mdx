...
Casinos design games with a negative expected value _for the player_. This means that, on average, the player will lose money over the long run. This negative expected value is the casino's house edge.
