...
date: "2024-01-26"
lastmod: "2024-01-26"
tags: ["spring boot", "microservices", "service discovery", "eureka", "netflix eureka", "spring cloud", "cloud native"]
draft: false
...
*   `eureka.client.register-with-eureka`:  Prevents the Eureka Server from registering itself as a client.  This is crucial because it *is* the registry.
