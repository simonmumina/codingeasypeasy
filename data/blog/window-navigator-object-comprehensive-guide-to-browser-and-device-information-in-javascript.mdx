...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['javascript', 'browser', 'navigator', 'user-agent', 'device-information', 'front-end-development', 'web-development', 'web-api']
draft: false
...
Instead of relying on the unreliable `userAgent` property, it's generally recommended to use *feature detection* to determine whether a particular feature is supported by the browser.  This involves checking for the existence of a specific property or method.
