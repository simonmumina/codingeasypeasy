...
date: '2024-01-01'
lastmod: '2024-10-27'
tags: ['next-js', 'image optimization', 'web performance', 'seo', 'next/image', 'responsive images', 'cloudinary', 'vercel']
draft: false
...
**Important:** The `width` and `height` attributes are *required* for local images. They tell Next.js the aspect ratio of the image, which is crucial for preventing layout shift.
