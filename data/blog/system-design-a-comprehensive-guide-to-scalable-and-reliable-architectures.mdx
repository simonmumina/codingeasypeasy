...
date: '2024-01-26'
lastmod: '2024-10-27'
tags: ['system design', 'architecture', 'scalability', 'reliability', 'distributed systems', 'microservices', 'database design', 'load balancing', 'caching']
draft: false
...
The code doesn't change much in either case, but the infrastructure does.  The *design* considerations, however, are significantly different.
