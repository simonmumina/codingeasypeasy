...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['SQL', 'Databases', 'ACID Properties', 'Database Transactions', 'Atomicity', 'Consistency', 'Isolation', 'Durability']
draft: false
...
Without isolation, Transaction 2 might read Account A's balance *before* Transaction 1 commits its changes.  Transaction 2 would see a balance of $100, and then deduct $30, leaving $70.  But after Transaction 1 commits, Account A should only have $20 ($100 - $50 - $30 = $20). The lack of isolation has caused a data inconsistency.
