...
date: '2024-01-26'
lastmod: '2024-01-27'
tags: ['vue.js', 'performance optimization', 'web development', 'javascript', 'frontend', 'speed', 'lazy loading', 'code splitting']
draft: false
...
}, 200)); // Execute at most once every 200 milliseconds
```
