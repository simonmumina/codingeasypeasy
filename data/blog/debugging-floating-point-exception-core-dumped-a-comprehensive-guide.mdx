...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['debugging', 'floating-point exceptions', 'core dump', 'gdb', 'linux', 'cpp', 'c', 'signal handling', 'numerical errors', 'error handling']
draft: false
...
Use the `print` command to examine the values of variables at the point of the crash. This is essential for understanding *why* the floating-point exception occurred.
...
*   **Conditional Checks:**  Use `if` statements to check for potential division by zero or invalid input *before* performing the calculation.
