...
Before diving into the specifics of the `Math.cbrt(x)` method, let's briefly review what a cube root is. The cube root of a number _x_ is a value _y_ such that _y_ \* _y_ \* _y_ = _x_. For instance, the cube root of 8 is 2 because 2 \* 2 \* 2 = 8.
