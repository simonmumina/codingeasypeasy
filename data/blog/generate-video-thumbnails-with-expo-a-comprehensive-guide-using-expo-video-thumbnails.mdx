...
date: '2023-10-27'
lastmod: '2024-10-27'
tags: ['expo', 'react-native', 'video', 'thumbnails', 'mobile-development', 'expo-video-thumbnails', 'image-generation', 'asynchronous', 'media-processing']
draft: false
...
export default function App() {
  ...
  const videoSource = 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4'; // Replace with a public video URL
