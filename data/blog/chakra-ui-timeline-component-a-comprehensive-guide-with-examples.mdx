  ...
  return (
    ...
    >
      ...
      <Box
        ...
        width="45%"
      >
        {time && <Text fontSize="sm" color={useColorModeValue("gray.600", "gray.400")}>{time}</Text>}
        {children}
      </Box>
    </Flex>
  );
...
function App() {
  ...
  return (
    <Box p={4} maxWidth="container.md" mx="auto">
      <Heading mb={4} textAlign="center">Project Timeline</Heading>
      <Timeline>
          ...
          <TimelineItem key={index} time={item.time}>
            ...
            >
              ...
              <Text mt={2} color={useColorModeValue("gray.700", "gray.300")}>
                A brief description of this milestone.  Explain the key activities and outcomes achieved during this stage.
              </Text>
            </Box>
          </TimelineItem>
        ))}
