...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['javascript', 'dom', 'events', 'onwheel', 'scroll', 'wheel event', 'web development', 'accessibility']
draft: false
...
*   `event.preventDefault()`:  This crucial line prevents the default scrolling behavior of the browser. This is often necessary when you want to implement custom scrolling logic or animations.  Without it, the browser will *also* scroll, leading to a janky or unexpected user experience.
