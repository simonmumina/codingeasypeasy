...
date: '2024-01-01'
lastmod: '2024-01-05'
tags: ['nextjs', 'react', 'loading ui', 'streaming', 'suspense', 'user experience', 'performance optimization']
draft: false
...
*   **Faster First Meaningful Paint (FMP):** Streaming allows the server to send chunks of HTML to the client as they become available.  This means the user sees *something* sooner, even if the entire page isn't ready.
