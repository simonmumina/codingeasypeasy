...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['statistics', 'standard deviation', 'data analysis', 'math', 'probability', 'mean', 'variance']
draft: false
...
*   **Sample Variance (s²):**
    ...
    Subtract the mean from each value, square the result, sum all the squared differences, and then divide by the number of values in the sample *minus one* (n-1).  Using n-1 is called Bessel's correction and provides an *unbiased* estimate of the population variance when working with a sample.
...
*   **Population Standard Deviation:**  Divides by the total number of values in the *population* (N). Use this when you have data for the entire population of interest.
*   **Sample Standard Deviation:** Divides by the number of values in the *sample minus one* (n-1).  Use this when you have data for a sample and are trying to estimate the standard deviation of the *population* from which the sample was drawn. Using `n-1` provides a less biased estimate of the population variance.
