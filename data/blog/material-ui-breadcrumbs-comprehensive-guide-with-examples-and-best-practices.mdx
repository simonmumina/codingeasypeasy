...
*   `itemsBeforeCollapse` (defaults to 1) specifies how many breadcrumbs should be visible *before* the collapsed section.  You can use `itemsAfterCollapse` similarly to control how many items are displayed after the collapsed section.
