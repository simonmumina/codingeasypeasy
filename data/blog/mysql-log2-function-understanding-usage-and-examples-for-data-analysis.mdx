...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['mysql', 'database', 'log2', 'logarithm', 'data analysis', 'sql', 'function', 'tutorial', 'coding']
draft: false
...
*   **`LOG(number)` or `LN(number)`:** Returns the natural logarithm (base *e*) of the number.
...
You can use these functions in conjunction with the change-of-base formula if you need to calculate logarithms to bases other than 2 or *e*.  The change-of-base formula is:
