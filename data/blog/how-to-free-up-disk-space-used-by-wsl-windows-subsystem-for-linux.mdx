...
date: "2024-02-29"
lastmod: "2024-02-29"
tags: ["wsl", "windows subsystem for linux", "disk space", "free space", "optimization", "virtual hard drive", "vhdx", "reclaim space", "windows", "linux"]
draft: false
...
WSL distributions are stored as virtual hard drives (VHDXs) on your Windows file system. These VHDXs dynamically grow as you add data to your Linux environment.  The problem is, even after you delete files *inside* your WSL environment, the VHDX file might not automatically shrink. This leads to wasted disk space.
