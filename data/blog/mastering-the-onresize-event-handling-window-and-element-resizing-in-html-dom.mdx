...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['HTML', 'DOM', 'JavaScript', 'onresize', 'Event Handling', 'Responsive Design', 'Window Resize', 'Element Resize']
draft: false
...
window.onresize = function() {
  ...
  document.getElementById("window-size").textContent = `Window size: ${window.innerWidth} x ${window.innerHeight}`;
};
```
