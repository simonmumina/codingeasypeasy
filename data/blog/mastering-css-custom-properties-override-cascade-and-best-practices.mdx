...
date: '2024-01-05'
lastmod: '2024-10-27'
tags: ['css', 'custom properties', 'css variables', 'overriding', 'cascade', 'specificity', 'theming', 'css best practices']
draft: false
...
**Caveat:**  This method overrides the variable *everywhere* it's used. It's suitable for major theme changes but less ideal for localized styling.
...
While generally discouraged for styling, you *can* override variables using inline styles.  This is useful for dynamic changes based on JavaScript logic.
...
<p style="color: var(--primary-color);">This text will use the default primary color, likely blue, if defined elsewhere.</p>
```
...
When overriding CSS variables, remember that the rule with the *highest specificity* that defines the variable will take precedence.  If two rules have the same specificity, the rule that appears *later* in the stylesheet will win.
