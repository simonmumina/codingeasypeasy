...
date: '2024-02-29'
lastmod: '2024-03-08'
tags: ['next-js', 'unit testing', 'jest', 'react testing library', 'javascript', 'testing', 'front-end development']
draft: false
...
*   `expect(trackEvent).toHaveBeenCalledWith('button_click');`:  Asserts that the `trackEvent` mock function was called with the argument 'button\_click'.
