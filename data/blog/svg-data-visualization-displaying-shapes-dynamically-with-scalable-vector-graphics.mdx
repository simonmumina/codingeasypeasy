...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['svg', 'data visualization', 'javascript', 'web development', 'scalable vector graphics', 'shapes', 'dynamic charts', 'd3.js', 'react', 'web design']
draft: false
...
const PieChart = ({ data, width = 400, height = 400, innerRadius = 0, outerRadius = Math.min(width, height) / 2 }) => {
