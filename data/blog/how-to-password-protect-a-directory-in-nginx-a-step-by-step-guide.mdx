...
date: "2024-01-01"
lastmod: "2024-01-02"
tags: ["nginx", "password protection", "web server", "security", "authentication", "directory protection", "htaccess", "htpasswd"]
draft: false
...
Now, let's create the `.htpasswd` file.  Choose a secure location for this file *outside* of your web server's document root. This prevents direct access to the password file via the web. A common location is `/etc/nginx/.htpasswd`.
