...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['mongodb', 'nodejs', 'database', 'drop database', 'mongodb tutorial', 'nodejs mongodb', 'mongodb nodejs', 'mongodb drop database', 'javascript', 'database management']
draft: false
...
```javascript
const uri = 'mongodb+srv://username:password@clustername.mongodb.net/database?retryWrites=true&w=majority'; // Replace with your Atlas connection string
const dbName = 'your_database_name'; // Replace with the name of the database you want to drop
```
