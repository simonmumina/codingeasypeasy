...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['expressjs', 'cookies', 'req.cookies', 'req.signedCookies', 'nodejs', 'web development', 'session management', 'security']
draft: false
...
While `req.cookies` lets you read cookies, you use `res.cookie()` to *set* cookies in the response.
