...
date: '2024-01-01'
lastmod: '2024-10-27'
tags: ['tailwind css', 'css framework', 'utility-first css', 'responsive design', 'web development', 'tailwind tutorial', 'tailwind examples', 'component library', 'tailwindcss', 'tailwind configuration']
draft: false
...
```html
<button class="bg-primary text-white px-4 py-2 rounded">Custom Button</button>
```
...
The `extend` property in the `theme` section allows you to *add* to the default Tailwind theme without completely overriding it.  This is generally preferred because it maintains Tailwind's default values while allowing you to add your own customizations.
...
module.exports = {
  ...
  theme: {
    colors: {  // Completely overrides the default colors
      red: '#ff0000',
      blue: '#0000ff',
    },
  },
