...
If you need to use CommonJS modules (those using `require`) from your ES6 module code, you can use the `import()` function, which returns a promise.  This is known as a *dynamic import*.
