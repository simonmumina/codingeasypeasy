...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['html', 'dom', 'transitionevent', 'css', 'javascript', 'web development', 'animation', 'front-end']
draft: false
...
Imagine you have a loading spinner that transitions its opacity while content is being loaded.  You want to hide the spinner *exactly* when the content is loaded.
