...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['javascript', 'matrix', 'array', 'data structures', 'is.js', 'type checking', 'function', 'programming']
draft: false
...
const irregularMatrix = [[1, 2], [3, 4, 5]];
...
function isMatrixCustom(arr) {
  ...
  if (arr.length === 0) { // Handles empty arrays. An empty array is not a matrix according to is.js
    return false;
  }
