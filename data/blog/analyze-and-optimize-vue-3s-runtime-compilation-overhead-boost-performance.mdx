...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['vue3', 'vuejs', 'optimization', 'runtime compilation', 'performance', 'javascript', 'frontend development', 'web performance']
draft: false
...
*   **Child Components:** `v-once` only applies to the element it's attached to, *not* to its child components. Child components will still be rendered as normal.
