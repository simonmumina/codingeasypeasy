...
- **`/E`:** Performs defragmentation on solid-state drives (SSDs) as well as traditional hard drives. This is generally _not_ recommended for SSDs (more on that below).
