...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['node.js', 'express.js', 'social authentication', 'oauth', 'passport.js', 'google authentication', 'facebook authentication', 'github authentication', 'authentication', 'security']
draft: false
...
// Routes
app.get('/', (req, res) => {
  res.send('<a href="/auth/google">Authenticate with Google</a><br><a href="/auth/facebook">Authenticate with Facebook</a><br><a href="/auth/github">Authenticate with GitHub</a><br><a href="/profile">Profile</a>');
});
...
app.get('/profile', isLoggedIn, (req, res) => {
  res.send(`<h1>Profile</h1><p>Hello, ${req.user.displayName}!</p><img src="${req.user.profilePicture || ''}"/><br><a href="/logout">Logout</a>`);
});
