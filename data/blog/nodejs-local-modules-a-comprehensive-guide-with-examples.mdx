...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['node.js', 'modules', 'local modules', 'javascript', 'require', 'exports', 'module.exports', 'best practices']
draft: false
...
*   **Local Modules:** These are modules that *you* create within your own project.  They contain reusable functionality specific to your application. This guide focuses on local modules.
