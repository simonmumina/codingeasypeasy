...
date: '2024-02-29'
lastmod: '2024-10-27'
tags: ['css', 'scope', 'css scoping', 'modern css', 'web development', 'css modules', 'bem', 'style maintainability']
draft: false
...
*   **`to <scope-limit>` (Optional):** This defines an upper limit to the scope.  Styles will *not* apply to elements that match this selector, even if they are descendants of the `<scope-root>`.
