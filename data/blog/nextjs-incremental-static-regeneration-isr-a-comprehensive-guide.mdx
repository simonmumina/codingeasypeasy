...
date: '2023-10-27'
lastmod: '2024-01-01'
tags: ['nextjs', 'isr', 'static-site-generation', 'performance', 'web-development', 'react', 'data-fetching']
draft: false
...
ISR allows you to generate (or *regenerate*) static pages at runtime after your application has already been deployed.  Think of it as a hybrid approach that combines the benefits of **Static Site Generation (SSG)** and **Server-Side Rendering (SSR)**.
...
ISR bridges the gap by allowing you to statically generate pages, *but with the ability to automatically regenerate them in the background at a specified interval.* This means your users get the speed and SEO benefits of static pages, while also seeing relatively up-to-date content.
