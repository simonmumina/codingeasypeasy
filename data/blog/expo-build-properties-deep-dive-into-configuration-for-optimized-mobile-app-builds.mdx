...
date: '2024-02-29'
lastmod: '2024-11-15'
tags: ['expo', 'react-native', 'build properties', 'configuration', 'android', 'ios', 'mobile development', 'optimization', 'eas build']
draft: false
            ...
            'expo-build-properties',
            {
              ...
              ios: {
                ...
                infoPlist: {
                  ...
                  NSLocationWhenInUseUsageDescription: "We use your location to provide better services."
                },
