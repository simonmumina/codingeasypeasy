...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['express', 'nodejs', 'deployment', 'zero-downtime', 'pm2', 'nginx', 'load balancing', 'continuous integration', 'continuous delivery', 'ci/cd']
draft: false
...
2.  **Configure Nginx as a reverse proxy and load balancer:**
    ...
    *   **proxy\_pass:**  Specifies the upstream group to proxy requests to.
