...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['git', 'git hooks', 'automation', 'development workflow', 'version control', 'code quality', 'pre-commit', 'pre-push']
draft: false
...
*   **Stored Locally:** Git hooks reside in the `.git/hooks` directory of your repository. This directory is *not* tracked by Git, meaning the hooks are not automatically shared with other collaborators.  We'll discuss ways to share and manage hooks later in this article.
