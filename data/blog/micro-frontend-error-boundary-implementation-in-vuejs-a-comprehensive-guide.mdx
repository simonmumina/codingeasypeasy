...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['micro-frontend', 'vuejs', 'error boundary', 'javascript', 'frontend architecture', 'component isolation', 'resilience']
draft: false
...
In a monolithic application, unhandled errors can often be caught by a global error handler.  However, in a micro-frontend setup, each micro-frontend ideally operates independently.  An error in one micro-frontend should *not* bring down other micro-frontends. This is where error boundaries come in.
