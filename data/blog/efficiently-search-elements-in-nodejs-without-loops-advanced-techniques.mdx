...
*   **Declarative Style:** Focus on *what* you want to achieve rather than *how* to achieve it.
...
**When to use:**  When you need to find only the *first* matching element.
...
**When to use:** When you need to find *all* matching elements.
...
*   Efficiently checks if *any* element satisfies the condition.
*   Stops iterating once a match is found.

**When to use:** When you only need to know if *at least one* element matches.
...
*   Efficiently checks if *all* elements satisfy the condition.
*   Stops iterating as soon as one element *fails* the test.

**When to use:** When you need to verify that *all* elements meet a specific criteria.
...
**When to use:** When you need to find the *index* of the first matching element.
