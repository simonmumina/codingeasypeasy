...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['react-native', 'ar', 'vr', 'augmented-reality', 'virtual-reality', 'mobile-development', 'cross-platform', 'react-native-viro', 'webxr']
draft: false
    ...
    const WebXRComponent = () => {
      ...
      const getHtml = () => {
        if(Platform.OS === 'android')
          return 'file:///android_asset/webxr.html';
        else
          return require('./webxr.html'); // For iOS, ensure the HTML file is correctly included in the bundle
      }
