...
date: '2024-01-01'
lastmod: '2024-01-08'
tags: ['react', 'testing', 'testing-library', 'user-event', 'unit testing', 'integration testing', 'frontend testing']
draft: false
...
function FileUploader() {
  ...
  return (
    <div>
      ...
      />
      {selectedFile && (
        <p data-testid="file-name">Selected file: {selectedFile.name}</p>
      )}
    </div>
  );
}
