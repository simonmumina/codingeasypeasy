...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['html', 'dom', 'video', 'javascript', 'web development', 'html video', 'video api', 'video control', 'video playback', 'video manipulation']
draft: false
...
*   **`video.width` and `video.height`:**  The width and height of the video element in pixels. Note that this is the *displayed* width/height; the intrinsic dimensions might be different.
