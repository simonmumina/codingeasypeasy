...
_Remember to install the necessary libraries: `pip install numpy Pillow matplotlib scipy`_
_Replace `'your_image.jpg'` with the actual path to your image file._
