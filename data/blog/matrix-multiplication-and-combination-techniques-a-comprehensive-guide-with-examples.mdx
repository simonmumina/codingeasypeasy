...
date: '2024-01-27'
lastmod: '2024-01-28'
tags: ['matrix multiplication', 'linear algebra', 'numpy', 'matrix operations', 'data science', 'machine learning', 'matrix combination']
draft: false
...
Matrix multiplication is arguably the most important matrix combination technique.  It's a non-commutative operation (A * B != B * A in most cases), and it requires specific dimension compatibility.
