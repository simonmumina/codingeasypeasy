...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['css', 'pow', 'function', 'exponential', 'math', 'responsive design', 'variables', 'calc', 'modern css']
draft: false
...
The function returns the result of the base raised to the exponent.  For example, `pow(2, 3)` would return 8 (2 * 2 * 2).
