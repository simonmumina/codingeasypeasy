...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['mui', 'material-ui', 'data-grid', 'react', 'react-table', 'mui-x', 'data-visualization', 'front-end', 'development']
draft: false
...
const columns = [
  ...
  { field: 'col1', headerName: 'Column 1', width: 130 },
  {
    ...
    width: 150,
    renderCell: (params) => (
      <Button variant="contained" color="primary" onClick={() => alert(`Clicked row ${params.row.id}`)}>
        View
      </Button>
    ),
  },
