...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['FastAPI', 'Security', 'CSP', 'Content Security Policy', 'Headers', 'Web Security', 'Python', 'Web Development']
draft: false
...
To use `report-to`, you need to define a reporting group using the `Report-To` header *alongside* the `Content-Security-Policy` (or `Content-Security-Policy-Report-Only`) header.
