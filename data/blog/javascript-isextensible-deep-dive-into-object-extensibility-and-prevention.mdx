...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['javascript', 'object', 'isExtensible', 'extensibility', 'preventExtensions', 'seal', 'freeze']
draft: false
...
`Object.freeze()` is the most restrictive method. It prevents new properties from being added, makes existing properties non-configurable, *and* makes existing properties non-writable.  Essentially, you cannot change the structure or values of a frozen object.  An object frozen with `freeze()` is also non-extensible, and `isExtensible()` will return `false`.
