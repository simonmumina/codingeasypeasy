...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['SQL', 'Database', 'Sorting', 'ORDER BY', 'Ascending', 'Descending', 'Data Management', 'SQL Tutorial']
draft: false
...
*   `ORDER BY` is typically the *last* clause in a `SELECT` statement (before `LIMIT` if used).
