...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['javascript', 'screen object', 'pixelDepth', 'resolution', 'color depth', 'web development', 'frontend', 'browser API']
draft: false
...
if (typeof screen !== 'undefined') {
  ...
  document.getElementById('color-depth-info').textContent = "Color Depth: " + colorDepth + " bits per pixel.";
} else {
