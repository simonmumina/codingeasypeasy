...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['sql', 'database', 'query optimization', 'performance tuning', 'database performance', 'slow query', 'indexing', 'execution plan']
draft: false
...
*   **Example (MySQL):**
    ...
    *   `possible_keys`: The indexes that *could* be used.
    *   `key`: The index that was *actually* used.  If this is NULL, no index was used.
