...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['git', 'rebase', 'interactive rebase', 'version control', 'commit history', 'squash', 'edit', 'reword', 'fixup', 'drop']
draft: false
...
*   **`squash` (or `s`):**  Use the commit, but merge its changes into the *previous* commit. You'll be prompted to edit the commit message of the resulting squashed commit.
