...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['javascript', 'html', 'dom', 'events', 'onhashchange', 'hash routing', 'single page application', 'spa', 'url fragments']
draft: false
...
2. **URL Changes (Without Reloading):**  The browser updates the URL's hash fragment to match the `href` attribute of the clicked link. Crucially, this URL change *does not* trigger a full page reload.
