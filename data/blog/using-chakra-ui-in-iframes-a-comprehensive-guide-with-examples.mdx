...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['chakra-ui', 'iframes', 'react', 'web-development', 'ui-framework', 'frontend-development', 'cross-origin', 'styling', 'embedding']
draft: false
      ...
      return (
        <div>
          ...
          <iframe
            ...
            style={{ width: '100%', height: '300px', border: '1px solid #ccc' }}
          />
          <Button colorScheme="blue" onClick={sendMessage}>Send Message to iFrame</Button>
        </div>
      );
    }
