...
Choose the default preset or customize it according to your needs.  Selecting "ESLint with Prettier" during the Vue CLI setup *can* get you started, but often requires further customization.  This guide provides more granular control.
