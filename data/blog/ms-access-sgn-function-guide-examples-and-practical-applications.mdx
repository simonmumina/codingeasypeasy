...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['MS Access', 'Sgn() Function', 'VBA', 'Database', 'Function', 'Programming', 'Tutorial', 'Examples', 'Microsoft Access']
draft: false
...
While you can't directly use `Sgn()` within a standard Access query *design view*, you can achieve the same result using VBA code that interacts with your database.  Here's how you could achieve a similar outcome by iterating over a recordset:
