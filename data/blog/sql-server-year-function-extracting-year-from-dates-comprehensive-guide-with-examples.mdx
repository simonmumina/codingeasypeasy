...
date: '2024-01-01'
lastmod: '2024-01-01'
tags: ['SQL Server', 'YEAR() Function', 'Date Functions', 'SQL Tutorial', 'Database', 'T-SQL', 'Extract Year', 'Datetime Data']
draft: false
...
Try to write *SARGable* queries (Search ARGument able) whenever possible.  A SARGable query allows the database engine to use indexes for filtering.  Using `YEAR()` directly in the `WHERE` clause often makes the query non-SARGable.
