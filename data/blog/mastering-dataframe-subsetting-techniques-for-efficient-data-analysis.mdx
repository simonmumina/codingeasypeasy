...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['dataframe', 'pandas', 'data manipulation', 'data analysis', 'python', 'subsetting', 'filtering', 'data science', 'data wrangling']
draft: false
...
Let's select rows where the age is greater than 25 *and* the salary is less than 80000:
