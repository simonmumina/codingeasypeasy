...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['canvas', 'javascript', 'html5', 'stroke', 'graphics', 'tutorial', 'web development', 'drawing']
draft: false
...
2.  `ctx.rect(20, 20, 150, 100)` defines a rectangle with its top-left corner at (20, 20) and dimensions 150x100 pixels.  **Note:** This only *defines* the path; it doesn't draw anything yet.
...
*   **Set styles before stroking:** Ensure that `lineWidth`, `strokeStyle`, `lineCap`, and `lineJoin` are set *before* calling `stroke()`.
