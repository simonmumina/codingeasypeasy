...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['tailwind css', 'text decoration', 'underline style', 'css styling', 'web development', 'front-end']
draft: false
...
```jsx
<p className="underline decoration-dashed decoration-purple-500 decoration-thick underline-offset-2">This is a thick, dashed, purple underlined text with a small offset.</p>
```
...
```jsx
<p className="underline decoration-dotted sm:decoration-dashed md:decoration-double lg:decoration-wavy">This underline style changes based on screen size.</p>
```
...
```jsx
<p className="underline decoration-dashed decoration-purple-500 decoration-extra-thin underline-offset-extra-large">Custom Underline Styling</p>
```
