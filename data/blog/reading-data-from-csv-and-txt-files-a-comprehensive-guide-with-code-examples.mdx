...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['CSV', 'TXT', 'Data Parsing', 'Data Analysis', 'JavaScript', 'Node.js', 'File Reading', 'Data Import']
draft: false
...
fs.readFile('data.csv', 'utf8', (err, data) => {
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    if (values.length === headers.length) {  // Ensuring row length matches header length
      const row = {};
