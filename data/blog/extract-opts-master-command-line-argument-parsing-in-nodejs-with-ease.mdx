...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['node.js', 'command-line', 'argument parsing', 'extract-opts', 'cli', 'development', 'javascript']
draft: false
...
*   **`required`**:  A boolean value (defaulting to `false`) indicating whether the option *must* be provided. If a required option is missing, an error will be reported.
