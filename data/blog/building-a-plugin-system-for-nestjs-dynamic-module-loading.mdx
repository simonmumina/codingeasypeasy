...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['nestjs', 'plugin system', 'dynamic modules', 'dependency injection', 'typescript', 'module federation', 'microservices']
draft: false
...
export class ConfigurablePlugin {
  ...
  async load(): Promise<void> {
    const message = this.options.uppercase ? this.options.message.toUpperCase() : this.options.message;
