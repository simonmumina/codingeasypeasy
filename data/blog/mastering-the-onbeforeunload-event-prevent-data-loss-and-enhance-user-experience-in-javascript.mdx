...
date: '2024-10-26'
lastmod: '2024-10-27'
tags: ['javascript', 'html', 'dom', 'events', 'onbeforeunload', 'web development', 'user experience', 'data loss prevention', 'browser events']
draft: false
...
*   `event.preventDefault();`: This is crucial.  Calling `preventDefault()` on the event prevents the default browser behavior, which is to unload the page immediately.  Without this, the confirmation dialog will *not* appear.
