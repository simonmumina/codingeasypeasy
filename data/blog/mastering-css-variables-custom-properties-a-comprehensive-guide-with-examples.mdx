...
date: '2023-10-27'
lastmod: '2024-01-26'
tags: ['css', 'css variables', 'custom properties', 'web development', 'frontend development', 'theming', 'dynamic styles']
draft: false
...
**Important Note:** The fallback value is only used if the variable is *not defined* or is an *invalid value* for the property.  If the variable is defined but has a value that is not valid for the property, the property will be ignored.
