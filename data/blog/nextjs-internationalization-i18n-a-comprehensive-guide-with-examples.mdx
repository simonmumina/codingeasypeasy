...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['nextjs', 'i18n', 'internationalization', 'localization', 'next-i18next', 'next-intl', 'routing', 'multilingual', 'seo']
draft: false
...
module.exports = {
  ...
  localePath: typeof window === 'undefined' ? require('path').resolve('./public/locales') : '/public/locales', // Adjust path if needed
};
```
