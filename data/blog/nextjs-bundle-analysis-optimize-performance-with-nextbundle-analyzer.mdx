...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['nextjs', 'bundle analyzer', 'performance optimization', 'webpack', 'javascript', 'react', 'web development']
draft: false
...
* **`webpack: (config) => { ... }`**:  A placeholder for adding custom webpack configuration.  You typically *don't* need to modify this for basic bundle analysis, but it's included for completeness.
