...
The simplest way to handle 404 errors in Express.js is to add a middleware function *after* all your other route definitions.  This middleware will be executed only if none of the preceding routes match the incoming request.
