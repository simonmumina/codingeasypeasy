...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['nextjs', 'css', 'css modules', 'styled-components', 'tailwind css', 'styling', 'frontend development', 'react']
draft: false
    ...
    export default function TailwindExample() {
      return (
        <div className="bg-gray-100 p-4 rounded-md shadow-md">
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Hello from Tailwind CSS!</h1>
