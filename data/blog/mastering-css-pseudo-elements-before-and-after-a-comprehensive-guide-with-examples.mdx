...
date: '2024-01-26'
lastmod: '2024-01-26'
tags: ['css', 'pseudo-elements', 'before', 'after', 'frontend development', 'web design', 'web development', 'css tricks', 'css tutorial']
draft: false
...
Similarly, to add content *after* an element, use `::after`:
...
*   **Semantic HTML:**  Remember that pseudo-elements are primarily for *styling* and visual enhancements. Don't use them to add essential content that should be part of the HTML structure.  Prioritize semantic HTML and use pseudo-elements to augment it.
