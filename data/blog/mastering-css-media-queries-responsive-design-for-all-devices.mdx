...
date: '2024-01-26'
lastmod: '2024-10-27'
tags: ['css', 'media queries', 'responsive design', 'web development', 'front-end', 'adaptive design', 'viewport', 'breakpoints']
draft: false
...
These are the workhorses of responsive design. `width` targets specific viewport widths, while `max-width` applies styles for viewport widths *up to* a certain value.
