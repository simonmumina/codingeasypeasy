...
date: '2023-10-27'
lastmod: '2024-01-26'
tags: ['next-js', 'nextjs', 'font optimization', 'google fonts', 'performance', 'web development', 'next/font/google']
draft: false
...
export default function MyComponent() {
  return (
    <div className={`${inter.className} font-sans`}>
      <h1 style={{ fontFamily: 'var(--font-inter)' }}>
        Hello, Variable Inter Font!
      </h1>
      <p>
        This paragraph uses the Inter font and inherits font-sans from tailwind.
      </p>
    </div>
  );
}
      ...
      return (
        <div className={`${inter.className} font-sans`}>
          ...
          <p className="text-gray-700">
            This text uses the Inter font and Tailwind CSS.
          </p>
        </div>
      );
    }
