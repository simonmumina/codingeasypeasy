...
date: '2024-02-29'
lastmod: '2024-02-29'
tags: ['expo', 'react-native', 'status bar', 'splash screen', 'app icon', 'configuration', 'mobile development']
draft: false
...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <StatusBar style="auto" hidden={!statusBarVisible} backgroundColor="blue" translucent={true} />
...
```json
{
  "expo": {
    ...
    "android": {
      ...
      "versionCode": 1,
      "adaptiveIcon": { // Related to app icon, mentioned later
    ...
    "splash": { // Related to splash screen, mentioned later
...
*   **`android.adaptiveIcon` (Android only):**  Specifies an *adaptive icon* for Android 8.0 (API level 26) and higher.  Adaptive icons allow the system to dynamically generate different shapes and sizes of the icon based on the device's theme and settings.
