...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['fastapi', 'python', 'api', 'response models', 'pydantic', 'data validation', 'api design', 'custom responses']
draft: false
...
Sometimes, instead of excluding certain fields, you want to explicitly specify the fields to *include* in the response (a whitelist approach).

### 1. Using `response_model_include`

The `response_model_include` parameter works similarly to `response_model_exclude`, but it specifies the fields to *include*.  All other fields are excluded.
