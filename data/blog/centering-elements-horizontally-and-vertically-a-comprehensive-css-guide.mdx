...
date: '2023-10-27'
lastmod: '2024-10-27'
tags: ['css', 'centering', 'horizontal centering', 'vertical centering', 'web development', 'frontend', 'flexbox', 'grid', 'absolute positioning', 'transform', 'css techniques']
draft: false
...
*  Setting `height` is often necessary for vertical alignment to be visible. The element needs space to align *within*.
...
*   `transform: translate(-50%, -50%);` shifts the element back by half of its own width and height, effectively centering it.  This part is essential because `top: 50%` and `left: 50%` don't center the *element*, they center its top-left corner.
