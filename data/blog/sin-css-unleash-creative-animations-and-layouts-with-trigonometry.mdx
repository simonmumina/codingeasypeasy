...
date: '2024-10-27'
lastmod: '2024-10-27'
tags: ['css', 'sin()', 'trigonometry', 'animation', 'layout', 'frontend development', 'web design', 'creative coding']
draft: false
...
*   **Amplitude:**  This determines the height of the wave (i.e., how far it swings up and down from the center line). In CSS, you'll use this to control the *intensity* of your effect.  Larger amplitude means a bigger swing.
*   **Frequency:** This controls how quickly the wave oscillates (i.e., how many cycles it completes in a given time).  In CSS, this affects the *speed* of your animation or the density of your layout.
...
*   `* 20px` multiplies the sine value by 20 pixels. This acts as the *amplitude*, determining how far the element moves up and down.
