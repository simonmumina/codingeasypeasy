...
date: '2024-01-01'
lastmod: '2024-01-01'
tags: ['pyramid', 'python', 'web development', 'url generation', 'routes', 'view configuration', 'ptweens']
draft: false
...
Pyramid provides two closely related functions: `route_url` and `route_path`. The main difference is that `route_url` returns an *absolute* URL including the scheme, hostname, and port, while `route_path` returns only the *relative* path.
