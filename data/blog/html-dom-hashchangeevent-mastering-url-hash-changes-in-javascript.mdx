...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['html', 'dom', 'javascript', 'hashchange', 'url', 'event', 'single page application', 'spa', 'browser history', 'navigation']
draft: false
...
function updateContent(hash) {
  ...
  switch (hash) {
    ...
    case 'contact':
      ...
      break;
    default:
      document.getElementById('content').innerHTML = '<h2>404 - Page Not Found</h2><p>The requested page could not be found.</p>';
  }
}
```
