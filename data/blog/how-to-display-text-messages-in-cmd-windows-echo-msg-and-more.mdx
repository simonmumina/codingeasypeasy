...
date: '2024-10-26'
lastmod: '2024-10-26'
tags: ['cmd', 'windows', 'batch scripting', 'echo', 'msg command', 'command prompt', 'text display', 'batch file', 'powershell']
draft: false
...
This will display "Files in the current directory:" followed by the output of the `dir` command. While not technically displaying the output *of* `dir` using `echo` (it's `dir` that's doing that), it demonstrates useful command chaining.
